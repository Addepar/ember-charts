...
for(var r in t)e(r,t[r])}}(),e("jquery",{default:self.jQuery}),e("rsvp",{default:Ember.RSVP})}(),function(){var e={version:"3.5.17"},t=[].slice,r=function(e){return t.call(e)},n=this.document
function i(e){return e&&(e.ownerDocument||e.document||e).documentElement}function o(e){return e&&(e.ownerDocument&&e.ownerDocument.defaultView||e.document&&e||e.defaultView)}if(n)try{r(n.documentElement.childNodes)[0].nodeType}catch(zs){r=function(e){for(var t=e.length,r=new Array(t);t--;)r[t]=e[t]
return r}}if(Date.now||(Date.now=function(){return+new Date}),n)try{n.createElement("DIV").style.setProperty("opacity",0,"")}catch(qs){var a=this.Element.prototype,s=a.setAttribute,u=a.setAttributeNS,l=this.CSSStyleDeclaration.prototype,c=l.setProperty
a.setAttribute=function(e,t){s.call(this,e,t+"")},a.setAttributeNS=function(e,t,r){u.call(this,e,t,r+"")},l.setProperty=function(e,t,r){c.call(this,e,t+"",r)}}function f(e,t){return e<t?-1:e>t?1:e>=t?0:NaN}function h(e){return null===e?NaN:+e}function d(e){return!isNaN(e)}function p(e){return{left:function(t,r,n,i){for(arguments.length<3&&(n=0),arguments.length<4&&(i=t.length);n<i;){var o=n+i>>>1
...
e(t[o],r)>0?i=o:n=o+1}return n}}}e.ascending=f,e.descending=function(e,t){return t<e?-1:t>e?1:t>=e?0:NaN},e.min=function(e,t){var r,n,i=-1,o=e.length
...
break}for(;++i<o;)null!=(n=t.call(e,e[i],i))&&r>n&&(r=n)}return r},e.max=function(e,t){var r,n,i=-1,o=e.length
if(1===arguments.length){for(;++i<o;)if(null!=(n=e[i])&&n>=n){r=n
break}for(;++i<o;)null!=(n=e[i])&&n>r&&(r=n)}else{for(;++i<o;)if(null!=(n=t.call(e,e[i],i))&&n>=n){r=n
break}for(;++i<o;)null!=(n=t.call(e,e[i],i))&&n>r&&(r=n)}return r},e.extent=function(e,t){var r,n,i,o=-1,a=e.length
...
break}for(;++o<a;)null!=(n=t.call(e,e[o],o))&&(r>n&&(r=n),i<n&&(i=n))}return[r,i]},e.sum=function(e,t){var r,n=0,i=e.length,o=-1
if(1===arguments.length)for(;++o<i;)d(r=+e[o])&&(n+=r)
else for(;++o<i;)d(r=+t.call(e,e[o],o))&&(n+=r)
return n},e.mean=function(e,t){var r,n=0,i=e.length,o=-1,a=i
if(1===arguments.length)for(;++o<i;)d(r=h(e[o]))?n+=r:--a
else for(;++o<i;)d(r=h(t.call(e,e[o],o)))?n+=r:--a
if(a)return n/a},e.quantile=function(e,t){var r=(e.length-1)*t+1,n=Math.floor(r),i=+e[n-1],o=r-n
return o?i+o*(e[n]-i):i},e.median=function(t,r){var n,i=[],o=t.length,a=-1
if(1===arguments.length)for(;++a<o;)d(n=h(t[a]))&&i.push(n)
else for(;++a<o;)d(n=h(r.call(t,t[a],a)))&&i.push(n)
if(i.length)return e.quantile(i.sort(f),.5)},e.variance=function(e,t){var r,n,i=e.length,o=0,a=0,s=-1,u=0
if(1===arguments.length)for(;++s<i;)d(r=h(e[s]))&&(a+=(n=r-o)*(r-(o+=n/++u)))
else for(;++s<i;)d(r=h(t.call(e,e[s],s)))&&(a+=(n=r-o)*(r-(o+=n/++u)))
if(u>1)return a/(u-1)},e.deviation=function(){var t=e.variance.apply(this,arguments)
return t?Math.sqrt(t):t}
var m=p(f)
function g(e){return e.length}e.bisectLeft=m.left,e.bisect=e.bisectRight=m.right,e.bisector=function(e){return p(1===e.length?function(t,r){return f(e(t),r)}:e)},e.shuffle=function(e,t,r){(o=arguments.length)<3&&(r=e.length,o<2&&(t=0))
for(var n,i,o=r-t;o;)i=Math.random()*o--|0,n=e[o+t],e[o+t]=e[i+t],e[i+t]=n
return e},e.permute=function(e,t){for(var r=t.length,n=new Array(r);r--;)n[r]=e[t[r]]
return n},e.pairs=function(e){for(var t=0,r=e.length-1,n=e[0],i=new Array(r<0?0:r);t<r;)i[t]=[n,n=e[++t]]
return i},e.transpose=function(t){if(!(o=t.length))return[]
for(var r=-1,n=e.min(t,g),i=new Array(n);++r<n;)for(var o,a=-1,s=i[r]=new Array(o);++a<o;)s[a]=t[a][r]
return i},e.zip=function(){return e.transpose(arguments)},e.keys=function(e){var t=[]
for(var r in e)t.push(r)
return t},e.values=function(e){var t=[]
for(var r in e)t.push(e[r])
return t},e.entries=function(e){var t=[]
for(var r in e)t.push({key:r,value:e[r]})
return t},e.merge=function(e){for(var t,r,n,i=e.length,o=-1,a=0;++o<i;)a+=e[o].length
for(r=new Array(a);--i>=0;)for(t=(n=e[i]).length;--t>=0;)r[--a]=n[t]
return r}
var v=Math.abs
function b(e,t){for(var r in t)Object.defineProperty(e.prototype,r,{value:t[r],enumerable:!1})}function y(){this._=Object.create(null)}e.range=function(e,t,r){if(arguments.length<3&&(r=1,arguments.length<2&&(t=e,e=0)),(t-e)/r==1/0)throw new Error("infinite range")
var n,i=[],o=function(e){var t=1
for(;e*t%1;)t*=10
return t}(v(r)),a=-1
if(e*=o,t*=o,(r*=o)<0)for(;(n=e+r*++a)>t;)i.push(n/o)
else for(;(n=e+r*++a)<t;)i.push(n/o)
return i},e.map=function(e,t){var r=new y
if(e instanceof y)e.forEach(function(e,t){r.set(e,t)})
...
return r}
var _="__proto__",w="\0"
function x(e){return(e+="")===_||e[0]===w?w+e:e}function E(e){return(e+="")[0]===w?e.slice(1):e}function k(e){return x(e)in this._}function S(e){return(e=x(e))in this._&&delete this._[e]}function A(){var e=[]
for(var t in this._)e.push(E(t))
return e}function C(){var e=0
for(var t in this._)++e
return e}function M(){for(var e in this._)return!1
return!0}function T(){this._=Object.create(null)}function O(e){return e}function N(e,t,r){return function(){var n=r.apply(t,arguments)
return n===t?e:n}}function L(e,t){if(t in e)return t
t=t.charAt(0).toUpperCase()+t.slice(1)
for(var r=0,n=D.length;r<n;++r){var i=D[r]+t
if(i in e)return i}}b(y,{has:k,get:function(e){return this._[x(e)]},set:function(e,t){return this._[x(e)]=t},remove:S,keys:A,values:function(){var e=[]
for(var t in this._)e.push(this._[t])
return e},entries:function(){var e=[]
for(var t in this._)e.push({key:E(t),value:this._[t]})
return e},size:C,empty:M,forEach:function(e){for(var t in this._)e.call(this,E(t),this._[t])}}),e.nest=function(){var t,r,n={},i=[],o=[]
function a(e,o,s){if(s>=i.length)return r?r.call(n,o):t?o.sort(t):o
for(var u,l,c,f,h=-1,d=o.length,p=i[s++],m=new y;++h<d;)(f=m.get(u=p(l=o[h])))?f.push(l):m.set(u,[l])
return e?(l=e(),c=function(t,r){l.set(t,a(e,r,s))}):(l={},c=function(t,r){l[t]=a(e,r,s)}),m.forEach(c),l}return n.map=function(e,t){return a(t,e,0)},n.entries=function(t){return function e(t,r){if(r>=i.length)return t
var n=[],a=o[r++]
return t.forEach(function(t,i){n.push({key:t,values:e(i,r)})}),a?n.sort(function(e,t){return a(e.key,t.key)}):n}(a(e.map,t,0),0)},n.key=function(e){return i.push(e),n},n.sortKeys=function(e){return o[i.length-1]=e,n},n.sortValues=function(e){return t=e,n},n.rollup=function(e){return r=e,n},n},e.set=function(e){var t=new T
if(e)for(var r=0,n=e.length;r<n;++r)t.add(e[r])
return t},b(T,{has:k,add:function(e){return this._[x(e+="")]=!0,e},remove:S,values:A,size:C,empty:M,forEach:function(e){for(var t in this._)e.call(this,E(t))}}),e.behavior={},e.rebind=function(e,t){for(var r,n=1,i=arguments.length;++n<i;)e[r=arguments[n]]=N(e,t,t[r])
return e}
var D=["webkit","ms","moz","Moz","o","O"]
function P(){}function R(){}function j(e){var t=[],r=new y
...
return arguments.length<2?a&&a.on:(a&&(a.on=null,t=t.slice(0,o=t.indexOf(a)).concat(t.slice(o+1)),r.remove(n)),i&&t.push(r.set(n,{on:i})),e)},n}function I(){e.event.preventDefault()}function B(){for(var t,r=e.event;t=r.sourceEvent;)r=t
return r}function V(t){for(var r=new R,n=0,i=arguments.length;++n<i;)r[arguments[n]]=j(r)
return r.of=function(n,i){return function(o){try{var a=o.sourceEvent=e.event
o.target=t,e.event=o,r[o.type].apply(n,i)}finally{e.event=a}}},r}e.dispatch=function(){for(var e=new R,t=-1,r=arguments.length;++t<r;)e[arguments[t]]=j(e)
return e},R.prototype.on=function(e,t){var r=e.indexOf("."),n=""
...
return this}},e.event=null,e.requote=function(e){return e.replace(F,"\\$&")}
var F=/[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g,H={}.__proto__?function(e,t){e.__proto__=t}:function(e,t){for(var r in t)e[r]=t[r]}
function W(e){return H(e,G),e}var z=function(e,t){return t.querySelector(e)},q=function(e,t){return t.querySelectorAll(e)},U=function(e,t){var r=e.matches||e[L(e,"matchesSelector")]
return(U=function(e,t){return r.call(e,t)})(e,t)}
"function"==typeof Sizzle&&(z=function(e,t){return Sizzle(e,t)[0]||null},q=Sizzle,U=Sizzle.matchesSelector),e.selection=function(){return e.select(n.documentElement)}
var G=e.selection.prototype=[]
function $(e){return"function"==typeof e?e:function(){return z(e,this)}}function K(e){return"function"==typeof e?e:function(){return q(e,this)}}G.select=function(e){var t,r,n,i,o=[]
e=$(e)
for(var a=-1,s=this.length;++a<s;){o.push(t=[]),t.parentNode=(n=this[a]).parentNode
for(var u=-1,l=n.length;++u<l;)(i=n[u])?(t.push(r=e.call(i,i.__data__,u,a)),r&&"__data__"in i&&(r.__data__=i.__data__)):t.push(null)}return W(o)},G.selectAll=function(e){var t,n,i=[]
e=K(e)
for(var o=-1,a=this.length;++o<a;)for(var s=this[o],u=-1,l=s.length;++u<l;)(n=s[u])&&(i.push(t=r(e.call(n,n.__data__,u,o))),t.parentNode=n)
return W(i)}
var Y="http://www.w3.org/1999/xhtml",Q={svg:"http://www.w3.org/2000/svg",xhtml:Y,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"}
function X(t,r){return t=e.ns.qualify(t),null==r?t.local?function(){this.removeAttributeNS(t.space,t.local)}:function(){this.removeAttribute(t)}:"function"==typeof r?t.local?function(){var e=r.apply(this,arguments)
null==e?this.removeAttributeNS(t.space,t.local):this.setAttributeNS(t.space,t.local,e)}:function(){var e=r.apply(this,arguments)
null==e?this.removeAttribute(t):this.setAttribute(t,e)}:t.local?function(){this.setAttributeNS(t.space,t.local,r)}:function(){this.setAttribute(t,r)}}function Z(e){return e.trim().replace(/\s+/g," ")}function J(t){return new RegExp("(?:^|\\s+)"+e.requote(t)+"(?:\\s+|$)","g")}function ee(e){return(e+"").trim().split(/^|\s+/)}function te(e,t){var r=(e=ee(e).map(re)).length
return"function"==typeof t?function(){for(var n=-1,i=t.apply(this,arguments);++n<r;)e[n](this,i)}:function(){for(var n=-1;++n<r;)e[n](this,t)}}function re(e){var t=J(e)
return function(r,n){if(i=r.classList)return n?i.add(e):i.remove(e)
var i=r.getAttribute("class")||""
n?(t.lastIndex=0,t.test(i)||r.setAttribute("class",Z(i+" "+e))):r.setAttribute("class",Z(i.replace(t," ")))}}function ne(e,t,r){return null==t?function(){this.style.removeProperty(e)}:"function"==typeof t?function(){var n=t.apply(this,arguments)
null==n?this.style.removeProperty(e):this.style.setProperty(e,n,r)}:function(){this.style.setProperty(e,t,r)}}function ie(e,t){return null==t?function(){delete this[e]}:"function"==typeof t?function(){var r=t.apply(this,arguments)
null==r?delete this[e]:this[e]=r}:function(){this[e]=t}}function oe(t){return"function"==typeof t?t:(t=e.ns.qualify(t)).local?function(){return this.ownerDocument.createElementNS(t.space,t.local)}:function(){var e=this.ownerDocument,r=this.namespaceURI
return r===Y&&e.documentElement.namespaceURI===Y?e.createElement(t):e.createElementNS(r,t)}}function ae(){var e=this.parentNode
e&&e.removeChild(this)}function se(e){return{__data__:e}}function ue(e){return function(){return U(this,e)}}function le(e,t){for(var r=0,n=e.length;r<n;r++)for(var i,o=e[r],a=0,s=o.length;a<s;a++)(i=o[a])&&t(i,a,r)
return e}function ce(e){return H(e,fe),e}e.ns={prefix:Q,qualify:function(e){var t=e.indexOf(":"),r=e
return t>=0&&"xmlns"!==(r=e.slice(0,t))&&(e=e.slice(t+1)),Q.hasOwnProperty(r)?{space:Q[r],local:e}:e}},G.attr=function(t,r){if(arguments.length<2){if("string"==typeof t){var n=this.node()
return(t=e.ns.qualify(t)).local?n.getAttributeNS(t.space,t.local):n.getAttribute(t)}for(r in t)this.each(X(r,t[r]))
return this}return this.each(X(t,r))},G.classed=function(e,t){if(arguments.length<2){if("string"==typeof e){var r=this.node(),n=(e=ee(e)).length,i=-1
if(t=r.classList){for(;++i<n;)if(!t.contains(e[i]))return!1}else for(t=r.getAttribute("class");++i<n;)if(!J(e[i]).test(t))return!1
return!0}for(t in e)this.each(te(t,e[t]))
return this}return this.each(te(e,t))},G.style=function(e,t,r){var n=arguments.length
if(n<3){if("string"!=typeof e){for(r in n<2&&(t=""),e)this.each(ne(r,e[r],t))
return this}if(n<2){var i=this.node()
return o(i).getComputedStyle(i,null).getPropertyValue(e)}r=""}return this.each(ne(e,t,r))},G.property=function(e,t){if(arguments.length<2){if("string"==typeof e)return this.node()[e]
for(t in e)this.each(ie(t,e[t]))
return this}return this.each(ie(e,t))},G.text=function(e){return arguments.length?this.each("function"==typeof e?function(){var t=e.apply(this,arguments)
this.textContent=null==t?"":t}:null==e?function(){this.textContent=""}:function(){this.textContent=e}):this.node().textContent},G.html=function(e){return arguments.length?this.each("function"==typeof e?function(){var t=e.apply(this,arguments)
this.innerHTML=null==t?"":t}:null==e?function(){this.innerHTML=""}:function(){this.innerHTML=e}):this.node().innerHTML},G.append=function(e){return e=oe(e),this.select(function(){return this.appendChild(e.apply(this,arguments))})},G.insert=function(e,t){return e=oe(e),t=$(t),this.select(function(){return this.insertBefore(e.apply(this,arguments),t.apply(this,arguments)||null)})},G.remove=function(){return this.each(ae)},G.data=function(e,t){var r,n,i=-1,o=this.length
...
if(t){var m,g=new y,v=new Array(a)
for(n=-1;++n<a;)(i=e[n])&&(g.has(m=t.call(i,i.__data__,n))?p[n]=i:g.set(m,i),v[n]=m)
for(n=-1;++n<c;)(i=g.get(m=t.call(r,o=r[n],n)))?!0!==i&&(h[n]=i,i.__data__=o):d[n]=se(o),g.set(m,!0)
for(n=-1;++n<a;)n in v&&!0!==g.get(v[n])&&(p[n]=e[n])}else{for(n=-1;++n<f;)i=e[n],o=r[n],i?(i.__data__=o,h[n]=i):d[n]=se(o)
for(;n<c;++n)d[n]=se(r[n])
for(;n<a;++n)p[n]=e[n]}d.update=h,d.parentNode=h.parentNode=p.parentNode=e.parentNode,s.push(d),u.push(h),l.push(p)}var s=ce([]),u=W([]),l=W([])
if("function"==typeof e)for(;++i<o;)a(r=this[i],e.call(r,r.parentNode.__data__,i))
else for(;++i<o;)a(r=this[i],e)
return u.enter=function(){return s},u.exit=function(){return l},u},G.datum=function(e){return arguments.length?this.property("__data__",e):this.property("__data__")},G.filter=function(e){var t,r,n,i=[]
"function"!=typeof e&&(e=ue(e))
for(var o=0,a=this.length;o<a;o++){i.push(t=[]),t.parentNode=(r=this[o]).parentNode
for(var s=0,u=r.length;s<u;s++)(n=r[s])&&e.call(n,n.__data__,s,o)&&t.push(n)}return W(i)},G.order=function(){for(var e=-1,t=this.length;++e<t;)for(var r,n=this[e],i=n.length-1,o=n[i];--i>=0;)(r=n[i])&&(o&&o!==r.nextSibling&&o.parentNode.insertBefore(r,o),o=r)
return this},G.sort=function(e){e=function(e){arguments.length||(e=f)
return function(t,r){return t&&r?e(t.__data__,r.__data__):!t-!r}}.apply(this,arguments)
for(var t=-1,r=this.length;++t<r;)this[t].sort(e)
return this.order()},G.each=function(e){return le(this,function(t,r,n){e.call(t,t.__data__,r,n)})},G.call=function(e){var t=r(arguments)
return e.apply(t[0]=this,t),this},G.empty=function(){return!this.node()},G.node=function(){for(var e=0,t=this.length;e<t;e++)for(var r=this[e],n=0,i=r.length;n<i;n++){var o=r[n]
if(o)return o}return null},G.size=function(){var e=0
return le(this,function(){++e}),e}
var fe=[]
function he(t,n,i){var o="__on"+t,a=t.indexOf("."),s=pe
a>0&&(t=t.slice(0,a))
var u=de.get(t)
function l(){var e=this[o]
e&&(this.removeEventListener(t,e,e.$),delete this[o])}return u&&(t=u,s=me),a?n?function(){var e=s(n,r(arguments))
l.call(this),this.addEventListener(t,this[o]=e,e.$=i),e._=n}:l:n?P:function(){var r,n=new RegExp("^__on([^.]+)"+e.requote(t)+"$")
for(var i in this)if(r=i.match(n)){var o=this[i]
this.removeEventListener(r[1],o,o.$),delete this[i]}}}e.selection.enter=ce,e.selection.enter.prototype=fe,fe.append=G.append,fe.empty=G.empty,fe.node=G.node,fe.call=G.call,fe.size=G.size,fe.select=function(e){for(var t,r,n,i,o,a=[],s=-1,u=this.length;++s<u;){n=(i=this[s]).update,a.push(t=[]),t.parentNode=i.parentNode
for(var l=-1,c=i.length;++l<c;)(o=i[l])?(t.push(n[l]=r=e.call(i.parentNode,o.__data__,l,s)),r.__data__=o.__data__):t.push(null)}return W(a)},fe.insert=function(e,t){var r,n,i
return arguments.length<2&&(r=this,t=function(e,t,o){var a,s=r[o].update,u=s.length
for(o!=i&&(i=o,n=0),t>=n&&(n=t+1);!(a=s[n])&&++n<u;);return a}),G.insert.call(this,e,t)},e.select=function(e){var t
return"string"==typeof e?(t=[z(e,n)]).parentNode=n.documentElement:(t=[e]).parentNode=i(e),W([t])},e.selectAll=function(e){var t
return"string"==typeof e?(t=r(q(e,n))).parentNode=n.documentElement:(t=r(e)).parentNode=null,W([t])},G.on=function(e,t,r){var n=arguments.length
if(n<3){if("string"!=typeof e){for(r in n<2&&(t=!1),e)this.each(he(r,e[r],t))
return this}if(n<2)return(n=this.node()["__on"+e])&&n._
r=!1}return this.each(he(e,t,r))}
var de=e.map({mouseenter:"mouseover",mouseleave:"mouseout"})
function pe(t,r){return function(n){var i=e.event
e.event=n,r[0]=this.__data__
try{t.apply(this,r)}finally{e.event=i}}}function me(e,t){var r=pe(e,t)
return function(e){var t=e.relatedTarget
t&&(t===this||8&t.compareDocumentPosition(this))||r.call(this,e)}}n&&de.forEach(function(e){"on"+e in n&&de.remove(e)})
var ge,ve=0
function be(t){var r=".dragsuppress-"+ ++ve,n="click"+r,a=e.select(o(t)).on("touchmove"+r,I).on("dragstart"+r,I).on("selectstart"+r,I)
if(null==ge&&(ge=!("onselectstart"in t)&&L(t.style,"userSelect")),ge){var s=i(t).style,u=s[ge]
s[ge]="none"}return function(e){if(a.on(r,null),ge&&(s[ge]=u),e){var t=function(){a.on(n,null)}
a.on(n,function(){I(),t()},!0),setTimeout(t,0)}}}e.mouse=function(e){return _e(e,B())}
var ye=this.navigator&&/WebKit/.test(this.navigator.userAgent)?-1:0
function _e(t,r){r.changedTouches&&(r=r.changedTouches[0])
var n=t.ownerSVGElement||t
if(n.createSVGPoint){var i=n.createSVGPoint()
if(ye<0){var a=o(t)
if(a.scrollX||a.scrollY){var s=(n=e.select("body").append("svg").style({position:"absolute",top:0,left:0,margin:0,padding:0,border:"none"},"important"))[0][0].getScreenCTM()
ye=!(s.f||s.e),n.remove()}}return ye?(i.x=r.pageX,i.y=r.pageY):(i.x=r.clientX,i.y=r.clientY),[(i=i.matrixTransform(t.getScreenCTM().inverse())).x,i.y]}var u=t.getBoundingClientRect()
return[r.clientX-u.left-t.clientLeft,r.clientY-u.top-t.clientTop]}function we(){return e.event.changedTouches[0].identifier}e.touch=function(e,t,r){if(arguments.length<3&&(r=t,t=B().changedTouches),t)for(var n,i=0,o=t.length;i<o;++i)if((n=t[i]).identifier===r)return _e(e,n)},e.behavior.drag=function(){var t=V(a,"drag","dragstart","dragend"),r=null,n=s(P,e.mouse,o,"mousemove","mouseup"),i=s(we,e.touch,O,"touchmove","touchend")
function a(){this.on("mousedown.drag",n).on("touchstart.drag",i)}function s(n,i,o,a,s){return function(){var u,l=e.event.target.correspondingElement||e.event.target,c=this.parentNode,f=t.of(this,arguments),h=0,d=n(),p=".drag"+(null==d?"":"-"+d),m=e.select(o(l)).on(a+p,function(){var e,t,r=i(c,d)
if(!r)return
e=r[0]-v[0],t=r[1]-v[1],h|=e|t,v=r,f({type:"drag",x:r[0]+u[0],y:r[1]+u[1],dx:e,dy:t})}).on(s+p,function(){if(!i(c,d))return
m.on(a+p,null).on(s+p,null),g(h),f({type:"dragend"})}),g=be(l),v=i(c,d)
u=r?[(u=r.apply(this,arguments)).x-v[0],u.y-v[1]]:[0,0],f({type:"dragstart"})}}return a.origin=function(e){return arguments.length?(r=e,a):r},e.rebind(a,t,"on")},e.touches=function(e,t){return arguments.length<2&&(t=B().touches),t?r(t).map(function(t){var r=_e(e,t)
return r.identifier=t.identifier,r}):[]}
var xe=1e-6,Ee=xe*xe,ke=Math.PI,Se=2*ke,Ae=Se-xe,Ce=ke/2,Me=ke/180,Te=180/ke
function Oe(e){return e>0?1:e<0?-1:0}function Ne(e,t,r){return(t[0]-e[0])*(r[1]-e[1])-(t[1]-e[1])*(r[0]-e[0])}function Le(e){return e>1?0:e<-1?ke:Math.acos(e)}function De(e){return e>1?Ce:e<-1?-Ce:Math.asin(e)}function Pe(e){return((e=Math.exp(e))+1/e)/2}function Re(e){return(e=Math.sin(e/2))*e}var je=Math.SQRT2
e.interpolateZoom=function(e,t){var r,n,i=e[0],o=e[1],a=e[2],s=t[0],u=t[1],l=t[2],c=s-i,f=u-o,h=c*c+f*f
if(h<Ee)n=Math.log(l/a)/je,r=function(e){return[i+e*c,o+e*f,a*Math.exp(je*e*n)]}
...
n=(v-g)/je,r=function(e){var t,r=e*n,s=Pe(g),u=a/(2*d)*(s*(t=je*r+g,((t=Math.exp(2*t))-1)/(t+1))-function(e){return((e=Math.exp(e))-1/e)/2}(g))
return[i+u*c,o+u*f,a*s/Pe(je*r+g)]}}return r.duration=1e3*n,r},e.behavior.zoom=function(){var t,r,i,a,s,u,l,c,f,h={x:0,y:0,k:1},d=[960,500],p=Ve,m=250,g=0,v="mousedown.zoom",b="mousemove.zoom",y="mouseup.zoom",_="touchstart.zoom",w=V(x,"zoomstart","zoom","zoomend")
function x(e){e.on(v,N).on(Be+".zoom",D).on("dblclick.zoom",P).on(_,L)}function E(e){return[(e[0]-h.x)/h.k,(e[1]-h.y)/h.k]}function k(e){h.k=Math.max(p[0],Math.min(p[1],e))}function S(e,t){t=function(e){return[e[0]*h.k+h.x,e[1]*h.k+h.y]}(t),h.x+=e[0]-t[0],h.y+=e[1]-t[1]}function A(t,n,i,o){t.__chart__={x:h.x,y:h.y,k:h.k},k(Math.pow(2,o)),S(r=n,i),t=e.select(t),m>0&&(t=t.transition().duration(m)),t.call(x.event)}function C(){l&&l.domain(u.range().map(function(e){return(e-h.x)/h.k}).map(u.invert)),f&&f.domain(c.range().map(function(e){return(e-h.y)/h.k}).map(c.invert))}function M(e){g++||e({type:"zoomstart"})}function T(e){C(),e({type:"zoom",scale:h.k,translate:[h.x,h.y]})}function O(e){--g||(e({type:"zoomend"}),r=null)}function N(){var t=this,r=w.of(t,arguments),n=0,i=e.select(o(t)).on(b,function(){n=1,S(e.mouse(t),a),T(r)}).on(y,function(){i.on(b,null).on(y,null),s(n),O(r)}),a=E(e.mouse(t)),s=be(t)
hs.call(t),M(r)}function L(){var t,r=this,n=w.of(r,arguments),i={},o=0,a=".zoom-"+e.event.changedTouches[0].identifier,u="touchmove"+a,l="touchend"+a,c=[],f=e.select(r),d=be(r)
function p(){var n=e.touches(r)
return t=h.k,n.forEach(function(e){e.identifier in i&&(i[e.identifier]=E(e))}),n}function m(){var t=e.event.target
e.select(t).on(u,g).on(l,b),c.push(t)
for(var n=e.event.changedTouches,a=0,f=n.length;a<f;++a)i[n[a].identifier]=null
var d=p(),m=Date.now()
if(1===d.length){if(m-s<500){var v=d[0]
A(r,v,i[v.identifier],Math.floor(Math.log(h.k)/Math.LN2)+1),I()}s=m}else if(d.length>1){v=d[0]
var y=d[1],_=v[0]-y[0],w=v[1]-y[1]
o=_*_+w*w}}function g(){var a,u,l,c,f=e.touches(r)
hs.call(r)
for(var h=0,d=f.length;h<d;++h,c=null)if(l=f[h],c=i[l.identifier]){if(u)break
a=l,u=c}if(c){var p=(p=l[0]-a[0])*p+(p=l[1]-a[1])*p,m=o&&Math.sqrt(p/o)
a=[(a[0]+l[0])/2,(a[1]+l[1])/2],u=[(u[0]+c[0])/2,(u[1]+c[1])/2],k(m*t)}s=null,S(a,u),T(n)}function b(){if(e.event.touches.length){for(var t=e.event.changedTouches,r=0,o=t.length;r<o;++r)delete i[t[r].identifier]
for(var s in i)return void p()}e.selectAll(c).on(a,null),f.on(v,N).on(_,L),d(),O(n)}m(),M(n),f.on(v,null).on(_,m)}function D(){var n=w.of(this,arguments)
a?clearTimeout(a):(hs.call(this),t=E(r=i||e.mouse(this)),M(n)),a=setTimeout(function(){a=null,O(n)},50),I(),k(Math.pow(2,.002*Ie())*h.k),S(r,t),T(n)}function P(){var t=e.mouse(this),r=Math.log(h.k)/Math.LN2
A(this,t,E(t),e.event.shiftKey?Math.ceil(r)-1:Math.floor(r)+1)}return Be||(Be="onwheel"in n?(Ie=function(){return-e.event.deltaY*(e.event.deltaMode?120:1)},"wheel"):"onmousewheel"in n?(Ie=function(){return e.event.wheelDelta},"mousewheel"):(Ie=function(){return-e.event.detail},"MozMousePixelScroll")),x.event=function(t){t.each(function(){var t=w.of(this,arguments),n=h
ms?e.select(this).transition().each("start.zoom",function(){h=this.__chart__||{x:0,y:0,k:1},M(t)}).tween("zoom:zoom",function(){var i=d[0],o=d[1],a=r?r[0]:i/2,s=r?r[1]:o/2,u=e.interpolateZoom([(a-h.x)/h.k,(s-h.y)/h.k,i/h.k],[(a-n.x)/n.k,(s-n.y)/n.k,i/n.k])
return function(e){var r=u(e),n=i/r[2]
this.__chart__=h={x:a-r[0]*n,y:s-r[1]*n,k:n},T(t)}}).each("interrupt.zoom",function(){O(t)}).each("end.zoom",function(){O(t)}):(this.__chart__=h,M(t),T(t),O(t))})},x.translate=function(e){return arguments.length?(h={x:+e[0],y:+e[1],k:h.k},C(),x):[h.x,h.y]},x.scale=function(e){return arguments.length?(h={x:h.x,y:h.y,k:null},k(+e),C(),x):h.k},x.scaleExtent=function(e){return arguments.length?(p=null==e?Ve:[+e[0],+e[1]],x):p},x.center=function(e){return arguments.length?(i=e&&[+e[0],+e[1]],x):i},x.size=function(e){return arguments.length?(d=e&&[+e[0],+e[1]],x):d},x.duration=function(e){return arguments.length?(m=+e,x):m},x.x=function(e){return arguments.length?(l=e,u=e.copy(),h={x:0,y:0,k:1},x):l},x.y=function(e){return arguments.length?(f=e,c=e.copy(),h={x:0,y:0,k:1},x):f},e.rebind(x,w,"on")}
var Ie,Be,Ve=[0,1/0]
function Fe(){}function He(e,t,r){return this instanceof He?(this.h=+e,this.s=+t,void(this.l=+r)):arguments.length<2?e instanceof He?new He(e.h,e.s,e.l):lt(""+e,ct,He):new He(e,t,r)}e.color=Fe,Fe.prototype.toString=function(){return this.rgb()+""},e.hsl=He
var We=He.prototype=new Fe
function ze(e,t,r){var n,i
function o(e){return Math.round(255*function(e){return e>360?e-=360:e<0&&(e+=360),e<60?n+(i-n)*e/60:e<180?i:e<240?n+(i-n)*(240-e)/60:n}(e))}return e=isNaN(e)?0:(e%=360)<0?e+360:e,t=isNaN(t)?0:t<0?0:t>1?1:t,n=2*(r=r<0?0:r>1?1:r)-(i=r<=.5?r*(1+t):r+t-r*t),new it(o(e+120),o(e),o(e-120))}function qe(t,r,n){return this instanceof qe?(this.h=+t,this.c=+r,void(this.l=+n)):arguments.length<2?t instanceof qe?new qe(t.h,t.c,t.l):et(t instanceof $e?t.l:(t=ft((t=e.rgb(t)).r,t.g,t.b)).l,t.a,t.b):new qe(t,r,n)}We.brighter=function(e){return e=Math.pow(.7,arguments.length?e:1),new He(this.h,this.s,this.l/e)},We.darker=function(e){return e=Math.pow(.7,arguments.length?e:1),new He(this.h,this.s,e*this.l)},We.rgb=function(){return ze(this.h,this.s,this.l)},e.hcl=qe
var Ue=qe.prototype=new Fe
function Ge(e,t,r){return isNaN(e)&&(e=0),isNaN(t)&&(t=0),new $e(r,Math.cos(e*=Me)*t,Math.sin(e)*t)}function $e(e,t,r){return this instanceof $e?(this.l=+e,this.a=+t,void(this.b=+r)):arguments.length<2?e instanceof $e?new $e(e.l,e.a,e.b):e instanceof qe?Ge(e.h,e.c,e.l):ft((e=it(e)).r,e.g,e.b):new $e(e,t,r)}Ue.brighter=function(e){return new qe(this.h,this.c,Math.min(100,this.l+Ke*(arguments.length?e:1)))},Ue.darker=function(e){return new qe(this.h,this.c,Math.max(0,this.l-Ke*(arguments.length?e:1)))},Ue.rgb=function(){return Ge(this.h,this.c,this.l).rgb()},e.lab=$e
var Ke=18,Ye=.95047,Qe=1,Xe=1.08883,Ze=$e.prototype=new Fe
function Je(e,t,r){var n=(e+16)/116,i=n+t/500,o=n-r/200
return new it(nt(3.2404542*(i=tt(i)*Ye)-1.5371385*(n=tt(n)*Qe)-.4985314*(o=tt(o)*Xe)),nt(-.969266*i+1.8760108*n+.041556*o),nt(.0556434*i-.2040259*n+1.0572252*o))}function et(e,t,r){return e>0?new qe(Math.atan2(r,t)*Te,Math.sqrt(t*t+r*r),e):new qe(NaN,NaN,e)}function tt(e){return e>.206893034?e*e*e:(e-4/29)/7.787037}function rt(e){return e>.008856?Math.pow(e,1/3):7.787037*e+4/29}function nt(e){return Math.round(255*(e<=.00304?12.92*e:1.055*Math.pow(e,1/2.4)-.055))}function it(e,t,r){return this instanceof it?(this.r=~~e,this.g=~~t,void(this.b=~~r)):arguments.length<2?e instanceof it?new it(e.r,e.g,e.b):lt(""+e,it,ze):new it(e,t,r)}function ot(e){return new it(e>>16,e>>8&255,255&e)}function at(e){return ot(e)+""}Ze.brighter=function(e){return new $e(Math.min(100,this.l+Ke*(arguments.length?e:1)),this.a,this.b)},Ze.darker=function(e){return new $e(Math.max(0,this.l-Ke*(arguments.length?e:1)),this.a,this.b)},Ze.rgb=function(){return Je(this.l,this.a,this.b)},e.rgb=it
var st=it.prototype=new Fe
function ut(e){return e<16?"0"+Math.max(0,e).toString(16):Math.min(255,e).toString(16)}function lt(e,t,r){var n,i,o,a=0,s=0,u=0
...
case"rgb":return t(dt(i[0]),dt(i[1]),dt(i[2]))}return(o=pt.get(e))?t(o.r,o.g,o.b):(null==e||"#"!==e.charAt(0)||isNaN(o=parseInt(e.slice(1),16))||(4===e.length?(a=(3840&o)>>4,a|=a>>4,s=240&o,s|=s>>4,u=15&o,u|=u<<4):7===e.length&&(a=(16711680&o)>>16,s=(65280&o)>>8,u=255&o)),t(a,s,u))}function ct(e,t,r){var n,i,o=Math.min(e/=255,t/=255,r/=255),a=Math.max(e,t,r),s=a-o,u=(a+o)/2
return s?(i=u<.5?s/(a+o):s/(2-a-o),n=e==a?(t-r)/s+(t<r?6:0):t==a?(r-e)/s+2:(e-t)/s+4,n*=60):(n=NaN,i=u>0&&u<1?0:n),new He(n,i,u)}function ft(e,t,r){var n=rt((.4124564*(e=ht(e))+.3575761*(t=ht(t))+.1804375*(r=ht(r)))/Ye),i=rt((.2126729*e+.7151522*t+.072175*r)/Qe)
return $e(116*i-16,500*(n-i),200*(i-rt((.0193339*e+.119192*t+.9503041*r)/Xe)))}function ht(e){return(e/=255)<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)}function dt(e){var t=parseFloat(e)
return"%"===e.charAt(e.length-1)?Math.round(2.55*t):t}st.brighter=function(e){e=Math.pow(.7,arguments.length?e:1)
var t=this.r,r=this.g,n=this.b,i=30
return t||r||n?(t&&t<i&&(t=i),r&&r<i&&(r=i),n&&n<i&&(n=i),new it(Math.min(255,t/e),Math.min(255,r/e),Math.min(255,n/e))):new it(i,i,i)},st.darker=function(e){return new it((e=Math.pow(.7,arguments.length?e:1))*this.r,e*this.g,e*this.b)},st.hsl=function(){return ct(this.r,this.g,this.b)},st.toString=function(){return"#"+ut(this.r)+ut(this.g)+ut(this.b)}
var pt=e.map({aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074})
function mt(e){return"function"==typeof e?e:function(){return e}}function gt(e){return function(t,r,n){return 2===arguments.length&&"function"==typeof r&&(n=r,r=null),vt(t,r,e,n)}}function vt(t,n,i,o){var a={},s=e.dispatch("beforesend","progress","load","error"),u={},l=new XMLHttpRequest,c=null
function f(){var e,t=l.status
if(!t&&function(e){var t=e.responseType
return t&&"text"!==t?e.response:e.responseText}(l)||t>=200&&t<300||304===t){try{e=i.call(a,l)}catch(zs){return void s.error.call(a,zs)}s.load.call(a,e)}else s.error.call(a,l)}return!this.XDomainRequest||"withCredentials"in l||!/^(http(s)?:)?\/\//.test(t)||(l=new XDomainRequest),"onload"in l?l.onload=l.onerror=f:l.onreadystatechange=function(){l.readyState>3&&f()},l.onprogress=function(t){var r=e.event
e.event=t
try{s.progress.call(a,l)}finally{e.event=r}},a.header=function(e,t){return e=(e+"").toLowerCase(),arguments.length<2?u[e]:(null==t?delete u[e]:u[e]=t+"",a)},a.mimeType=function(e){return arguments.length?(n=null==e?null:e+"",a):n},a.responseType=function(e){return arguments.length?(c=e,a):c},a.response=function(e){return i=e,a},["get","post"].forEach(function(e){a[e]=function(){return a.send.apply(a,[e].concat(r(arguments)))}}),a.send=function(e,r,i){if(2===arguments.length&&"function"==typeof r&&(i=r,r=null),l.open(e,t,!0),null==n||"accept"in u||(u.accept=n+",*/*"),l.setRequestHeader)for(var o in u)l.setRequestHeader(o,u[o])
return null!=n&&l.overrideMimeType&&l.overrideMimeType(n),null!=c&&(l.responseType=c),null!=i&&a.on("error",i).on("load",function(e){i(null,e)}),s.beforesend.call(a,l),l.send(null==r?null:r),a},a.abort=function(){return l.abort(),a},e.rebind(a,s,"on"),null==o?a:a.get(function(e){return 1===e.length?function(t,r){e(null==t?r:null)}:e}(o))}pt.forEach(function(e,t){pt.set(e,ot(t))}),e.functor=mt,e.xhr=gt(O),e.dsv=function(e,t){var r=new RegExp('["'+e+"\n]"),n=e.charCodeAt(0)
function i(e,r,n){arguments.length<3&&(n=r,r=null)
var i=vt(e,t,null==r?o:a(r),n)
...
var r=new T,n=[]
return t.forEach(function(e){for(var t in e)r.has(t)||n.push(r.add(t))}),[n.map(u).join(e)].concat(t.map(function(t){return n.map(function(e){return u(t[e])}).join(e)})).join("\n")},i.formatRows=function(e){return e.map(s).join("\n")},i},e.csv=e.dsv(",","text/csv"),e.tsv=e.dsv("\t","text/tab-separated-values")
var bt,yt,_t,wt,xt=this[L(this,"requestAnimationFrame")]||function(e){setTimeout(e,17)}
function Et(e,t,r){var n=arguments.length
n<2&&(t=0),n<3&&(r=Date.now())
var i={c:e,t:r+t,n:null}
return yt?yt.n=i:bt=i,yt=i,_t||(wt=clearTimeout(wt),_t=1,xt(kt)),i}function kt(){var e=St(),t=At()-e
t>24?(isFinite(t)&&(clearTimeout(wt),wt=setTimeout(kt,t)),_t=0):(_t=1,xt(kt))}function St(){for(var e=Date.now(),t=bt;t;)e>=t.t&&t.c(e-t.t)&&(t.c=null),t=t.n
return e}function At(){for(var e,t=bt,r=1/0;t;)t.c?(t.t<r&&(r=t.t),t=(e=t).n):t=e?e.n=t.n:bt=t.n
return yt=e,r}function Ct(e,t){return t-(e?Math.ceil(Math.log(e)/Math.LN10):1)}e.timer=function(){Et.apply(this,arguments)},e.timer.flush=function(){St(),At()},e.round=function(e,t){return t?Math.round(e*(t=Math.pow(10,t)))/t:Math.round(e)}
var Mt=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"].map(function(e,t){var r=Math.pow(10,3*v(8-t))
return{scale:t>8?function(e){return e/r}:function(e){return e*r},symbol:e}})
function Tt(t){var r=t.decimal,n=t.thousands,i=t.grouping,o=t.currency,a=i&&n?function(e,t){for(var r=e.length,o=[],a=0,s=i[0],u=0;r>0&&s>0&&(u+s+1>t&&(s=Math.max(1,t-u)),o.push(e.substring(r-=s,r+s)),!((u+=s+1)>t));)s=i[a=(a+1)%i.length]
return o.reverse().join(n)}:O
return function(t){var n=Ot.exec(t),i=n[1]||" ",s=n[2]||">",u=n[3]||"-",l=n[4]||"",c=n[5],f=+n[6],h=n[7],d=n[8],p=n[9],m=1,g="",v="",b=!1,y=!0
switch(d&&(d=+d.substring(1)),(c||"0"===i&&"="===s)&&(c=i="0",s="="),p){case"n":h=!0,p="g"
break
case"%":m=100,v="%",p="f"
break
case"p":m=100,v="%",p="r"
...
case"d":b=!0,d=0
break
case"s":m=-1,p="r"}"$"===l&&(g=o[0],v=o[1]),"r"!=p||d||(p="g"),null!=d&&("g"==p?d=Math.max(1,Math.min(21,d)):"e"!=p&&"f"!=p||(d=Math.max(0,Math.min(20,d)))),p=Nt.get(p)||Lt
var _=c&&h
return function(t){var n=v
if(b&&t%1)return""
var o=t<0||0===t&&1/t<0?(t=-t,"-"):"-"===u?"":u
if(m<0){var l=e.formatPrefix(t,d)
t=l.scale(t),n=l.symbol+v}else t*=m
var w,x,E=(t=p(t,d)).lastIndexOf(".")
if(E<0){var k=y?t.lastIndexOf("e"):-1
k<0?(w=t,x=""):(w=t.substring(0,k),x=t.substring(k))}else w=t.substring(0,E),x=r+t.substring(E+1)
!c&&h&&(w=a(w,1/0))
var S=g.length+w.length+x.length+(_?0:o.length),A=S<f?new Array(S=f-S+1).join(i):""
return _&&(w=a(A+w,A.length?f-x.length:1/0)),o+=g,t=w+x,("<"===s?o+t+A:">"===s?A+o+t:"^"===s?A.substring(0,S>>=1)+o+t+A.substring(S):o+(_?t:A+t))+n}}}e.formatPrefix=function(t,r){var n=0
return(t=+t)&&(t<0&&(t*=-1),r&&(t=e.round(t,Ct(t,r))),n=1+Math.floor(1e-12+Math.log(t)/Math.LN10),n=Math.max(-24,Math.min(24,3*Math.floor((n-1)/3)))),Mt[8+n/3]}
var Ot=/(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,Nt=e.map({b:function(e){return e.toString(2)},c:function(e){return String.fromCharCode(e)},o:function(e){return e.toString(8)},x:function(e){return e.toString(16)},X:function(e){return e.toString(16).toUpperCase()},g:function(e,t){return e.toPrecision(t)},e:function(e,t){return e.toExponential(t)},f:function(e,t){return e.toFixed(t)},r:function(t,r){return(t=e.round(t,Ct(t,r))).toFixed(Math.max(0,Math.min(20,Ct(t*(1+1e-15),r))))}})
function Lt(e){return e+""}var Dt=e.time={},Pt=Date
function Rt(){this._=new Date(arguments.length>1?Date.UTC.apply(this,arguments):arguments[0])}Rt.prototype={getDate:function(){return this._.getUTCDate()},getDay:function(){return this._.getUTCDay()},getFullYear:function(){return this._.getUTCFullYear()},getHours:function(){return this._.getUTCHours()},getMilliseconds:function(){return this._.getUTCMilliseconds()},getMinutes:function(){return this._.getUTCMinutes()},getMonth:function(){return this._.getUTCMonth()},getSeconds:function(){return this._.getUTCSeconds()},getTime:function(){return this._.getTime()},getTimezoneOffset:function(){return 0},valueOf:function(){return this._.valueOf()},setDate:function(){jt.setUTCDate.apply(this._,arguments)},setDay:function(){jt.setUTCDay.apply(this._,arguments)},setFullYear:function(){jt.setUTCFullYear.apply(this._,arguments)},setHours:function(){jt.setUTCHours.apply(this._,arguments)},setMilliseconds:function(){jt.setUTCMilliseconds.apply(this._,arguments)},setMinutes:function(){jt.setUTCMinutes.apply(this._,arguments)},setMonth:function(){jt.setUTCMonth.apply(this._,arguments)},setSeconds:function(){jt.setUTCSeconds.apply(this._,arguments)},setTime:function(){jt.setTime.apply(this._,arguments)}}
var jt=Date.prototype
function It(e,t,r){function n(t){var r=e(t),n=o(r,1)
return t-r<n-t?r:n}function i(r){return t(r=e(new Pt(r-1)),1),r}function o(e,r){return t(e=new Pt(+e),r),e}function a(e,n,o){var a=i(e),s=[]
...
var s=e.utc=Bt(e)
return s.floor=s,s.round=Bt(n),s.ceil=Bt(i),s.offset=Bt(o),s.range=function(e,t,r){try{Pt=Rt
var n=new Rt
return n._=e,a(n,t,r)}finally{Pt=Date}},e}function Bt(e){return function(t,r){try{Pt=Rt
var n=new Rt
return n._=t,e(n,r)._}finally{Pt=Date}}}function Vt(t){var r=t.dateTime,n=t.date,i=t.time,o=t.periods,a=t.days,s=t.shortDays,u=t.months,l=t.shortMonths
function c(e){var t=e.length
function r(r){for(var n,i,o,a=[],s=-1,u=0;++s<t;)37===e.charCodeAt(s)&&(a.push(e.slice(u,s)),null!=(i=Ft[n=e.charAt(++s)])&&(n=e.charAt(++s)),(o=w[n])&&(n=o(r,null==i?"e"===n?" ":"0":i)),a.push(n),u=s+1)
...
var n=null!=r.Z&&Pt!==Rt,i=new(n?Rt:Pt)
...
if(37===(i=t.charCodeAt(s++))){if(a=t.charAt(s++),!(o=x[a in Ft?t.charAt(s++):a])||(n=o(e,r,n))<0)return-1}else if(i!=r.charCodeAt(n++))return-1}return n}c.utc=function(e){var t=c(e)
function r(e){try{var r=new(Pt=Rt)
return r._=e,t(r)}finally{Pt=Date}}return r.parse=function(e){try{Pt=Rt
var r=t.parse(e)
return r&&r._}finally{Pt=Date}},r.toString=t.toString,r},c.multi=c.utc.multi=sr
var h=e.map(),d=qt(a),p=Ut(a),m=qt(s),g=Ut(s),v=qt(u),b=Ut(u),y=qt(l),_=Ut(l)
o.forEach(function(e,t){h.set(e.toLowerCase(),t)})
var w={a:function(e){return s[e.getDay()]},A:function(e){return a[e.getDay()]},b:function(e){return l[e.getMonth()]},B:function(e){return u[e.getMonth()]},c:c(r),d:function(e,t){return zt(e.getDate(),t,2)},e:function(e,t){return zt(e.getDate(),t,2)},H:function(e,t){return zt(e.getHours(),t,2)},I:function(e,t){return zt(e.getHours()%12||12,t,2)},j:function(e,t){return zt(1+Dt.dayOfYear(e),t,3)},L:function(e,t){return zt(e.getMilliseconds(),t,3)},m:function(e,t){return zt(e.getMonth()+1,t,2)},M:function(e,t){return zt(e.getMinutes(),t,2)},p:function(e){return o[+(e.getHours()>=12)]},S:function(e,t){return zt(e.getSeconds(),t,2)},U:function(e,t){return zt(Dt.sundayOfYear(e),t,2)},w:function(e){return e.getDay()},W:function(e,t){return zt(Dt.mondayOfYear(e),t,2)},x:c(n),X:c(i),y:function(e,t){return zt(e.getFullYear()%100,t,2)},Y:function(e,t){return zt(e.getFullYear()%1e4,t,4)},Z:or,"%":function(){return"%"}},x={a:function(e,t,r){m.lastIndex=0
...
return n?(e.m=b.get(n[0].toLowerCase()),r+n[0].length):-1},c:function(e,t,r){return f(e,w.c.toString(),t,r)},d:Jt,e:Jt,H:tr,I:tr,j:er,L:ir,m:Zt,M:rr,p:function(e,t,r){var n=h.get(t.slice(r,r+=2).toLowerCase())
return null==n?-1:(e.p=n,r)},S:nr,U:$t,w:Gt,W:Kt,x:function(e,t,r){return f(e,w.x.toString(),t,r)},X:function(e,t,r){return f(e,w.X.toString(),t,r)},y:Qt,Y:Yt,Z:Xt,"%":ar}
return c}Dt.year=It(function(e){return(e=Dt.day(e)).setMonth(0,1),e},function(e,t){e.setFullYear(e.getFullYear()+t)},function(e){return e.getFullYear()}),Dt.years=Dt.year.range,Dt.years.utc=Dt.year.utc.range,Dt.day=It(function(e){var t=new Pt(2e3,0)
return t.setFullYear(e.getFullYear(),e.getMonth(),e.getDate()),t},function(e,t){e.setDate(e.getDate()+t)},function(e){return e.getDate()-1}),Dt.days=Dt.day.range,Dt.days.utc=Dt.day.utc.range,Dt.dayOfYear=function(e){var t=Dt.year(e)
...
var r=Dt[e]=It(function(e){return(e=Dt.day(e)).setDate(e.getDate()-(e.getDay()+t)%7),e},function(e,t){e.setDate(e.getDate()+7*Math.floor(t))},function(e){var r=Dt.year(e).getDay()
return Math.floor((Dt.dayOfYear(e)+(r+t)%7)/7)-(r!==t)})
Dt[e+"s"]=r.range,Dt[e+"s"].utc=r.utc.range,Dt[e+"OfYear"]=function(e){var r=Dt.year(e).getDay()
return Math.floor((Dt.dayOfYear(e)+(r+t)%7)/7)}}),Dt.week=Dt.sunday,Dt.weeks=Dt.sunday.range,Dt.weeks.utc=Dt.sunday.utc.range,Dt.weekOfYear=Dt.sundayOfYear
var Ft={"-":"",_:" ",0:"0"},Ht=/^\s*\d+/,Wt=/^%/
function zt(e,t,r){var n=e<0?"-":"",i=(n?-e:e)+"",o=i.length
return n+(o<r?new Array(r-o+1).join(t)+i:i)}function qt(t){return new RegExp("^(?:"+t.map(e.requote).join("|")+")","i")}function Ut(e){for(var t=new y,r=-1,n=e.length;++r<n;)t.set(e[r].toLowerCase(),r)
return t}function Gt(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r,r+1))
return n?(e.w=+n[0],r+n[0].length):-1}function $t(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r))
return n?(e.U=+n[0],r+n[0].length):-1}function Kt(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r))
return n?(e.W=+n[0],r+n[0].length):-1}function Yt(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r,r+4))
return n?(e.y=+n[0],r+n[0].length):-1}function Qt(e,t,r){Ht.lastIndex=0
var n,i=Ht.exec(t.slice(r,r+2))
return i?(e.y=(n=+i[0])+(n>68?1900:2e3),r+i[0].length):-1}function Xt(e,t,r){return/^[+-]\d{4}$/.test(t=t.slice(r,r+5))?(e.Z=-t,r+5):-1}function Zt(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r,r+2))
return n?(e.m=n[0]-1,r+n[0].length):-1}function Jt(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r,r+2))
return n?(e.d=+n[0],r+n[0].length):-1}function er(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r,r+3))
return n?(e.j=+n[0],r+n[0].length):-1}function tr(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r,r+2))
return n?(e.H=+n[0],r+n[0].length):-1}function rr(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r,r+2))
return n?(e.M=+n[0],r+n[0].length):-1}function nr(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r,r+2))
return n?(e.S=+n[0],r+n[0].length):-1}function ir(e,t,r){Ht.lastIndex=0
var n=Ht.exec(t.slice(r,r+3))
return n?(e.L=+n[0],r+n[0].length):-1}function or(e){var t=e.getTimezoneOffset(),r=t>0?"-":"+",n=v(t)/60|0,i=v(t)%60
return r+zt(n,"0",2)+zt(i,"0",2)}function ar(e,t,r){Wt.lastIndex=0
var n=Wt.exec(t.slice(r,r+1))
return n?r+n[0].length:-1}function sr(e){for(var t=e.length,r=-1;++r<t;)e[r][0]=this(e[r][0])
return function(t){for(var r=0,n=e[r];!n[1](t);)n=e[++r]
return n[0](t)}}e.locale=function(e){return{numberFormat:Tt(e),timeFormat:Vt(e)}}
var ur=e.locale({decimal:".",thousands:",",grouping:[3],currency:["$",""],dateTime:"%a %b %e %X %Y",date:"%m/%d/%Y",time:"%H:%M:%S",periods:["AM","PM"],days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],shortDays:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],shortMonths:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]})
function lr(){}e.format=ur.numberFormat,e.geo={},lr.prototype={s:0,t:0,add:function(e){fr(e,this.t,cr),fr(cr.s,this.s,this),this.s?this.t+=cr.t:this.s=cr.t},reset:function(){this.s=this.t=0},valueOf:function(){return this.s}}
var cr=new lr
function fr(e,t,r){var n=r.s=e+t,i=n-e,o=n-i
r.t=e-o+(t-i)}function hr(e,t){e&&pr.hasOwnProperty(e.type)&&pr[e.type](e,t)}e.geo.stream=function(e,t){e&&dr.hasOwnProperty(e.type)?dr[e.type](e,t):hr(e,t)}
var dr={Feature:function(e,t){hr(e.geometry,t)},FeatureCollection:function(e,t){for(var r=e.features,n=-1,i=r.length;++n<i;)hr(r[n].geometry,t)}},pr={Sphere:function(e,t){t.sphere()},Point:function(e,t){e=e.coordinates,t.point(e[0],e[1],e[2])},MultiPoint:function(e,t){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],t.point(e[0],e[1],e[2])},LineString:function(e,t){mr(e.coordinates,t,0)},MultiLineString:function(e,t){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)mr(r[n],t,0)},Polygon:function(e,t){gr(e.coordinates,t)},MultiPolygon:function(e,t){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)gr(r[n],t)},GeometryCollection:function(e,t){for(var r=e.geometries,n=-1,i=r.length;++n<i;)hr(r[n],t)}}
function mr(e,t,r){var n,i=-1,o=e.length-r
for(t.lineStart();++i<o;)n=e[i],t.point(n[0],n[1],n[2])
t.lineEnd()}function gr(e,t){var r=-1,n=e.length
for(t.polygonStart();++r<n;)mr(e[r],t,1)
t.polygonEnd()}e.geo.area=function(t){return vr=0,e.geo.stream(t,Or),vr}
var vr,br,yr,_r,wr,xr,Er,kr,Sr,Ar,Cr,Mr,Tr=new lr,Or={sphere:function(){vr+=4*ke},point:P,lineStart:P,lineEnd:P,polygonStart:function(){Tr.reset(),Or.lineStart=Nr},polygonEnd:function(){var e=2*Tr
vr+=e<0?4*ke+e:e,Or.lineStart=Or.lineEnd=Or.point=P}}
function Nr(){var e,t,r,n,i
function o(e,t){t=t*Me/2+ke/4
var o=(e*=Me)-r,a=o>=0?1:-1,s=a*o,u=Math.cos(t),l=Math.sin(t),c=i*l,f=n*u+c*Math.cos(s),h=c*a*Math.sin(s)
Tr.add(Math.atan2(h,f)),r=e,n=u,i=l}Or.point=function(a,s){Or.point=o,r=(e=a)*Me,n=Math.cos(s=(t=s)*Me/2+ke/4),i=Math.sin(s)},Or.lineEnd=function(){o(e,t)}}function Lr(e){var t=e[0],r=e[1],n=Math.cos(r)
return[n*Math.cos(t),n*Math.sin(t),Math.sin(r)]}function Dr(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]}function Pr(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function Rr(e,t){e[0]+=t[0],e[1]+=t[1],e[2]+=t[2]}function jr(e,t){return[e[0]*t,e[1]*t,e[2]*t]}function Ir(e){var t=Math.sqrt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2])
e[0]/=t,e[1]/=t,e[2]/=t}function Br(e){return[Math.atan2(e[1],e[0]),De(e[2])]}function Vr(e,t){return v(e[0]-t[0])<xe&&v(e[1]-t[1])<xe}e.geo.bounds=function(){var t,r,n,i,o,a,s,u,l,c,f,h={point:d,lineStart:m,lineEnd:g,polygonStart:function(){h.point=b,h.lineStart=y,h.lineEnd=_,l=0,Or.polygonStart()},polygonEnd:function(){Or.polygonEnd(),h.point=d,h.lineStart=m,h.lineEnd=g,Tr<0?(t=-(n=180),r=-(i=90)):l>xe?i=90:l<-xe&&(r=-90),f[0]=t,f[1]=n}}
function d(e,o){c.push(f=[t=e,n=e]),o<r&&(r=o),o>i&&(i=o)}function p(e,a){var s=Lr([e*Me,a*Me])
if(u){var l=Pr(u,s),c=Pr([l[1],-l[0],0],l)
Ir(c),c=Br(c)
var f=e-o,h=f>0?1:-1,p=c[0]*Te*h,m=v(f)>180
if(m^(h*o<p&&p<h*e))(g=c[1]*Te)>i&&(i=g)
else if(m^(h*o<(p=(p+360)%360-180)&&p<h*e)){var g;(g=-c[1]*Te)<r&&(r=g)}else a<r&&(r=a),a>i&&(i=a)
m?e<o?w(t,e)>w(t,n)&&(n=e):w(e,n)>w(t,n)&&(t=e):n>=t?(e<t&&(t=e),e>n&&(n=e)):e>o?w(t,e)>w(t,n)&&(n=e):w(e,n)>w(t,n)&&(t=e)}else d(e,a)
u=s,o=e}function m(){h.point=p}function g(){f[0]=t,f[1]=n,h.point=d,u=null}function b(e,t){if(u){var r=e-o
l+=v(r)>180?r+(r>0?360:-360):r}else a=e,s=t
Or.point(e,t),p(e,t)}function y(){Or.lineStart()}function _(){b(a,s),Or.lineEnd(),v(l)>xe&&(t=-(n=180)),f[0]=t,f[1]=n,u=null}function w(e,t){return(t-=e)<0?t+360:t}function x(e,t){return e[0]-t[0]}function E(e,t){return t[0]<=t[1]?t[0]<=e&&e<=t[1]:e<t[0]||t[1]<e}return function(o){if(i=n=-(t=r=1/0),c=[],e.geo.stream(o,h),l=c.length){c.sort(x)
for(var a=1,s=[m=c[0]];a<l;++a)E((d=c[a])[0],m)||E(d[1],m)?(w(m[0],d[1])>w(m[0],m[1])&&(m[1]=d[1]),w(d[0],m[1])>w(m[0],m[1])&&(m[0]=d[0])):s.push(m=d)
for(var u,l,d,p=-1/0,m=(a=0,s[l=s.length-1]);a<=l;m=d,++a)d=s[a],(u=w(m[1],d[0]))>p&&(p=u,t=d[0],n=m[1])}return c=f=null,t===1/0||r===1/0?[[NaN,NaN],[NaN,NaN]]:[[t,r],[n,i]]}}(),e.geo.centroid=function(t){br=yr=_r=wr=xr=Er=kr=Sr=Ar=Cr=Mr=0,e.geo.stream(t,Fr)
var r=Ar,n=Cr,i=Mr,o=r*r+n*n+i*i
return o<Ee&&(r=Er,n=kr,i=Sr,yr<xe&&(r=_r,n=wr,i=xr),(o=r*r+n*n+i*i)<Ee)?[NaN,NaN]:[Math.atan2(n,r)*Te,De(i/Math.sqrt(o))*Te]}
var Fr={sphere:P,point:Hr,lineStart:zr,lineEnd:qr,polygonStart:function(){Fr.lineStart=Ur},polygonEnd:function(){Fr.lineStart=zr}}
function Hr(e,t){e*=Me
var r=Math.cos(t*=Me)
Wr(r*Math.cos(e),r*Math.sin(e),Math.sin(t))}function Wr(e,t,r){_r+=(e-_r)/++br,wr+=(t-wr)/br,xr+=(r-xr)/br}function zr(){var e,t,r
function n(n,i){n*=Me
var o=Math.cos(i*=Me),a=o*Math.cos(n),s=o*Math.sin(n),u=Math.sin(i),l=Math.atan2(Math.sqrt((l=t*u-r*s)*l+(l=r*a-e*u)*l+(l=e*s-t*a)*l),e*a+t*s+r*u)
yr+=l,Er+=l*(e+(e=a)),kr+=l*(t+(t=s)),Sr+=l*(r+(r=u)),Wr(e,t,r)}Fr.point=function(i,o){i*=Me
var a=Math.cos(o*=Me)
e=a*Math.cos(i),t=a*Math.sin(i),r=Math.sin(o),Fr.point=n,Wr(e,t,r)}}function qr(){Fr.point=Hr}function Ur(){var e,t,r,n,i
function o(e,t){e*=Me
var o=Math.cos(t*=Me),a=o*Math.cos(e),s=o*Math.sin(e),u=Math.sin(t),l=n*u-i*s,c=i*a-r*u,f=r*s-n*a,h=Math.sqrt(l*l+c*c+f*f),d=r*a+n*s+i*u,p=h&&-Le(d)/h,m=Math.atan2(h,d)
Ar+=p*l,Cr+=p*c,Mr+=p*f,yr+=m,Er+=m*(r+(r=a)),kr+=m*(n+(n=s)),Sr+=m*(i+(i=u)),Wr(r,n,i)}Fr.point=function(a,s){e=a,t=s,Fr.point=o,a*=Me
var u=Math.cos(s*=Me)
r=u*Math.cos(a),n=u*Math.sin(a),i=Math.sin(s),Wr(r,n,i)},Fr.lineEnd=function(){o(e,t),Fr.lineEnd=qr,Fr.point=Hr}}function Gr(e,t){function r(r,n){return r=e(r,n),t(r[0],r[1])}return e.invert&&t.invert&&(r.invert=function(r,n){return(r=t.invert(r,n))&&e.invert(r[0],r[1])}),r}function $r(){return!0}function Kr(e,t,r,n,i){var o=[],a=[]
if(e.forEach(function(e){if(!((t=e.length-1)<=0)){var t,r=e[0],n=e[t]
if(Vr(r,n)){i.lineStart()
for(var s=0;s<t;++s)i.point((r=e[s])[0],r[1])
i.lineEnd()}else{var u=new Qr(r,e,null,!0),l=new Qr(r,null,u,!1)
u.o=l,o.push(u),a.push(l),u=new Qr(n,e,null,!1),l=new Qr(n,null,u,!0),u.o=l,o.push(u),a.push(l)}}}),a.sort(t),Yr(o),Yr(a),o.length){for(var s=0,u=r,l=a.length;s<l;++s)a[s].e=u=!u
...
i.lineEnd()}}}function Yr(e){if(t=e.length){for(var t,r,n=0,i=e[0];++n<t;)i.n=r=e[n],r.p=i,i=r
i.n=r=e[0],r.p=i}}function Qr(e,t,r,n){this.x=e,this.z=t,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Xr(t,r,n,i){return function(o,a){var s,u=r(a),l=o.invert(i[0],i[1]),c={point:f,lineStart:d,lineEnd:p,polygonStart:function(){c.point=_,c.lineStart=w,c.lineEnd=x,s=[],m=[]},polygonEnd:function(){c.point=f,c.lineStart=d,c.lineEnd=p,s=e.merge(s)
var t=function(e,t){var r=e[0],n=e[1],i=[Math.sin(r),-Math.cos(r),0],o=0,a=0
Tr.reset()
for(var s=0,u=t.length;s<u;++s){var l=t[s],c=l.length
if(c)for(var f=l[0],h=f[0],d=f[1]/2+ke/4,p=Math.sin(d),m=Math.cos(d),g=1;;){g===c&&(g=0)
var v=(e=l[g])[0],b=e[1]/2+ke/4,y=Math.sin(b),_=Math.cos(b),w=v-h,x=w>=0?1:-1,E=x*w,k=E>ke,S=p*y
if(Tr.add(Math.atan2(S*x*Math.sin(E),m*_+S*Math.cos(E))),o+=k?w+x*Se:w,k^h>=r^v>=r){var A=Pr(Lr(f),Lr(e))
Ir(A)
var C=Pr(i,A)
Ir(C)
var M=(k^w>=0?-1:1)*De(C[2]);(n>M||n===M&&(A[0]||A[1]))&&(a+=k^w>=0?1:-1)}if(!g++)break
h=v,p=y,m=_,f=e}}return(o<-xe||o<xe&&Tr<-xe)^1&a}(l,m)
s.length?(y||(a.polygonStart(),y=!0),Kr(s,en,t,n,a)):t&&(y||(a.polygonStart(),y=!0),a.lineStart(),n(null,null,1,a),a.lineEnd()),y&&(a.polygonEnd(),y=!1),s=m=null},sphere:function(){a.polygonStart(),a.lineStart(),n(null,null,1,a),a.lineEnd(),a.polygonEnd()}}
function f(e,r){var n=o(e,r)
t(e=n[0],r=n[1])&&a.point(e,r)}function h(e,t){var r=o(e,t)
u.point(r[0],r[1])}function d(){c.point=h,u.lineStart()}function p(){c.point=f,u.lineEnd()}var m,g,v=Jr(),b=r(v),y=!1
...
if(g.pop(),m.push(g),g=null,n)if(1&t){var i,o=-1
if((n=(e=r[0]).length-1)>0){for(y||(a.polygonStart(),y=!0),a.lineStart();++o<n;)a.point((i=e[o])[0],i[1])
a.lineEnd()}}else n>1&&2&t&&r.push(r.pop().concat(r.shift())),s.push(r.filter(Zr))}return c}}function Zr(e){return e.length>1}function Jr(){var e,t=[]
return{lineStart:function(){t.push(e=[])},point:function(t,r){e.push([t,r])},lineEnd:P,buffer:function(){var r=t
return t=[],e=null,r},rejoin:function(){t.length>1&&t.push(t.pop().concat(t.shift()))}}}function en(e,t){return((e=e.x)[0]<0?e[1]-Ce-xe:Ce-e[1])-((t=t.x)[0]<0?t[1]-Ce-xe:Ce-t[1])}var tn=Xr($r,function(e){var t,r=NaN,n=NaN,i=NaN
return{lineStart:function(){e.lineStart(),t=1},point:function(o,a){var s=o>0?ke:-ke,u=v(o-r)
v(u-ke)<xe?(e.point(r,n=(n+a)/2>0?Ce:-Ce),e.point(i,n),e.lineEnd(),e.lineStart(),e.point(s,n),e.point(o,n),t=0):i!==s&&u>=ke&&(v(r-i)<xe&&(r-=i*xe),v(o-s)<xe&&(o-=s*xe),n=function(e,t,r,n){var i,o,a=Math.sin(e-r)
return v(a)>xe?Math.atan((Math.sin(t)*(o=Math.cos(n))*Math.sin(r)-Math.sin(n)*(i=Math.cos(t))*Math.sin(e))/(i*o*a)):(t+n)/2}(r,n,o,a),e.point(i,n),e.lineEnd(),e.lineStart(),e.point(s,n),t=0),e.point(r=o,n=a),i=s},lineEnd:function(){e.lineEnd(),r=n=NaN},clean:function(){return 2-t}}},function(e,t,r,n){var i
if(null==e)i=r*Ce,n.point(-ke,i),n.point(0,i),n.point(ke,i),n.point(ke,0),n.point(ke,-i),n.point(0,-i),n.point(-ke,-i),n.point(-ke,0),n.point(-ke,i)
else if(v(e[0]-t[0])>xe){var o=e[0]<t[0]?ke:-ke
i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(t[0],t[1])},[-ke,-ke/2])
function rn(e,t,r,n){return function(i){var o,a=i.a,s=i.b,u=a.x,l=a.y,c=0,f=1,h=s.x-u,d=s.y-l
...
o<f&&(f=o)}return c>0&&(i.a={x:u+c*h,y:l+c*d}),f<1&&(i.b={x:u+f*h,y:l+f*d}),i}}}}}}var nn=1e9
function on(t,r,n,i){return function(u){var l,c,f,h,d,p,m,g,v,b,y,_=u,w=Jr(),x=rn(t,r,n,i),E={point:A,lineStart:function(){E.point=C,c&&c.push(f=[])
b=!0,v=!1,m=g=NaN},lineEnd:function(){l&&(C(h,d),p&&v&&w.rejoin(),l.push(w.buffer()))
E.point=A,v&&u.lineEnd()},polygonStart:function(){u=w,l=[],c=[],y=!0},polygonEnd:function(){u=_,l=e.merge(l)
var r=function(e){for(var t=0,r=c.length,n=e[1],i=0;i<r;++i)for(var o,a=1,s=c[i],u=s.length,l=s[0];a<u;++a)o=s[a],l[1]<=n?o[1]>n&&Ne(l,o,e)>0&&++t:o[1]<=n&&Ne(l,o,e)<0&&--t,l=o
return 0!==t}([t,i]),n=y&&r,o=l.length;(n||o)&&(u.polygonStart(),n&&(u.lineStart(),k(null,null,1,u),u.lineEnd()),o&&Kr(l,a,r,k,u),u.polygonEnd()),l=c=f=null}}
function k(e,a,u,l){var c=0,f=0
if(null==e||(c=o(e,u))!==(f=o(a,u))||s(e,a)<0^u>0)do{l.point(0===c||3===c?t:n,c>1?i:r)}while((c=(c+u+4)%4)!==f)
else l.point(a[0],a[1])}function S(e,o){return t<=e&&e<=n&&r<=o&&o<=i}function A(e,t){S(e,t)&&u.point(e,t)}function C(e,t){var r=S(e=Math.max(-nn,Math.min(nn,e)),t=Math.max(-nn,Math.min(nn,t)))
...
function o(e,i){return v(e[0]-t)<xe?i>0?0:3:v(e[0]-n)<xe?i>0?2:1:v(e[1]-r)<xe?i>0?1:0:i>0?3:2}function a(e,t){return s(e.x,t.x)}function s(e,t){var r=o(e,1),n=o(t,1)
return r!==n?r-n:0===r?t[1]-e[1]:1===r?e[0]-t[0]:2===r?e[1]-t[1]:t[0]-e[0]}}function an(e){var t=0,r=ke/3,n=On(e),i=n(t,r)
return i.parallels=function(e){return arguments.length?n(t=e[0]*ke/180,r=e[1]*ke/180):[t/ke*180,r/ke*180]},i}function sn(e,t){var r=Math.sin(e),n=(r+Math.sin(t))/2,i=1+r*(2*n-r),o=Math.sqrt(i)/n
...
return[Math.atan2(e,r)/n,De((i-(e*e+r*r)*n*n)/(2*n))]},a}e.geo.clipExtent=function(){var e,t,r,n,i,o,a={stream:function(e){return i&&(i.valid=!1),(i=o(e)).valid=!0,i},extent:function(s){return arguments.length?(o=on(e=+s[0][0],t=+s[0][1],r=+s[1][0],n=+s[1][1]),i&&(i.valid=!1,i=null),a):[[e,t],[r,n]]}}
return a.extent([[0,0],[960,500]])},(e.geo.conicEqualArea=function(){return an(sn)}).raw=sn,e.geo.albers=function(){return e.geo.conicEqualArea().rotate([96,0]).center([-.6,38.7]).parallels([29.5,45.5]).scale(1070)},e.geo.albersUsa=function(){var t,r,n,i,o=e.geo.albers(),a=e.geo.conicEqualArea().rotate([154,0]).center([-2,58.5]).parallels([55,65]),s=e.geo.conicEqualArea().rotate([157,0]).center([-3,19.9]).parallels([8,18]),u={point:function(e,r){t=[e,r]}}
function l(e){var o=e[0],a=e[1]
return t=null,r(o,a),t||(n(o,a),t)||i(o,a),t}return l.invert=function(e){var t=o.scale(),r=o.translate(),n=(e[0]-r[0])/t,i=(e[1]-r[1])/t
return(i>=.12&&i<.234&&n>=-.425&&n<-.214?a:i>=.166&&i<.234&&n>=-.214&&n<-.115?s:o).invert(e)},l.stream=function(e){var t=o.stream(e),r=a.stream(e),n=s.stream(e)
...
var t=o.scale(),c=+e[0],f=+e[1]
return r=o.translate(e).clipExtent([[c-.455*t,f-.238*t],[c+.455*t,f+.238*t]]).stream(u).point,n=a.translate([c-.307*t,f+.201*t]).clipExtent([[c-.425*t+xe,f+.12*t+xe],[c-.214*t-xe,f+.234*t-xe]]).stream(u).point,i=s.translate([c-.205*t,f+.212*t]).clipExtent([[c-.214*t+xe,f+.166*t+xe],[c-.115*t-xe,f+.234*t-xe]]).stream(u).point,l},l.scale(1070)}
var un,ln,cn,fn,hn,dn,pn={point:P,lineStart:P,lineEnd:P,polygonStart:function(){ln=0,pn.lineStart=mn},polygonEnd:function(){pn.lineStart=pn.lineEnd=pn.point=P,un+=v(ln/2)}}
function mn(){var e,t,r,n
function i(e,t){ln+=n*e-r*t,r=e,n=t}pn.point=function(o,a){pn.point=i,e=r=o,t=n=a},pn.lineEnd=function(){i(e,t)}}var gn={point:function(e,t){e<cn&&(cn=e)
e>hn&&(hn=e)
t<fn&&(fn=t)
t>dn&&(dn=t)},lineStart:P,lineEnd:P,polygonStart:P,polygonEnd:P}
function vn(){var e=bn(4.5),t=[],r={point:n,lineStart:function(){r.point=i},lineEnd:a,polygonStart:function(){r.lineEnd=s},polygonEnd:function(){r.lineEnd=a,r.point=n},pointRadius:function(t){return e=bn(t),r},result:function(){if(t.length){var e=t.join("")
return t=[],e}}}
function n(r,n){t.push("M",r,",",n,e)}function i(e,n){t.push("M",e,",",n),r.point=o}function o(e,r){t.push("L",e,",",r)}function a(){r.point=n}function s(){t.push("Z")}return r}function bn(e){return"m0,"+e+"a"+e+","+e+" 0 1,1 0,"+-2*e+"a"+e+","+e+" 0 1,1 0,"+2*e+"z"}var yn,_n={point:wn,lineStart:xn,lineEnd:En,polygonStart:function(){_n.lineStart=kn},polygonEnd:function(){_n.point=wn,_n.lineStart=xn,_n.lineEnd=En}}
function wn(e,t){_r+=e,wr+=t,++xr}function xn(){var e,t
function r(r,n){var i=r-e,o=n-t,a=Math.sqrt(i*i+o*o)
Er+=a*(e+r)/2,kr+=a*(t+n)/2,Sr+=a,wn(e=r,t=n)}_n.point=function(n,i){_n.point=r,wn(e=n,t=i)}}function En(){_n.point=wn}function kn(){var e,t,r,n
function i(e,t){var i=e-r,o=t-n,a=Math.sqrt(i*i+o*o)
Er+=a*(r+e)/2,kr+=a*(n+t)/2,Sr+=a,Ar+=(a=n*e-r*t)*(r+e),Cr+=a*(n+t),Mr+=3*a,wn(r=e,n=t)}_n.point=function(o,a){_n.point=i,wn(e=r=o,t=n=a)},_n.lineEnd=function(){i(e,t)}}function Sn(e){var t=4.5,r={point:n,lineStart:function(){r.point=i},lineEnd:a,polygonStart:function(){r.lineEnd=s},polygonEnd:function(){r.lineEnd=a,r.point=n},pointRadius:function(e){return t=e,r},result:P}
function n(r,n){e.moveTo(r+t,n),e.arc(r,n,t,0,Se)}function i(t,n){e.moveTo(t,n),r.point=o}function o(t,r){e.lineTo(t,r)}function a(){r.point=n}function s(){e.closePath()}return r}function An(e){var t=.5,r=Math.cos(30*Me),n=16
...
function v(r,n){r=e(r,n),t.point(r[0],r[1])}function b(){f=NaN,g.point=y,t.lineStart()}function y(r,i){var a=Lr([r,i]),s=e(r,i)
o(f,h,c,d,p,m,f=s[0],h=s[1],c=r,d=a[0],p=a[1],m=a[2],n,t),t.point(f,h)}function _(){g.point=v,t.lineEnd()}function w(){b(),g.point=x,g.lineEnd=E}function x(e,t){y(r=e,t),i=f,a=h,s=d,u=p,l=m,g.point=y}function E(){o(f,h,c,d,p,m,i,a,r,s,u,l,n,t),g.lineEnd=_,_()}return g}:function(t){return Mn(t,function(r,n){r=e(r,n),t.point(r[0],r[1])})})(t)}function o(n,i,a,s,u,l,c,f,h,d,p,m,g,b){var y=c-n,_=f-i,w=y*y+_*_
if(w>4*t&&g--){var x=s+d,E=u+p,k=l+m,S=Math.sqrt(x*x+E*E+k*k),A=Math.asin(k/=S),C=v(v(k)-1)<xe||v(a-h)<xe?(a+h)/2:Math.atan2(E,x),M=e(C,A),T=M[0],O=M[1],N=T-n,L=O-i,D=_*N-y*L;(D*D/w>t||v((y*N+_*L)/w-.5)>.3||s*d+u*p+l*m<r)&&(o(n,i,a,s,u,l,T,O,C,x/=S,E/=S,k,g,b),b.point(T,O),o(T,O,C,x,E,k,c,f,h,d,p,m,g,b))}}return i.precision=function(e){return arguments.length?(n=(t=e*e)>0&&16,i):Math.sqrt(t)},i}function Cn(e){this.stream=e}function Mn(e,t){return{point:t,sphere:function(){e.sphere()},lineStart:function(){e.lineStart()},lineEnd:function(){e.lineEnd()},polygonStart:function(){e.polygonStart()},polygonEnd:function(){e.polygonEnd()}}}function Tn(e){return On(function(){return e})()}function On(t){var r,n,i,o,a,s,u=An(function(e,t){return[(e=r(e,t))[0]*l+o,a-e[1]*l]}),l=150,c=480,f=250,h=0,d=0,p=0,m=0,g=0,b=tn,y=O,_=null,w=null
function x(e){return[(e=i(e[0]*Me,e[1]*Me))[0]*l+o,a-e[1]*l]}function E(e){return(e=i.invert((e[0]-o)/l,(a-e[1])/l))&&[e[0]*Te,e[1]*Te]}function k(){i=Gr(n=Pn(p,m,g),r)
var e=r(h,d)
return o=c-e[0]*l,a=f+e[1]*l,S()}function S(){return s&&(s.valid=!1,s=null),x}return x.stream=function(e){return s&&(s.valid=!1),(s=Nn(b(n,u(y(e))))).valid=!0,s},x.clipAngle=function(e){return arguments.length?(b=null==e?(_=e,tn):function(e){var t=Math.cos(e),r=t>0,n=v(t)>xe
return Xr(i,function(e){var t,s,u,l,c
return{lineStart:function(){l=u=!1,c=1},point:function(f,h){var d,p=[f,h],m=i(f,h),g=r?m?0:a(f,h):m?a(f+(f<0?ke:-ke),h):0
if(!t&&(l=u=m)&&e.lineStart(),m!==u&&(d=o(t,p),(Vr(t,d)||Vr(p,d))&&(p[0]+=xe,p[1]+=xe,m=i(p[0],p[1]))),m!==u)c=0,m?(e.lineStart(),d=o(p,t),e.point(d[0],d[1])):(d=o(t,p),e.point(d[0],d[1]),e.lineEnd()),t=d
else if(n&&t&&r^m){var v
g&s||!(v=o(p,t,!0))||(c=0,r?(e.lineStart(),e.point(v[0][0],v[0][1]),e.point(v[1][0],v[1][1]),e.lineEnd()):(e.point(v[1][0],v[1][1]),e.lineEnd(),e.lineStart(),e.point(v[0][0],v[0][1])))}!m||t&&Vr(t,p)||e.point(p[0],p[1]),t=p,u=m,s=g},lineEnd:function(){u&&e.lineEnd(),t=null},clean:function(){return c|(l&&u)<<1}}},Bn(e,6*Me),r?[0,-e]:[-ke,e-ke])
function i(e,r){return Math.cos(e)*Math.cos(r)>t}function o(e,r,n){var i=[1,0,0],o=Pr(Lr(e),Lr(r)),a=Dr(o,o),s=o[0],u=a-s*s
if(!u)return!n&&e
var l=t*a/u,c=-t*s/u,f=Pr(i,o),h=jr(i,l)
Rr(h,jr(o,c))
var d=f,p=Dr(h,d),m=Dr(d,d),g=p*p-m*(Dr(h,h)-1)
if(!(g<0)){var b=Math.sqrt(g),y=jr(d,(-p-b)/m)
if(Rr(y,h),y=Br(y),!n)return y
var _,w=e[0],x=r[0],E=e[1],k=r[1]
x<w&&(_=w,w=x,x=_)
var S=x-w,A=v(S-ke)<xe
if(!A&&k<E&&(_=E,E=k,k=_),A||S<xe?A?E+k>0^y[1]<(v(y[0]-w)<xe?E:k):E<=y[1]&&y[1]<=k:S>ke^(w<=y[0]&&y[0]<=x)){var C=jr(d,(-p+b)/m)
return Rr(C,h),[y,Br(C)]}}}function a(t,n){var i=r?e:ke-e,o=0
return t<-i?o|=1:t>i&&(o|=2),n<-i?o|=4:n>i&&(o|=8),o}}((_=+e)*Me),S()):_},x.clipExtent=function(e){return arguments.length?(w=e,y=e?on(e[0][0],e[0][1],e[1][0],e[1][1]):O,S()):w},x.scale=function(e){return arguments.length?(l=+e,k()):l},x.translate=function(e){return arguments.length?(c=+e[0],f=+e[1],k()):[c,f]},x.center=function(e){return arguments.length?(h=e[0]%360*Me,d=e[1]%360*Me,k()):[h*Te,d*Te]},x.rotate=function(e){return arguments.length?(p=e[0]%360*Me,m=e[1]%360*Me,g=e.length>2?e[2]%360*Me:0,k()):[p*Te,m*Te,g*Te]},e.rebind(x,u,"precision"),function(){return r=t.apply(this,arguments),x.invert=r.invert&&E,k()}}function Nn(e){return Mn(e,function(t,r){e.point(t*Me,r*Me)})}function Ln(e,t){return[e,t]}function Dn(e,t){return[e>ke?e-Se:e<-ke?e+Se:e,t]}function Pn(e,t,r){return e?t||r?Gr(jn(e),In(t,r)):jn(e):t||r?In(t,r):Dn}function Rn(e){return function(t,r){return[(t+=e)>ke?t-Se:t<-ke?t+Se:t,r]}}function jn(e){var t=Rn(e)
return t.invert=Rn(-e),t}function In(e,t){var r=Math.cos(e),n=Math.sin(e),i=Math.cos(t),o=Math.sin(t)
function a(e,t){var a=Math.cos(t),s=Math.cos(e)*a,u=Math.sin(e)*a,l=Math.sin(t),c=l*r+s*n
return[Math.atan2(u*i-c*o,s*r-l*n),De(c*i+u*o)]}return a.invert=function(e,t){var a=Math.cos(t),s=Math.cos(e)*a,u=Math.sin(e)*a,l=Math.sin(t),c=l*i-u*o
return[Math.atan2(u*i+l*o,s*r+c*n),De(c*r-s*n)]},a}function Bn(e,t){var r=Math.cos(e),n=Math.sin(e)
return function(i,o,a,s){var u=a*t
null!=i?(i=Vn(r,i),o=Vn(r,o),(a>0?i<o:i>o)&&(i+=a*Se)):(i=e+a*Se,o=e-.5*u)
for(var l,c=i;a>0?c>o:c<o;c-=u)s.point((l=Br([r,-n*Math.cos(c),-n*Math.sin(c)]))[0],l[1])}}function Vn(e,t){var r=Lr(t)
r[0]-=e,Ir(r)
var n=Le(-r[1])
return((-r[2]<0?-n:n)+2*Math.PI-xe)%(2*Math.PI)}function Fn(t,r,n){var i=e.range(t,r-xe,n).concat(r)
return function(e){return i.map(function(t){return[e,t]})}}function Hn(t,r,n){var i=e.range(t,r-xe,n).concat(r)
return function(e){return i.map(function(t){return[t,e]})}}function Wn(e){return e.source}function zn(e){return e.target}e.geo.path=function(){var t,r,n,i,o,a=4.5
function s(t){return t&&("function"==typeof a&&i.pointRadius(+a.apply(this,arguments)),o&&o.valid||(o=n(i)),e.geo.stream(t,o)),i.result()}function u(){return o=null,s}return s.area=function(t){return un=0,e.geo.stream(t,n(pn)),un},s.centroid=function(t){return _r=wr=xr=Er=kr=Sr=Ar=Cr=Mr=0,e.geo.stream(t,n(_n)),Mr?[Ar/Mr,Cr/Mr]:Sr?[Er/Sr,kr/Sr]:xr?[_r/xr,wr/xr]:[NaN,NaN]},s.bounds=function(t){return hn=dn=-(cn=fn=1/0),e.geo.stream(t,n(gn)),[[cn,fn],[hn,dn]]},s.projection=function(e){return arguments.length?(n=(t=e)?e.stream||(r=e,i=An(function(e,t){return r([e*Te,t*Te])}),function(e){return Nn(i(e))}):O,u()):t
var r,i},s.context=function(e){return arguments.length?(i=null==(r=e)?new vn:new Sn(e),"function"!=typeof a&&i.pointRadius(a),u()):r},s.pointRadius=function(e){return arguments.length?(a="function"==typeof e?e:(i.pointRadius(+e),+e),s):a},s.projection(e.geo.albersUsa()).context(null)},e.geo.transform=function(e){return{stream:function(t){var r=new Cn(t)
for(var n in e)r[n]=e[n]
return r}}},Cn.prototype={point:function(e,t){this.stream.point(e,t)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}},e.geo.projection=Tn,e.geo.projectionMutator=On,(e.geo.equirectangular=function(){return Tn(Ln)}).raw=Ln.invert=Ln,e.geo.rotation=function(e){function t(t){return(t=e(t[0]*Me,t[1]*Me))[0]*=Te,t[1]*=Te,t}return e=Pn(e[0]%360*Me,e[1]*Me,e.length>2?e[2]*Me:0),t.invert=function(t){return(t=e.invert(t[0]*Me,t[1]*Me))[0]*=Te,t[1]*=Te,t},t},Dn.invert=Ln,e.geo.circle=function(){var e,t,r=[0,0],n=6
function i(){var e="function"==typeof r?r.apply(this,arguments):r,n=Pn(-e[0]*Me,-e[1]*Me,0).invert,i=[]
return t(null,null,1,{point:function(e,t){i.push(e=n(e,t)),e[0]*=Te,e[1]*=Te}}),{type:"Polygon",coordinates:[i]}}return i.origin=function(e){return arguments.length?(r=e,i):r},i.angle=function(r){return arguments.length?(t=Bn((e=+r)*Me,n*Me),i):e},i.precision=function(r){return arguments.length?(t=Bn(e*Me,(n=+r)*Me),i):n},i.angle(90)},e.geo.distance=function(e,t){var r,n=(t[0]-e[0])*Me,i=e[1]*Me,o=t[1]*Me,a=Math.sin(n),s=Math.cos(n),u=Math.sin(i),l=Math.cos(i),c=Math.sin(o),f=Math.cos(o)
return Math.atan2(Math.sqrt((r=f*a)*r+(r=l*c-u*f*s)*r),u*c+l*f*s)},e.geo.graticule=function(){var t,r,n,i,o,a,s,u,l,c,f,h,d=10,p=d,m=90,g=360,b=2.5
function y(){return{type:"MultiLineString",coordinates:_()}}function _(){return e.range(Math.ceil(i/m)*m,n,m).map(f).concat(e.range(Math.ceil(u/g)*g,s,g).map(h)).concat(e.range(Math.ceil(r/d)*d,t,d).filter(function(e){return v(e%m)>xe}).map(l)).concat(e.range(Math.ceil(a/p)*p,o,p).filter(function(e){return v(e%g)>xe}).map(c))}return y.lines=function(){return _().map(function(e){return{type:"LineString",coordinates:e}})},y.outline=function(){return{type:"Polygon",coordinates:[f(i).concat(h(s).slice(1),f(n).reverse().slice(1),h(u).reverse().slice(1))]}},y.extent=function(e){return arguments.length?y.majorExtent(e).minorExtent(e):y.minorExtent()},y.majorExtent=function(e){return arguments.length?(i=+e[0][0],n=+e[1][0],u=+e[0][1],s=+e[1][1],i>n&&(e=i,i=n,n=e),u>s&&(e=u,u=s,s=e),y.precision(b)):[[i,u],[n,s]]},y.minorExtent=function(e){return arguments.length?(r=+e[0][0],t=+e[1][0],a=+e[0][1],o=+e[1][1],r>t&&(e=r,r=t,t=e),a>o&&(e=a,a=o,o=e),y.precision(b)):[[r,a],[t,o]]},y.step=function(e){return arguments.length?y.majorStep(e).minorStep(e):y.minorStep()},y.majorStep=function(e){return arguments.length?(m=+e[0],g=+e[1],y):[m,g]},y.minorStep=function(e){return arguments.length?(d=+e[0],p=+e[1],y):[d,p]},y.precision=function(e){return arguments.length?(b=+e,l=Fn(a,o,90),c=Hn(r,t,b),f=Fn(u,s,90),h=Hn(i,n,b),y):b},y.majorExtent([[-180,-90+xe],[180,90-xe]]).minorExtent([[-180,-80-xe],[180,80+xe]])},e.geo.greatArc=function(){var t,r,n=Wn,i=zn
function o(){return{type:"LineString",coordinates:[t||n.apply(this,arguments),r||i.apply(this,arguments)]}}return o.distance=function(){return e.geo.distance(t||n.apply(this,arguments),r||i.apply(this,arguments))},o.source=function(e){return arguments.length?(n=e,t="function"==typeof e?null:e,o):n},o.target=function(e){return arguments.length?(i=e,r="function"==typeof e?null:e,o):i},o.precision=function(){return arguments.length?o:0},o},e.geo.interpolate=function(e,t){return r=e[0]*Me,n=e[1]*Me,i=t[0]*Me,o=t[1]*Me,a=Math.cos(n),s=Math.sin(n),u=Math.cos(o),l=Math.sin(o),c=a*Math.cos(r),f=a*Math.sin(r),h=u*Math.cos(i),d=u*Math.sin(i),p=2*Math.asin(Math.sqrt(Re(o-n)+a*u*Re(i-r))),m=1/Math.sin(p),(g=p?function(e){var t=Math.sin(e*=p)*m,r=Math.sin(p-e)*m,n=r*c+t*h,i=r*f+t*d,o=r*s+t*l
return[Math.atan2(i,n)*Te,Math.atan2(o,Math.sqrt(n*n+i*i))*Te]}:function(){return[r*Te,n*Te]}).distance=p,g
var r,n,i,o,a,s,u,l,c,f,h,d,p,m,g},e.geo.length=function(t){return yn=0,e.geo.stream(t,qn),yn}
var qn={sphere:P,point:P,lineStart:function(){var e,t,r
function n(n,i){var o=Math.sin(i*=Me),a=Math.cos(i),s=v((n*=Me)-e),u=Math.cos(s)
yn+=Math.atan2(Math.sqrt((s=a*Math.sin(s))*s+(s=r*o-t*a*u)*s),t*o+r*a*u),e=n,t=o,r=a}qn.point=function(i,o){e=i*Me,t=Math.sin(o*=Me),r=Math.cos(o),qn.point=n},qn.lineEnd=function(){qn.point=qn.lineEnd=P}},lineEnd:P,polygonStart:P,polygonEnd:P}
function Un(e,t){function r(t,r){var n=Math.cos(t),i=Math.cos(r),o=e(n*i)
return[o*i*Math.sin(t),o*Math.sin(r)]}return r.invert=function(e,r){var n=Math.sqrt(e*e+r*r),i=t(n),o=Math.sin(i),a=Math.cos(i)
return[Math.atan2(e*o,n*a),Math.asin(n&&r*o/n)]},r}var Gn=Un(function(e){return Math.sqrt(2/(1+e))},function(e){return 2*Math.asin(e/2)});(e.geo.azimuthalEqualArea=function(){return Tn(Gn)}).raw=Gn
var $n=Un(function(e){var t=Math.acos(e)
return t&&t/Math.sin(t)},O)
function Kn(e,t){var r=Math.cos(e),n=function(e){return Math.tan(ke/4+e/2)},i=e===t?Math.sin(e):Math.log(r/Math.cos(t))/Math.log(n(t)/n(e)),o=r*Math.pow(n(e),i)/i
if(!i)return Xn
function a(e,t){o>0?t<-Ce+xe&&(t=-Ce+xe):t>Ce-xe&&(t=Ce-xe)
var r=o/Math.pow(n(t),i)
return[r*Math.sin(i*e),o-r*Math.cos(i*e)]}return a.invert=function(e,t){var r=o-t,n=Oe(i)*Math.sqrt(e*e+r*r)
return[Math.atan2(e,r)/i,2*Math.atan(Math.pow(o/n,1/i))-Ce]},a}function Yn(e,t){var r=Math.cos(e),n=e===t?Math.sin(e):(r-Math.cos(t))/(t-e),i=r/n+e
if(v(n)<xe)return Ln
function o(e,t){var r=i-t
return[r*Math.sin(n*e),i-r*Math.cos(n*e)]}return o.invert=function(e,t){var r=i-t
return[Math.atan2(e,r)/n,i-Oe(n)*Math.sqrt(e*e+r*r)]},o}(e.geo.azimuthalEquidistant=function(){return Tn($n)}).raw=$n,(e.geo.conicConformal=function(){return an(Kn)}).raw=Kn,(e.geo.conicEquidistant=function(){return an(Yn)}).raw=Yn
var Qn=Un(function(e){return 1/e},Math.atan)
function Xn(e,t){return[e,Math.log(Math.tan(ke/4+t/2))]}function Zn(e){var t,r=Tn(e),n=r.scale,i=r.translate,o=r.clipExtent
...
if(a===r){if(t=null==e){var s=ke*n(),u=i()
o([[u[0]-s,u[1]-s],[u[0]+s,u[1]+s]])}}else t&&(a=null)
return a},r.clipExtent(null)}(e.geo.gnomonic=function(){return Tn(Qn)}).raw=Qn,Xn.invert=function(e,t){return[e,2*Math.atan(Math.exp(t))-Ce]},(e.geo.mercator=function(){return Zn(Xn)}).raw=Xn
var Jn=Un(function(){return 1},Math.asin);(e.geo.orthographic=function(){return Tn(Jn)}).raw=Jn
var ei=Un(function(e){return 1/(1+e)},function(e){return 2*Math.atan(e)})
function ti(e,t){return[Math.log(Math.tan(ke/4+t/2)),-e]}function ri(e){return e[0]}function ni(e){return e[1]}function ii(e){for(var t=e.length,r=[0,1],n=2,i=2;i<t;i++){for(;n>1&&Ne(e[r[n-2]],e[r[n-1]],e[i])<=0;)--n
r[n++]=i}return r.slice(0,n)}function oi(e,t){return e[0]-t[0]||e[1]-t[1]}(e.geo.stereographic=function(){return Tn(ei)}).raw=ei,ti.invert=function(e,t){return[-t,2*Math.atan(Math.exp(e))-Ce]},(e.geo.transverseMercator=function(){var e=Zn(ti),t=e.center,r=e.rotate
return e.center=function(e){return e?t([-e[1],e[0]]):[(e=t())[1],-e[0]]},e.rotate=function(e){return e?r([e[0],e[1],e.length>2?e[2]+90:90]):[(e=r())[0],e[1],e[2]-90]},r([0,0,90])}).raw=ti,e.geom={},e.geom.hull=function(e){var t=ri,r=ni
if(arguments.length)return n(e)
function n(e){if(e.length<3)return[]
var n,i=mt(t),o=mt(r),a=e.length,s=[],u=[]
for(n=0;n<a;n++)s.push([+i.call(this,e[n],n),+o.call(this,e[n],n),n])
for(s.sort(oi),n=0;n<a;n++)u.push([s[n][0],-s[n][1]])
var l=ii(s),c=ii(u),f=c[0]===l[0],h=c[c.length-1]===l[l.length-1],d=[]
for(n=l.length-1;n>=0;--n)d.push(e[s[l[n]][2]])
for(n=+f;n<c.length-h;++n)d.push(e[s[c[n]][2]])
return d}return n.x=function(e){return arguments.length?(t=e,n):t},n.y=function(e){return arguments.length?(r=e,n):r},n},e.geom.polygon=function(e){return H(e,ai),e}
var ai=e.geom.polygon.prototype=[]
function si(e,t,r){return(r[0]-t[0])*(e[1]-t[1])<(r[1]-t[1])*(e[0]-t[0])}function ui(e,t,r,n){var i=e[0],o=r[0],a=t[0]-i,s=n[0]-o,u=e[1],l=r[1],c=t[1]-u,f=n[1]-l,h=(s*(u-l)-f*(i-o))/(f*a-s*c)
return[i+h*a,u+h*c]}function li(e){var t=e[0],r=e[e.length-1]
return!(t[0]-r[0]||t[1]-r[1])}ai.area=function(){for(var e,t=-1,r=this.length,n=this[r-1],i=0;++t<r;)e=n,n=this[t],i+=e[1]*n[0]-e[0]*n[1]
return.5*i},ai.centroid=function(e){var t,r,n=-1,i=this.length,o=0,a=0,s=this[i-1]
for(arguments.length||(e=-1/(6*this.area()));++n<i;)t=s,s=this[n],r=t[0]*s[1]-s[0]*t[1],o+=(t[0]+s[0])*r,a+=(t[1]+s[1])*r
return[o*e,a*e]},ai.clip=function(e){for(var t,r,n,i,o,a,s=li(e),u=-1,l=this.length-li(this),c=this[l-1];++u<l;){for(t=e.slice(),e.length=0,i=this[u],o=t[(n=t.length-s)-1],r=-1;++r<n;)si(a=t[r],c,i)?(si(o,c,i)||e.push(ui(o,a,c,i)),e.push(a)):si(o,c,i)&&e.push(ui(o,a,c,i)),o=a
s&&e.push(e[0]),c=i}return e}
var ci,fi,hi,di,pi,mi=[],gi=[]
function vi(){Ri(this),this.edge=this.site=this.circle=null}function bi(e){var t=mi.pop()||new vi
return t.site=e,t}function yi(e){Mi(e),hi.remove(e),mi.push(e),Ri(e)}function _i(e){var t=e.circle,r=t.x,n=t.cy,i={x:r,y:n},o=e.P,a=e.N,s=[e]
yi(e)
for(var u=o;u.circle&&v(r-u.circle.x)<xe&&v(n-u.circle.cy)<xe;)o=u.P,s.unshift(u),yi(u),u=o
s.unshift(u),Mi(u)
for(var l=a;l.circle&&v(r-l.circle.x)<xe&&v(n-l.circle.cy)<xe;)a=l.N,s.push(l),yi(l),l=a
s.push(l),Mi(l)
var c,f=s.length
for(c=1;c<f;++c)l=s[c],u=s[c-1],Li(l.edge,u.site,l.site,i)
u=s[0],(l=s[f-1]).edge=Ni(u.site,l.site,null,i),Ci(u),Ci(l)}function wi(e){for(var t,r,n,i,o=e.x,a=e.y,s=hi._;s;)if((n=xi(s,a)-o)>xe)s=s.L
else{if(!((i=o-Ei(s,a))>xe)){n>-xe?(t=s.P,r=s):i>-xe?(t=s,r=s.N):t=r=s
break}if(!s.R){t=s
break}s=s.R}var u=bi(e)
if(hi.insert(t,u),t||r){if(t===r)return Mi(t),r=bi(t.site),hi.insert(u,r),u.edge=r.edge=Ni(t.site,u.site),Ci(t),void Ci(r)
if(r){Mi(t),Mi(r)
...
Li(r.edge,l,p,_),u.edge=Ni(l,e,null,_),r.edge=Ni(e,p,null,_),Ci(t),Ci(r)}else u.edge=Ni(t.site,u.site)}}function xi(e,t){var r=e.site,n=r.x,i=r.y,o=i-t
if(!o)return n
var a=e.P
if(!a)return-1/0
...
return f?(-h+Math.sqrt(h*h-2*f*(c*c/(-2*l)-u+l/2+i-o/2)))/f+n:(n+s)/2}function Ei(e,t){var r=e.N
if(r)return xi(r,t)
var n=e.site
return n.y===t?n.x:1/0}function ki(e){this.site=e,this.edges=[]}function Si(e,t){return t.angle-e.angle}function Ai(){Ri(this),this.x=this.y=this.arc=this.site=this.cy=null}function Ci(e){var t=e.P,r=e.N
if(t&&r){var n=t.site,i=e.site,o=r.site
if(n!==o){var a=i.x,s=i.y,u=n.x-a,l=n.y-s,c=o.x-a,f=2*(u*(g=o.y-s)-l*c)
if(!(f>=-Ee)){var h=u*u+l*l,d=c*c+g*g,p=(g*h-l*d)/f,m=(u*d-c*h)/f,g=m+s,v=gi.pop()||new Ai
v.arc=e,v.site=i,v.x=p+a,v.y=g+Math.sqrt(p*p+m*m),v.cy=g,e.circle=v
for(var b=null,y=pi._;y;)if(v.y<y.y||v.y===y.y&&v.x<=y.x){if(!y.L){b=y.P
break}y=y.L}else{if(!y.R){b=y
break}y=y.R}pi.insert(b,v),b||(di=v)}}}}function Mi(e){var t=e.circle
t&&(t.P||(di=t.N),pi.remove(t),gi.push(t),Ri(t),e.circle=null)}function Ti(e,t){var r=e.b
if(r)return!0
...
r={x:a,y:n*a+i}}return e.a=o,e.b=r,!0}function Oi(e,t){this.l=e,this.r=t,this.a=this.b=null}function Ni(e,t,r,n){var i=new Oi(e,t)
return ci.push(i),r&&Li(i,e,t,r),n&&Li(i,t,e,n),fi[e.i].edges.push(new Di(i,e,t)),fi[t.i].edges.push(new Di(i,t,e)),i}function Li(e,t,r,n){e.a||e.b?e.l===r?e.b=n:e.a=n:(e.a=n,e.l=t,e.r=r)}function Di(e,t,r){var n=e.a,i=e.b
this.edge=e,this.site=t,this.angle=r?Math.atan2(r.y-t.y,r.x-t.x):e.l===t?Math.atan2(i.x-n.x,n.y-i.y):Math.atan2(n.x-i.x,i.y-n.y)}function Pi(){this._=null}function Ri(e){e.U=e.C=e.L=e.R=e.P=e.N=null}function ji(e,t){var r=t,n=t.R,i=r.U
i?i.L===r?i.L=n:i.R=n:e._=n,n.U=i,r.U=n,r.R=n.L,r.R&&(r.R.U=r),n.L=r}function Ii(e,t){var r=t,n=t.L,i=r.U
i?i.L===r?i.L=n:i.R=n:e._=n,n.U=i,r.U=n,r.L=n.R,r.L&&(r.L.U=r),n.R=r}function Bi(e){for(;e.L;)e=e.L
return e}function Vi(e,t){var r,n,i,o=e.sort(Fi).pop()
for(ci=[],fi=new Array(e.length),hi=new Pi,pi=new Pi;;)if(i=di,o&&(!i||o.y<i.y||o.y===i.y&&o.x<i.x))o.x===r&&o.y===n||(fi[o.i]=new ki(o),wi(o),r=o.x,n=o.y),o=e.pop()
else{if(!i)break
_i(i.arc)}t&&(function(e){for(var t,r=ci,n=rn(e[0][0],e[0][1],e[1][0],e[1][1]),i=r.length;i--;)(!Ti(t=r[i],e)||!n(t)||v(t.a.x-t.b.x)<xe&&v(t.a.y-t.b.y)<xe)&&(t.a=t.b=null,r.splice(i,1))}(t),function(e){for(var t,r,n,i,o,a,s,u,l,c,f=e[0][0],h=e[1][0],d=e[0][1],p=e[1][1],m=fi,g=m.length;g--;)if((o=m[g])&&o.prepare())for(u=(s=o.edges).length,a=0;a<u;)n=(c=s[a].end()).x,i=c.y,t=(l=s[++a%u].start()).x,r=l.y,(v(n-t)>xe||v(i-r)>xe)&&(s.splice(a,0,new Di((b=o.site,y=c,_=v(n-f)<xe&&p-i>xe?{x:f,y:v(t-f)<xe?r:p}:v(i-p)<xe&&h-n>xe?{x:v(r-p)<xe?t:h,y:p}:v(n-h)<xe&&i-d>xe?{x:h,y:v(t-h)<xe?r:d}:v(i-d)<xe&&n-f>xe?{x:v(r-d)<xe?t:f,y:d}:null,w=void 0,w=new Oi(b,null),w.a=y,w.b=_,ci.push(w),w),o.site,null)),++u)
var b,y,_,w}(t))
var a={cells:fi,edges:ci}
return hi=pi=ci=fi=null,a}function Fi(e,t){return t.y-e.y||t.x-e.x}ki.prototype.prepare=function(){for(var e,t=this.edges,r=t.length;r--;)(e=t[r].edge).b&&e.a||t.splice(r,1)
return t.sort(Si),t.length},Di.prototype={start:function(){return this.edge.l===this.site?this.edge.a:this.edge.b},end:function(){return this.edge.l===this.site?this.edge.b:this.edge.a}},Pi.prototype={insert:function(e,t){var r,n,i
if(e){if(t.P=e,t.N=e.N,e.N&&(e.N.P=t),e.N=t,e.R){for(e=e.R;e.L;)e=e.L
e.L=t}else e.R=t
r=e}else this._?(e=Bi(this._),t.P=null,t.N=e,e.P=e.L=t,r=e):(t.P=t.N=null,this._=t,r=null)
for(t.L=t.R=null,t.U=r,t.C=!0,e=t;r&&r.C;)r===(n=r.U).L?(i=n.R)&&i.C?(r.C=i.C=!1,n.C=!0,e=n):(e===r.R&&(ji(this,r),r=(e=r).U),r.C=!1,n.C=!0,Ii(this,n)):(i=n.L)&&i.C?(r.C=i.C=!1,n.C=!0,e=n):(e===r.L&&(Ii(this,r),r=(e=r).U),r.C=!1,n.C=!0,ji(this,n)),r=e.U
this._.C=!1},remove:function(e){e.N&&(e.N.P=e.P),e.P&&(e.P.N=e.N),e.N=e.P=null
var t,r,n,i=e.U,o=e.L,a=e.R
if(r=o?a?Bi(a):o:a,i?i.L===e?i.L=r:i.R=r:this._=r,o&&a?(n=r.C,r.C=e.C,r.L=o,o.U=r,r!==a?(i=r.U,r.U=e.U,e=r.R,i.L=e,r.R=a,a.U=r):(r.U=i,i=r,e=r.R)):(n=e.C,e=r),e&&(e.U=i),!n)if(e&&e.C)e.C=!1
else{do{if(e===this._)break
if(e===i.L){if((t=i.R).C&&(t.C=!1,i.C=!0,ji(this,i),t=i.R),t.L&&t.L.C||t.R&&t.R.C){t.R&&t.R.C||(t.L.C=!1,t.C=!0,Ii(this,t),t=i.R),t.C=i.C,i.C=t.R.C=!1,ji(this,i),e=this._
break}}else if((t=i.L).C&&(t.C=!1,i.C=!0,Ii(this,i),t=i.L),t.L&&t.L.C||t.R&&t.R.C){t.L&&t.L.C||(t.R.C=!1,t.C=!0,ji(this,t),t=i.L),t.C=i.C,i.C=t.L.C=!1,Ii(this,i),e=this._
break}t.C=!0,e=i,i=i.U}while(!e.C)
e&&(e.C=!1)}}},e.geom.voronoi=function(e){var t=ri,r=ni,n=t,i=r,o=Hi
if(e)return a(e)
function a(e){var t=new Array(e.length),r=o[0][0],n=o[0][1],i=o[1][0],a=o[1][1]
return Vi(s(e),o).cells.forEach(function(o,s){var u=o.edges,l=o.site;(t[s]=u.length?u.map(function(e){var t=e.start()
return[t.x,t.y]}):l.x>=r&&l.x<=i&&l.y>=n&&l.y<=a?[[r,a],[i,a],[i,n],[r,n]]:[]).point=e[s]}),t}function s(e){return e.map(function(e,t){return{x:Math.round(n(e,t)/xe)*xe,y:Math.round(i(e,t)/xe)*xe,i:t}})}return a.links=function(e){return Vi(s(e)).edges.filter(function(e){return e.l&&e.r}).map(function(t){return{source:e[t.l.i],target:e[t.r.i]}})},a.triangles=function(e){var t=[]
return Vi(s(e)).cells.forEach(function(r,n){for(var i,o,a,s,u=r.site,l=r.edges.sort(Si),c=-1,f=l.length,h=l[f-1].edge,d=h.l===u?h.r:h.l;++c<f;)h,i=d,d=(h=l[c].edge).l===u?h.r:h.l,n<i.i&&n<d.i&&(a=i,s=d,((o=u).x-s.x)*(a.y-o.y)-(o.x-a.x)*(s.y-o.y)<0)&&t.push([e[n],e[i.i],e[d.i]])}),t},a.x=function(e){return arguments.length?(n=mt(t=e),a):t},a.y=function(e){return arguments.length?(i=mt(r=e),a):r},a.clipExtent=function(e){return arguments.length?(o=null==e?Hi:e,a):o===Hi?null:o},a.size=function(e){return arguments.length?a.clipExtent(e&&[[0,0],e]):o===Hi?null:o&&o[1]},a}
var Hi=[[-1e6,-1e6],[1e6,1e6]]
function Wi(e){return e.x}function zi(e){return e.y}function qi(t,r){t=e.rgb(t),r=e.rgb(r)
var n=t.r,i=t.g,o=t.b,a=r.r-n,s=r.g-i,u=r.b-o
return function(e){return"#"+ut(Math.round(n+a*e))+ut(Math.round(i+s*e))+ut(Math.round(o+u*e))}}function Ui(e,t){var r,n={},i={}
for(r in e)r in t?n[r]=Qi(e[r],t[r]):i[r]=e[r]
for(r in t)r in e||(i[r]=t[r])
return function(e){for(r in n)i[r]=n[r](e)
return i}}function Gi(e,t){return e=+e,t=+t,function(r){return e*(1-r)+t*r}}function $i(e,t){var r,n,i,o=Ki.lastIndex=Yi.lastIndex=0,a=-1,s=[],u=[]
for(e+="",t+="";(r=Ki.exec(e))&&(n=Yi.exec(t));)(i=n.index)>o&&(i=t.slice(o,i),s[a]?s[a]+=i:s[++a]=i),(r=r[0])===(n=n[0])?s[a]?s[a]+=n:s[++a]=n:(s[++a]=null,u.push({i:a,x:Gi(r,n)})),o=Yi.lastIndex
...
return s.join("")})}e.geom.delaunay=function(t){return e.geom.voronoi().triangles(t)},e.geom.quadtree=function(e,t,r,n,i){var o,a=ri,s=ni
if(o=arguments.length)return a=Wi,s=zi,3===o&&(i=r,n=t,r=t=0),u(e)
function u(e){var u,l,c,f,h,d,p,m,g,b=mt(a),y=mt(s)
...
else for(f=0;f<h;++f){var _=+b(u=e[f],f),w=+y(u,f)
_<d&&(d=_),w<p&&(p=w),_>m&&(m=_),w>g&&(g=w),l.push(_),c.push(w)}var x=m-d,E=g-p
function k(e,t,r,n,i,o,a,s){if(!isNaN(r)&&!isNaN(n))if(e.leaf){var u=e.x,l=e.y
if(null!=u)if(v(u-r)+v(l-n)<.01)S(e,t,r,n,i,o,a,s)
else{var c=e.point
...
e.leaf=!1,c?i=u:a=u,f?o=l:s=l,k(e=e.nodes[h]||(e.nodes[h]={leaf:!0,nodes:[],point:null,x:null,y:null}),t,r,n,i,o,a,s)}x>E?g=p+x:m=d+E
var A={leaf:!0,nodes:[],point:null,x:null,y:null,add:function(e){k(A,e,+b(e,++f),+y(e,f),d,p,m,g)}}
if(A.visit=function(e){(function e(t,r,n,i,o,a){if(!t(r,n,i,o,a)){var s=.5*(n+o),u=.5*(i+a),l=r.nodes
l[0]&&e(t,l[0],n,i,s,u),l[1]&&e(t,l[1],s,i,o,u),l[2]&&e(t,l[2],n,u,s,a),l[3]&&e(t,l[3],s,u,o,a)}})(e,A,d,p,m,g)},A.find=function(e){return function(e,t,r,n,i,o,a){var s,u=1/0
...
case 2:e(l,c,w,_,d)
break
case 3:e(l,_,w,h,d)}}}(e,n,i,o,a),s}(A,e[0],e[1],d,p,m,g)},f=-1,null==t){for(;++f<h;)k(A,e[f],l[f],c[f],d,p,m,g);--f}else e.forEach(A.add)
return l=c=e=u=null,A}return u.x=function(e){return arguments.length?(a=e,u):a},u.y=function(e){return arguments.length?(s=e,u):s},u.extent=function(e){return arguments.length?(null==e?t=r=n=i=null:(t=+e[0][0],r=+e[0][1],n=+e[1][0],i=+e[1][1]),u):null==t?null:[[t,r],[n,i]]},u.size=function(e){return arguments.length?(null==e?t=r=n=i=null:(t=r=0,n=+e[0],i=+e[1]),u):null==t?null:[n-t,i-r]},u},e.interpolateRgb=qi,e.interpolateObject=Ui,e.interpolateNumber=Gi,e.interpolateString=$i
var Ki=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,Yi=new RegExp(Ki.source,"g")
function Qi(t,r){for(var n,i=e.interpolators.length;--i>=0&&!(n=e.interpolators[i](t,r)););return n}function Xi(e,t){var r,n=[],i=[],o=e.length,a=t.length,s=Math.min(e.length,t.length)
for(r=0;r<s;++r)n.push(Qi(e[r],t[r]))
for(;r<o;++r)i[r]=e[r]
for(;r<a;++r)i[r]=t[r]
return function(e){for(r=0;r<s;++r)i[r]=n[r](e)
return i}}e.interpolate=Qi,e.interpolators=[function(e,t){var r=typeof t
return("string"===r?pt.has(t.toLowerCase())||/^(#|rgb\(|hsl\()/i.test(t)?qi:$i:t instanceof Fe?qi:Array.isArray(t)?Xi:"object"===r&&isNaN(t)?Ui:Gi)(e,t)}],e.interpolateArray=Xi
var Zi=function(){return O},Ji=e.map({linear:Zi,poly:function(e){return function(t){return Math.pow(t,e)}},quad:function(){return no},cubic:function(){return io},sin:function(){return ao},exp:function(){return so},circle:function(){return uo},elastic:function(e,t){var r
arguments.length<2&&(t=.45)
arguments.length?r=t/Se*Math.asin(1/e):(e=1,r=t/4)
return function(n){return 1+e*Math.pow(2,-10*n)*Math.sin((n-r)*Se/t)}},back:function(e){e||(e=1.70158)
return function(t){return t*t*((e+1)*t-e)}},bounce:function(){return lo}}),eo=e.map({in:O,out:to,"in-out":ro,"out-in":function(e){return ro(to(e))}})
function to(e){return function(t){return 1-e(1-t)}}function ro(e){return function(t){return.5*(t<.5?e(2*t):2-e(2-2*t))}}function no(e){return e*e}function io(e){return e*e*e}function oo(e){if(e<=0)return 0
if(e>=1)return 1
var t=e*e,r=t*e
return 4*(e<.5?r:3*(e-t)+r-.75)}function ao(e){return 1-Math.cos(e*Ce)}function so(e){return Math.pow(2,10*(e-1))}function uo(e){return 1-Math.sqrt(1-e*e)}function lo(e){return e<1/2.75?7.5625*e*e:e<2/2.75?7.5625*(e-=1.5/2.75)*e+.75:e<2.5/2.75?7.5625*(e-=2.25/2.75)*e+.9375:7.5625*(e-=2.625/2.75)*e+.984375}function co(e,t){return t-=e,function(r){return Math.round(e+t*r)}}function fo(e){var t,r,n,i=[e.a,e.b],o=[e.c,e.d],a=po(i),s=ho(i,o),u=po(((t=o)[0]+=(n=-s)*(r=i)[0],t[1]+=n*r[1],t))||0
i[0]*o[1]<o[0]*i[1]&&(i[0]*=-1,i[1]*=-1,a*=-1,s*=-1),this.rotate=(a?Math.atan2(i[1],i[0]):Math.atan2(-o[0],o[1]))*Te,this.translate=[e.e,e.f],this.scale=[a,u],this.skew=u?Math.atan2(s,u)*Te:0}function ho(e,t){return e[0]*t[0]+e[1]*t[1]}function po(e){var t=Math.sqrt(ho(e,e))
return t&&(e[0]/=t,e[1]/=t),t}e.ease=function(e){var r,n=e.indexOf("-"),i=n>=0?e.slice(0,n):e,o=n>=0?e.slice(n+1):"in"
return i=Ji.get(i)||Zi,o=eo.get(o)||O,r=o(i.apply(null,t.call(arguments,1))),function(e){return e<=0?0:e>=1?1:r(e)}},e.interpolateHcl=function(t,r){t=e.hcl(t),r=e.hcl(r)
var n=t.h,i=t.c,o=t.l,a=r.h-n,s=r.c-i,u=r.l-o
isNaN(s)&&(s=0,i=isNaN(i)?r.c:i)
isNaN(a)?(a=0,n=isNaN(n)?r.h:n):a>180?a-=360:a<-180&&(a+=360)
return function(e){return Ge(n+a*e,i+s*e,o+u*e)+""}},e.interpolateHsl=function(t,r){t=e.hsl(t),r=e.hsl(r)
var n=t.h,i=t.s,o=t.l,a=r.h-n,s=r.s-i,u=r.l-o
isNaN(s)&&(s=0,i=isNaN(i)?r.s:i)
isNaN(a)?(a=0,n=isNaN(n)?r.h:n):a>180?a-=360:a<-180&&(a+=360)
return function(e){return ze(n+a*e,i+s*e,o+u*e)+""}},e.interpolateLab=function(t,r){t=e.lab(t),r=e.lab(r)
var n=t.l,i=t.a,o=t.b,a=r.l-n,s=r.a-i,u=r.b-o
return function(e){return Je(n+a*e,i+s*e,o+u*e)+""}},e.interpolateRound=co,e.transform=function(t){var r=n.createElementNS(e.ns.prefix.svg,"g")
return(e.transform=function(e){if(null!=e){r.setAttribute("transform",e)
var t=r.transform.baseVal.consolidate()}return new fo(t?t.matrix:mo)})(t)},fo.prototype.toString=function(){return"translate("+this.translate+")rotate("+this.rotate+")skewX("+this.skew+")scale("+this.scale+")"}
var mo={a:1,b:0,c:0,d:1,e:0,f:0}
function go(e){return e.length?e.pop()+",":""}function vo(t,r){var n=[],i=[]
return t=e.transform(t),r=e.transform(r),function(e,t,r,n){if(e[0]!==t[0]||e[1]!==t[1]){var i=r.push("translate(",null,",",null,")")
n.push({i:i-4,x:Gi(e[0],t[0])},{i:i-2,x:Gi(e[1],t[1])})}else(t[0]||t[1])&&r.push("translate("+t+")")}(t.translate,r.translate,n,i),function(e,t,r,n){e!==t?(e-t>180?t+=360:t-e>180&&(e+=360),n.push({i:r.push(go(r)+"rotate(",null,")")-2,x:Gi(e,t)})):t&&r.push(go(r)+"rotate("+t+")")}(t.rotate,r.rotate,n,i),function(e,t,r,n){e!==t?n.push({i:r.push(go(r)+"skewX(",null,")")-2,x:Gi(e,t)}):t&&r.push(go(r)+"skewX("+t+")")}(t.skew,r.skew,n,i),function(e,t,r,n){if(e[0]!==t[0]||e[1]!==t[1]){var i=r.push(go(r)+"scale(",null,",",null,")")
n.push({i:i-4,x:Gi(e[0],t[0])},{i:i-2,x:Gi(e[1],t[1])})}else 1===t[0]&&1===t[1]||r.push(go(r)+"scale("+t+")")}(t.scale,r.scale,n,i),t=r=null,function(e){for(var t,r=-1,o=i.length;++r<o;)n[(t=i[r]).i]=t.x(e)
return n.join("")}}function bo(e,t){return t=(t-=e=+e)||1/t,function(r){return(r-e)/t}}function yo(e,t){return t=(t-=e=+e)||1/t,function(r){return Math.max(0,Math.min(1,(r-e)/t))}}function _o(e){for(var t=e.source,r=e.target,n=function(e,t){if(e===t)return e
var r=wo(e),n=wo(t),i=r.pop(),o=n.pop(),a=null
for(;i===o;)a=i,i=r.pop(),o=n.pop()
return a}(t,r),i=[t];t!==n;)t=t.parent,i.push(t)
for(var o=i.length;r!==n;)i.splice(o,0,r),r=r.parent
return i}function wo(e){for(var t=[],r=e.parent;null!=r;)t.push(e),e=r,r=r.parent
return t.push(e),t}function xo(e){e.fixed|=2}function Eo(e){e.fixed&=-7}function ko(e){e.fixed|=4,e.px=e.x,e.py=e.y}function So(e){e.fixed&=-5}e.interpolateTransform=vo,e.layout={},e.layout.bundle=function(){return function(e){for(var t=[],r=-1,n=e.length;++r<n;)t.push(_o(e[r]))
return t}},e.layout.chord=function(){var t,r,n,i,o,a,s,u={},l=0
function c(){var u,c,h,d,p,m={},g=[],v=e.range(i),b=[]
for(t=[],r=[],u=0,d=-1;++d<i;){for(c=0,p=-1;++p<i;)c+=n[d][p]
g.push(c),b.push(e.range(i)),u+=c}for(o&&v.sort(function(e,t){return o(g[e],g[t])}),a&&b.forEach(function(e,t){e.sort(function(e,r){return a(n[t][e],n[t][r])})}),u=(Se-l*i)/u,c=0,d=-1;++d<i;){for(h=c,p=-1;++p<i;){var y=v[d],_=b[y][p],w=n[y][_],x=c,E=c+=w*u
m[y+"-"+_]={index:y,subindex:_,startAngle:x,endAngle:E,value:w}}r[y]={index:y,startAngle:h,endAngle:c,value:g[y]},c+=l}for(d=-1;++d<i;)for(p=d-1;++p<i;){var k=m[d+"-"+p],S=m[p+"-"+d];(k.value||S.value)&&t.push(k.value<S.value?{source:S,target:k}:{source:k,target:S})}s&&f()}function f(){t.sort(function(e,t){return s((e.source.value+e.target.value)/2,(t.source.value+t.target.value)/2)})}return u.matrix=function(e){return arguments.length?(i=(n=e)&&n.length,t=r=null,u):n},u.padding=function(e){return arguments.length?(l=e,t=r=null,u):l},u.sortGroups=function(e){return arguments.length?(o=e,t=r=null,u):o},u.sortSubgroups=function(e){return arguments.length?(a=e,t=null,u):a},u.sortChords=function(e){return arguments.length?(s=e,t&&f(),u):s},u.chords=function(){return t||c(),t},u.groups=function(){return r||c(),r},u},e.layout.force=function(){var t,r,n,i,o,a,s={},u=e.dispatch("start","tick","end"),l=[1,1],c=.9,f=Ao,h=Co,d=-30,p=Mo,m=.1,g=.64,v=[],b=[]
...
e.px-=o*l,e.py-=a*l}return!0}if(t.point&&u&&u<p){l=t.pointCharge/u
e.px-=o*l,e.py-=a*l}}return!t.charge}}function _(t){t.px=e.event.x,t.py=e.event.y,s.resume()}return s.tick=function(){if((n*=.99)<.005)return t=null,u.end({type:"end",alpha:n=0}),!0
var r,s,f,h,p,g,_,w,x,E=v.length,k=b.length
for(s=0;s<k;++s)h=(f=b[s]).source,(g=(w=(p=f.target).x-h.x)*w+(x=p.y-h.y)*x)&&(w*=g=n*o[s]*((g=Math.sqrt(g))-i[s])/g,x*=g,p.x-=w*(_=h.weight+p.weight?h.weight/(h.weight+p.weight):.5),p.y-=x*_,h.x+=w*(_=1-_),h.y+=x*_)
if((_=n*m)&&(w=l[0]/2,x=l[1]/2,s=-1,_))for(;++s<E;)(f=v[s]).x+=(w-f.x)*_,f.y+=(x-f.y)*_
if(d)for(function e(t,r,n){var i=0,o=0
t.charge=0
if(!t.leaf)for(var a,s=t.nodes,u=s.length,l=-1;++l<u;)null!=(a=s[l])&&(e(a,r,n),t.charge+=a.charge,i+=a.charge*a.cx,o+=a.charge*a.cy)
...
t.cy=o/t.charge}(r=e.geom.quadtree(v),n,a),s=-1;++s<E;)(f=v[s]).fixed||r.visit(y(f))
for(s=-1;++s<E;)(f=v[s]).fixed?(f.x=f.px,f.y=f.py):(f.x-=(f.px-(f.px=f.x))*c,f.y-=(f.py-(f.py=f.y))*c)
u.tick({type:"tick",alpha:n})},s.nodes=function(e){return arguments.length?(v=e,s):v},s.links=function(e){return arguments.length?(b=e,s):b},s.size=function(e){return arguments.length?(l=e,s):l},s.linkDistance=function(e){return arguments.length?(f="function"==typeof e?e:+e,s):f},s.distance=s.linkDistance,s.linkStrength=function(e){return arguments.length?(h="function"==typeof e?e:+e,s):h},s.friction=function(e){return arguments.length?(c=+e,s):c},s.charge=function(e){return arguments.length?(d="function"==typeof e?e:+e,s):d},s.chargeDistance=function(e){return arguments.length?(p=e*e,s):Math.sqrt(p)},s.gravity=function(e){return arguments.length?(m=+e,s):m},s.theta=function(e){return arguments.length?(g=e*e,s):Math.sqrt(g)},s.alpha=function(e){return arguments.length?(e=+e,n?e>0?n=e:(t.c=null,t.t=NaN,t=null,u.end({type:"end",alpha:n=0})):e>0&&(u.start({type:"start",alpha:n=e}),t=Et(s.tick)),s):n},s.start=function(){var e,t,r,n=v.length,u=b.length,c=l[0],p=l[1]
for(e=0;e<n;++e)(r=v[e]).index=e,r.weight=0
...
for(e=0;e<n;++e)r=v[e],isNaN(r.x)&&(r.x=m("x",c)),isNaN(r.y)&&(r.y=m("y",p)),isNaN(r.px)&&(r.px=r.x),isNaN(r.py)&&(r.py=r.y)
if(i=[],"function"==typeof f)for(e=0;e<u;++e)i[e]=+f.call(this,b[e],e)
else for(e=0;e<u;++e)i[e]=f
if(o=[],"function"==typeof h)for(e=0;e<u;++e)o[e]=+h.call(this,b[e],e)
else for(e=0;e<u;++e)o[e]=h
if(a=[],"function"==typeof d)for(e=0;e<n;++e)a[e]=+d.call(this,v[e],e)
else for(e=0;e<n;++e)a[e]=d
function m(r,i){if(!t){for(t=new Array(n),l=0;l<n;++l)t[l]=[]
for(l=0;l<u;++l){var o=b[l]
t[o.source.index].push(o.target),t[o.target.index].push(o.source)}}for(var a,s=t[e],l=-1,c=s.length;++l<c;)if(!isNaN(a=s[l][r]))return a
return Math.random()*i}return s.resume()},s.resume=function(){return s.alpha(.1)},s.stop=function(){return s.alpha(0)},s.drag=function(){if(r||(r=e.behavior.drag().origin(O).on("dragstart.force",xo).on("drag.force",_).on("dragend.force",Eo)),!arguments.length)return r
this.on("mouseover.force",ko).on("mouseout.force",So).call(r)},e.rebind(s,u,"on")}
var Ao=20,Co=1,Mo=1/0
function To(t,r){return e.rebind(t,r,"sort","children","value"),t.nodes=t,t.links=Ro,t}function Oo(e,t){for(var r=[e];null!=(e=r.pop());)if(t(e),(i=e.children)&&(n=i.length))for(var n,i;--n>=0;)r.push(i[n])}function No(e,t){for(var r=[e],n=[];null!=(e=r.pop());)if(n.push(e),(o=e.children)&&(i=o.length))for(var i,o,a=-1;++a<i;)r.push(o[a])
for(;null!=(e=n.pop());)t(e)}function Lo(e){return e.children}function Do(e){return e.value}function Po(e,t){return t.value-e.value}function Ro(t){return e.merge(t.map(function(e){return(e.children||[]).map(function(t){return{source:e,target:t}})}))}e.layout.hierarchy=function(){var e=Po,t=Lo,r=Do
...
return No(i,function(t){var n,i
e&&(n=t.children)&&n.sort(e),r&&(i=t.parent)&&(i.value+=t.value)}),s}return n.sort=function(t){return arguments.length?(e=t,n):e},n.children=function(e){return arguments.length?(t=e,n):t},n.value=function(e){return arguments.length?(r=e,n):r},n.revalue=function(e){return r&&(Oo(e,function(e){e.children&&(e.value=0)}),No(e,function(e){var t
e.children||(e.value=+r.call(n,e,e.depth)||0),(t=e.parent)&&(t.value+=e.value)})),e},n},e.layout.partition=function(){var t=e.layout.hierarchy(),r=[1,1]
function n(e,n){var i=t.call(this,e,n)
return function e(t,r,n,i){var o=t.children
if(t.x=r,t.y=t.depth*i,t.dx=n,t.dy=i,o&&(a=o.length)){var a,s,u,l=-1
for(n=t.value?n/t.value:0;++l<a;)e(s=o[l],r,u=s.value*n,i),r+=u}}(i[0],0,r[0],r[1]/function e(t){var r=t.children,n=0
if(r&&(i=r.length))for(var i,o=-1;++o<i;)n=Math.max(n,e(r[o]))
return 1+n}(i[0])),i}return n.size=function(e){return arguments.length?(r=e,n):r},To(n,t)},e.layout.pie=function(){var t=Number,r=jo,n=0,i=Se,o=0
function a(s){var u,l=s.length,c=s.map(function(e,r){return+t.call(a,e,r)}),f=+("function"==typeof n?n.apply(this,arguments):n),h=("function"==typeof i?i.apply(this,arguments):i)-f,d=Math.min(Math.abs(h)/l,+("function"==typeof o?o.apply(this,arguments):o)),p=d*(h<0?-1:1),m=e.sum(c),g=m?(h-l*p)/m:0,v=e.range(l),b=[]
return null!=r&&v.sort(r===jo?function(e,t){return c[t]-c[e]}:function(e,t){return r(s[e],s[t])}),v.forEach(function(e){b[e]={data:s[e],value:u=c[e],startAngle:f,endAngle:f+=u*g+p,padAngle:d}}),b}return a.value=function(e){return arguments.length?(t=e,a):t},a.sort=function(e){return arguments.length?(r=e,a):r},a.startAngle=function(e){return arguments.length?(n=e,a):n},a.endAngle=function(e){return arguments.length?(i=e,a):i},a.padAngle=function(e){return arguments.length?(o=e,a):o},a}
var jo={}
function Io(e){return e.x}function Bo(e){return e.y}function Vo(e,t,r){e.y0=t,e.y=r}e.layout.stack=function(){var t=O,r=Wo,n=zo,i=Vo,o=Io,a=Bo
function s(u,l){if(!(d=u.length))return u
var c=u.map(function(e,r){return t.call(s,e,r)}),f=c.map(function(e){return e.map(function(e,t){return[o.call(s,e,t),a.call(s,e,t)]})}),h=r.call(s,f,l)
c=e.permute(c,h),f=e.permute(f,h)
var d,p,m,g,v=n.call(s,f,l),b=c[0].length
for(m=0;m<b;++m)for(i.call(s,c[0][m],g=v[m],f[0][m][1]),p=1;p<d;++p)i.call(s,c[p][m],g+=f[p-1][m][1],f[p][m][1])
return u}return s.values=function(e){return arguments.length?(t=e,s):t},s.order=function(e){return arguments.length?(r="function"==typeof e?e:Fo.get(e)||Wo,s):r},s.offset=function(e){return arguments.length?(n="function"==typeof e?e:Ho.get(e)||zo,s):n},s.x=function(e){return arguments.length?(o=e,s):o},s.y=function(e){return arguments.length?(a=e,s):a},s.out=function(e){return arguments.length?(i=e,s):i},s}
var Fo=e.map({"inside-out":function(t){var r,n,i=t.length,o=t.map(qo),a=t.map(Uo),s=e.range(i).sort(function(e,t){return o[e]-o[t]}),u=0,l=0,c=[],f=[]
for(r=0;r<i;++r)n=s[r],u<l?(u+=a[n],c.push(n)):(l+=a[n],f.push(n))
return f.reverse().concat(c)},reverse:function(t){return e.range(t.length).reverse()},default:Wo}),Ho=e.map({silhouette:function(e){var t,r,n,i=e.length,o=e[0].length,a=[],s=0,u=[]
...
return s},zero:zo})
function Wo(t){return e.range(t.length)}function zo(e){for(var t=-1,r=e[0].length,n=[];++t<r;)n[t]=0
return n}function qo(e){for(var t,r=1,n=0,i=e[0][1],o=e.length;r<o;++r)(t=e[r][1])>i&&(n=r,i=t)
return n}function Uo(e){return e.reduce(Go,0)}function Go(e,t){return e+t[1]}function $o(e,t){return Ko(e,Math.ceil(Math.log(t.length)/Math.LN2+1))}function Ko(e,t){for(var r=-1,n=+e[0],i=(e[1]-n)/t,o=[];++r<=t;)o[r]=i*r+n
return o}function Yo(t){return[e.min(t),e.max(t)]}function Qo(e,t){return e.value-t.value}function Xo(e,t){var r=e._pack_next
e._pack_next=t,t._pack_prev=e,t._pack_next=r,r._pack_prev=t}function Zo(e,t){e._pack_next=t,t._pack_prev=e}function Jo(e,t){var r=t.x-e.x,n=t.y-e.y,i=e.r+t.r
return.999*i*i>r*r+n*n}function ea(e){if((t=e.children)&&(u=t.length)){var t,r,n,i,o,a,s,u,l=1/0,c=-1/0,f=1/0,h=-1/0
if(t.forEach(ta),(r=t[0]).x=-r.r,r.y=0,y(r),u>1&&((n=t[1]).x=n.r,n.y=0,y(n),u>2))for(na(r,n,i=t[2]),y(i),Xo(r,i),r._pack_prev=i,Xo(i,n),n=r._pack_next,o=3;o<u;o++){na(r,n,i=t[o])
var d=0,p=1,m=1
for(a=n._pack_next;a!==n;a=a._pack_next,p++)if(Jo(a,i)){d=1
break}if(1==d)for(s=r._pack_prev;s!==a._pack_prev&&!Jo(s,i);s=s._pack_prev,m++);d?(p<m||p==m&&n.r<r.r?Zo(r,n=a):Zo(r=s,n),o--):(Xo(r,i),n=i,y(i))}var g=(l+c)/2,v=(f+h)/2,b=0
for(o=0;o<u;o++)(i=t[o]).x-=g,i.y-=v,b=Math.max(b,i.r+Math.sqrt(i.x*i.x+i.y*i.y))
e.r=b,t.forEach(ra)}function y(e){l=Math.min(e.x-e.r,l),c=Math.max(e.x+e.r,c),f=Math.min(e.y-e.r,f),h=Math.max(e.y+e.r,h)}}function ta(e){e._pack_next=e._pack_prev=e}function ra(e){delete e._pack_next,delete e._pack_prev}function na(e,t,r){var n=e.r+r.r,i=t.x-e.x,o=t.y-e.y
if(n&&(i||o)){var a=t.r+r.r,s=i*i+o*o,u=.5+((n*=n)-(a*=a))/(2*s),l=Math.sqrt(Math.max(0,2*a*(n+s)-(n-=s)*n-a*a))/(2*s)
r.x=e.x+u*i+l*o,r.y=e.y+u*o-l*i}else r.x=e.x+n,r.y=e.y}function ia(e,t){return e.parent==t.parent?1:2}function oa(e){var t=e.children
return t.length?t[0]:e.t}function aa(e){var t,r=e.children
return(t=r.length)?r[t-1]:e.t}function sa(e,t,r){var n=r/(t.i-e.i)
t.c-=n,t.s+=r,e.c+=n,t.z+=r,t.m+=r}function ua(e,t,r){return e.a.parent===t.parent?e.a:r}function la(e){return{x:e.x,y:e.y,dx:e.dx,dy:e.dy}}function ca(e,t){var r=e.x+t[3],n=e.y+t[0],i=e.dx-t[1]-t[3],o=e.dy-t[0]-t[2]
return i<0&&(r+=i/2,i=0),o<0&&(n+=o/2,o=0),{x:r,y:n,dx:i,dy:o}}function fa(e){var t=e[0],r=e[e.length-1]
return t<r?[t,r]:[r,t]}function ha(e){return e.rangeExtent?e.rangeExtent():fa(e.range())}function da(e,t,r,n){var i=r(e[0],e[1]),o=n(t[0],t[1])
return function(e){return o(i(e))}}function pa(e,t){var r,n=0,i=e.length-1,o=e[n],a=e[i]
return a<o&&(r=n,n=i,i=r,r=o,o=a,a=r),e[n]=t.floor(o),e[i]=t.ceil(a),e}function ma(e){return e?{floor:function(t){return Math.floor(t/e)*e},ceil:function(t){return Math.ceil(t/e)*e}}:ga}e.layout.histogram=function(){var t=!0,r=Number,n=Yo,i=$o
function o(o,a){for(var s,u,l=[],c=o.map(r,this),f=n.call(this,c,a),h=i.call(this,f,c,a),d=(a=-1,c.length),p=h.length-1,m=t?1:1/d;++a<p;)(s=l[a]=[]).dx=h[a+1]-(s.x=h[a]),s.y=0
if(p>0)for(a=-1;++a<d;)(u=c[a])>=f[0]&&u<=f[1]&&((s=l[e.bisect(h,u,1,p)-1]).y+=m,s.push(o[a]))
return l}return o.value=function(e){return arguments.length?(r=e,o):r},o.range=function(e){return arguments.length?(n=mt(e),o):n},o.bins=function(e){return arguments.length?(i="number"==typeof e?function(t){return Ko(t,e)}:mt(e),o):i},o.frequency=function(e){return arguments.length?(t=!!e,o):t},o},e.layout.pack=function(){var t,r=e.layout.hierarchy().sort(Qo),n=0,i=[1,1]
function o(e,o){var a=r.call(this,e,o),s=a[0],u=i[0],l=i[1],c=null==t?Math.sqrt:"function"==typeof t?t:function(){return t}
if(s.x=s.y=0,No(s,function(e){e.r=+c(e.value)}),No(s,ea),n){var f=n*(t?1:Math.max(2*s.r/u,2*s.r/l))/2
No(s,function(e){e.r+=f}),No(s,ea),No(s,function(e){e.r-=f})}return function e(t,r,n,i){var o=t.children
t.x=r+=i*t.x
t.y=n+=i*t.y
t.r*=i
if(o)for(var a=-1,s=o.length;++a<s;)e(o[a],r,n,i)}(s,u/2,l/2,t?1:1/Math.max(2*s.r/u,2*s.r/l)),a}return o.size=function(e){return arguments.length?(i=e,o):i},o.radius=function(e){return arguments.length?(t=null==e||"function"==typeof e?e:+e,o):t},o.padding=function(e){return arguments.length?(n=+e,o):n},To(o,r)},e.layout.tree=function(){var t=e.layout.hierarchy().sort(null).value(null),r=ia,n=[1,1],i=null
function o(e,o){var l=t.call(this,e,o),c=l[0],f=function(e){var t,r={A:null,children:[e]},n=[r]
for(;null!=(t=n.pop());)for(var i,o=t.children,a=0,s=o.length;a<s;++a)n.push((o[a]=i={_:o[a],parent:t,children:(i=o[a].children)&&i.slice()||[],A:null,a:null,z:0,m:0,c:0,s:0,t:null,i:a}).a=i)
return r.children[0]}(c)
if(No(f,a),f.parent.m=-f.z,Oo(f,s),i)Oo(c,u)
else{var h=c,d=c,p=c
Oo(c,function(e){e.x<h.x&&(h=e),e.x>d.x&&(d=e),e.depth>p.depth&&(p=e)})
var m=r(h,d)/2-h.x,g=n[0]/(d.x+r(d,h)/2+m),v=n[1]/(p.depth||1)
Oo(c,function(e){e.x=(e.x+m)*g,e.y=e.depth*v})}return l}function a(e){var t=e.children,n=e.parent.children,i=e.i?n[e.i-1]:null
if(t.length){(function(e){var t,r=0,n=0,i=e.children,o=i.length
for(;--o>=0;)(t=i[o]).z+=r,t.m+=r,r+=t.s+(n+=t.c)})(e)
var o=(t[0].z+t[t.length-1].z)/2
i?(e.z=i.z+r(e._,i._),e.m=e.z-o):e.z=o}else i&&(e.z=i.z+r(e._,i._))
e.parent.A=function(e,t,n){if(t){for(var i,o=e,a=e,s=t,u=o.parent.children[0],l=o.m,c=a.m,f=s.m,h=u.m;s=aa(s),o=oa(o),s&&o;)u=oa(u),(a=aa(a)).a=e,(i=s.z+f-o.z-l+r(s._,o._))>0&&(sa(ua(s,e,n),e,i),l+=i,c+=i),f+=s.m,l+=o.m,h+=u.m,c+=a.m
s&&!aa(a)&&(a.t=s,a.m+=f-c),o&&!oa(u)&&(u.t=o,u.m+=l-h,n=e)}return n}(e,i,e.parent.A||n[0])}function s(e){e._.x=e.z+e.parent.m,e.m+=e.parent.m}function u(e){e.x*=n[0],e.y=e.depth*n[1]}return o.separation=function(e){return arguments.length?(r=e,o):r},o.size=function(e){return arguments.length?(i=null==(n=e)?u:null,o):i?null:n},o.nodeSize=function(e){return arguments.length?(i=null==(n=e)?null:u,o):i?n:null},To(o,t)},e.layout.cluster=function(){var t=e.layout.hierarchy().sort(null).value(null),r=ia,n=[1,1],i=!1
function o(o,a){var s,u=t.call(this,o,a),l=u[0],c=0
No(l,function(t){var n=t.children
n&&n.length?(t.x=function(e){return e.reduce(function(e,t){return e+t.x},0)/e.length}(n),t.y=function(t){return 1+e.max(t,function(e){return e.y})}(n)):(t.x=s?c+=r(t,s):0,t.y=0,s=t)})
var f=function e(t){var r=t.children
return r&&r.length?e(r[0]):t}(l),h=function e(t){var r,n=t.children
return n&&(r=n.length)?e(n[r-1]):t}(l),d=f.x-r(f,h)/2,p=h.x+r(h,f)/2
return No(l,i?function(e){e.x=(e.x-l.x)*n[0],e.y=(l.y-e.y)*n[1]}:function(e){e.x=(e.x-d)/(p-d)*n[0],e.y=(1-(l.y?e.y/l.y:1))*n[1]}),u}return o.separation=function(e){return arguments.length?(r=e,o):r},o.size=function(e){return arguments.length?(i=null==(n=e),o):i?null:n},o.nodeSize=function(e){return arguments.length?(i=null!=(n=e),o):i?n:null},To(o,t)},e.layout.treemap=function(){var t,r=e.layout.hierarchy(),n=Math.round,i=[1,1],o=null,a=la,s=!1,u="squarify",l=.5*(1+Math.sqrt(5))
function c(e,t){for(var r,n,i=-1,o=e.length;++i<o;)n=(r=e[i]).value*(t<0?0:t),r.area=isNaN(n)||n<=0?0:n}function f(e){var t=e.children
if(t&&t.length){var r,n,i,o=a(e),s=[],l=t.slice(),h=1/0,m="slice"===u?o.dx:"dice"===u?o.dy:"slice-dice"===u?1&e.depth?o.dy:o.dx:Math.min(o.dx,o.dy)
for(c(l,o.dx*o.dy/e.value),s.area=0;(i=l.length)>0;)s.push(r=l[i-1]),s.area+=r.area,"squarify"!==u||(n=d(s,m))<=h?(l.pop(),h=n):(s.area-=s.pop().area,p(s,m,o,!1),m=Math.min(o.dx,o.dy),s.length=s.area=0,h=1/0)
s.length&&(p(s,m,o,!0),s.length=s.area=0),t.forEach(f)}}function h(e){var t=e.children
if(t&&t.length){var r,n=a(e),i=t.slice(),o=[]
for(c(i,n.dx*n.dy/e.value),o.area=0;r=i.pop();)o.push(r),o.area+=r.area,null!=r.z&&(p(o,r.z?n.dx:n.dy,n,!i.length),o.length=o.area=0)
t.forEach(h)}}function d(e,t){for(var r,n=e.area,i=0,o=1/0,a=-1,s=e.length;++a<s;)(r=e[a].area)&&(r<o&&(o=r),r>i&&(i=r))
return t*=t,(n*=n)?Math.max(t*i*l/n,n/(t*o*l)):1/0}function p(e,t,r,i){var o,a=-1,s=e.length,u=r.x,l=r.y,c=t?n(e.area/t):0
if(t==r.dx){for((i||c>r.dy)&&(c=r.dy);++a<s;)(o=e[a]).x=u,o.y=l,o.dy=c,u+=o.dx=Math.min(r.x+r.dx-u,c?n(o.area/c):0)
o.z=!0,o.dx+=r.x+r.dx-u,r.y+=c,r.dy-=c}else{for((i||c>r.dx)&&(c=r.dx);++a<s;)(o=e[a]).x=u,o.y=l,o.dx=c,l+=o.dy=Math.min(r.y+r.dy-l,c?n(o.area/c):0)
o.z=!1,o.dy+=r.y+r.dy-l,r.x+=c,r.dx-=c}}function m(e){var n=t||r(e),o=n[0]
return o.x=o.y=0,o.value?(o.dx=i[0],o.dy=i[1]):o.dx=o.dy=0,t&&r.revalue(o),c([o],o.dx*o.dy/o.value),(t?h:f)(o),s&&(t=n),n}return m.size=function(e){return arguments.length?(i=e,m):i},m.padding=function(e){if(!arguments.length)return o
function t(t){return ca(t,e)}var r
return a=null==(o=e)?la:"function"==(r=typeof e)?function(t){var r=e.call(m,t,t.depth)
return null==r?la(t):ca(t,"number"==typeof r?[r,r,r,r]:r)}:"number"===r?(e=[e,e,e,e],t):t,m},m.round=function(e){return arguments.length?(n=e?Math.round:Number,m):n!=Number},m.sticky=function(e){return arguments.length?(s=e,t=null,m):s},m.ratio=function(e){return arguments.length?(l=e,m):l},m.mode=function(e){return arguments.length?(u=e+"",m):u},To(m,r)},e.random={normal:function(e,t){var r=arguments.length
return r<2&&(t=1),r<1&&(e=0),function(){var r,n,i
do{i=(r=2*Math.random()-1)*r+(n=2*Math.random()-1)*n}while(!i||i>1)
return e+t*r*Math.sqrt(-2*Math.log(i)/i)}},logNormal:function(){var t=e.random.normal.apply(e,arguments)
return function(){return Math.exp(t())}},bates:function(t){var r=e.random.irwinHall(t)
return function(){return r()/t}},irwinHall:function(e){return function(){for(var t=0,r=0;r<e;r++)t+=Math.random()
return t}}},e.scale={}
var ga={floor:O,ceil:O}
function va(t,r,n,i){var o=[],a=[],s=0,u=Math.min(t.length,r.length)-1
for(t[u]<t[0]&&(t=t.slice().reverse(),r=r.slice().reverse());++s<=u;)o.push(n(t[s-1],t[s])),a.push(i(r[s-1],r[s]))
return function(r){var n=e.bisect(t,r,1,u)-1
return a[n](o[n](r))}}function ba(t,r){return e.rebind(t,r,"range","rangeRound","interpolate","clamp")}function ya(e,t){return pa(e,ma(_a(e,t)[2])),pa(e,ma(_a(e,t)[2])),e}function _a(e,t){null==t&&(t=10)
var r=fa(e),n=r[1]-r[0],i=Math.pow(10,Math.floor(Math.log(n/t)/Math.LN10)),o=t/n*i
return o<=.15?i*=10:o<=.35?i*=5:o<=.75&&(i*=2),r[0]=Math.ceil(r[0]/i)*i,r[1]=Math.floor(r[1]/i)*i+.5*i,r[2]=i,r}function wa(t,r){return e.range.apply(e,_a(t,r))}function xa(t,r,n){var i=_a(t,r)
if(n){var o=Ot.exec(n)
if(o.shift(),"s"===o[8]){var a=e.formatPrefix(Math.max(v(i[0]),v(i[1])))
return o[7]||(o[7]="."+ka(a.scale(i[2]))),o[8]="f",n=e.format(o.join("")),function(e){return n(a.scale(e))+a.symbol}}o[7]||(o[7]="."+function(e,t){var r=ka(t[2])
return e in Ea?Math.abs(r-ka(Math.max(v(t[0]),v(t[1]))))+ +("e"!==e):r-2*("%"===e)}(o[8],i)),n=o.join("")}else n=",."+ka(i[2])+"f"
return e.format(n)}e.scale.linear=function(){return function e(t,r,n,i){var o,a
function s(){var e=Math.min(t.length,r.length)>2?va:da,s=i?yo:bo
return o=e(t,r,s,n),a=e(r,t,s,Qi),u}function u(e){return o(e)}u.invert=function(e){return a(e)}
u.domain=function(e){return arguments.length?(t=e.map(Number),s()):t}
u.range=function(e){return arguments.length?(r=e,s()):r}
u.rangeRound=function(e){return u.range(e).interpolate(co)}
u.clamp=function(e){return arguments.length?(i=e,s()):i}
u.interpolate=function(e){return arguments.length?(n=e,s()):n}
u.ticks=function(e){return wa(t,e)}
u.tickFormat=function(e,r){return xa(t,e,r)}
u.nice=function(e){return ya(t,e),s()}
u.copy=function(){return e(t,r,n,i)}
return s()}([0,1],[0,1],Qi,!1)}
var Ea={s:1,g:1,p:1,r:1,e:1}
function ka(e){return-Math.floor(Math.log(e)/Math.LN10+.01)}e.scale.log=function(){return function t(r,n,i,o){function a(e){return(i?Math.log(e<0?0:e):-Math.log(e>0?0:-e))/Math.log(n)}function s(e){return i?Math.pow(n,e):-Math.pow(n,-e)}function u(e){return r(a(e))}u.invert=function(e){return s(r.invert(e))}
u.domain=function(e){return arguments.length?(i=e[0]>=0,r.domain((o=e.map(Number)).map(a)),u):o}
u.base=function(e){return arguments.length?(n=+e,r.domain(o.map(a)),u):n}
u.nice=function(){var e=pa(o.map(a),i?Math:Aa)
return r.domain(e),o=e.map(s),u}
u.ticks=function(){var e=fa(o),t=[],r=e[0],u=e[1],l=Math.floor(a(r)),c=Math.ceil(a(u)),f=n%1?2:n
if(isFinite(c-l)){if(i){for(;l<c;l++)for(var h=1;h<f;h++)t.push(s(l)*h)
t.push(s(l))}else for(t.push(s(l));l++<c;)for(var h=f-1;h>0;h--)t.push(s(l)*h)
for(l=0;t[l]<r;l++);for(c=t.length;t[c-1]>u;c--);t=t.slice(l,c)}return t}
u.tickFormat=function(t,r){if(!arguments.length)return Sa
arguments.length<2?r=Sa:"function"!=typeof r&&(r=e.format(r))
var i=Math.max(1,n*t/u.ticks().length)
return function(e){var t=e/s(Math.round(a(e)))
return t*n<n-.5&&(t*=n),t<=i?r(e):""}}
u.copy=function(){return t(r.copy(),n,i,o)}
return ba(u,r)}(e.scale.linear().domain([0,1]),10,!0,[1,10])}
var Sa=e.format(".0e"),Aa={floor:function(e){return-Math.ceil(-e)},ceil:function(e){return-Math.floor(-e)}}
function Ca(e){return function(t){return t<0?-Math.pow(-t,e):Math.pow(t,e)}}e.scale.pow=function(){return function e(t,r,n){var i=Ca(r),o=Ca(1/r)
function a(e){return t(i(e))}a.invert=function(e){return o(t.invert(e))}
a.domain=function(e){return arguments.length?(t.domain((n=e.map(Number)).map(i)),a):n}
a.ticks=function(e){return wa(n,e)}
a.tickFormat=function(e,t){return xa(n,e,t)}
a.nice=function(e){return a.domain(ya(n,e))}
a.exponent=function(e){return arguments.length?(i=Ca(r=e),o=Ca(1/r),t.domain(n.map(i)),a):r}
a.copy=function(){return e(t.copy(),r,n)}
return ba(a,t)}(e.scale.linear(),1,[0,1])},e.scale.sqrt=function(){return e.scale.pow().exponent(.5)},e.scale.ordinal=function(){return function t(r,n){var i,o,a
function s(e){return o[((i.get(e)||("range"===n.t?i.set(e,r.push(e)):NaN))-1)%o.length]}function u(t,n){return e.range(r.length).map(function(e){return t+n*e})}s.domain=function(e){if(!arguments.length)return r
r=[],i=new y
for(var t,o=-1,a=e.length;++o<a;)i.has(t=e[o])||i.set(t,r.push(t))
return s[n.t].apply(s,n.a)}
s.range=function(e){return arguments.length?(o=e,a=0,n={t:"range",a:arguments},s):o}
s.rangePoints=function(e,t){arguments.length<2&&(t=0)
var i=e[0],l=e[1],c=r.length<2?(i=(i+l)/2,0):(l-i)/(r.length-1+t)
return o=u(i+c*t/2,c),a=0,n={t:"rangePoints",a:arguments},s}
s.rangeRoundPoints=function(e,t){arguments.length<2&&(t=0)
var i=e[0],l=e[1],c=r.length<2?(i=l=Math.round((i+l)/2),0):(l-i)/(r.length-1+t)|0
return o=u(i+Math.round(c*t/2+(l-i-(r.length-1+t)*c)/2),c),a=0,n={t:"rangeRoundPoints",a:arguments},s}
s.rangeBands=function(e,t,i){arguments.length<2&&(t=0),arguments.length<3&&(i=t)
var l=e[1]<e[0],c=e[l-0],f=e[1-l],h=(f-c)/(r.length-t+2*i)
return o=u(c+h*i,h),l&&o.reverse(),a=h*(1-t),n={t:"rangeBands",a:arguments},s}
s.rangeRoundBands=function(e,t,i){arguments.length<2&&(t=0),arguments.length<3&&(i=t)
var l=e[1]<e[0],c=e[l-0],f=e[1-l],h=Math.floor((f-c)/(r.length-t+2*i))
return o=u(c+Math.round((f-c-(r.length-t)*h)/2),h),l&&o.reverse(),a=Math.round(h*(1-t)),n={t:"rangeRoundBands",a:arguments},s}
s.rangeBand=function(){return a}
s.rangeExtent=function(){return fa(n.a[0])}
s.copy=function(){return t(r,n)}
return s.domain(r)}([],{t:"range",a:[[]]})},e.scale.category10=function(){return e.scale.ordinal().range(Ma)},e.scale.category20=function(){return e.scale.ordinal().range(Ta)},e.scale.category20b=function(){return e.scale.ordinal().range(Oa)},e.scale.category20c=function(){return e.scale.ordinal().range(Na)}
var Ma=[2062260,16744206,2924588,14034728,9725885,9197131,14907330,8355711,12369186,1556175].map(at),Ta=[2062260,11454440,16744206,16759672,2924588,10018698,14034728,16750742,9725885,12955861,9197131,12885140,14907330,16234194,8355711,13092807,12369186,14408589,1556175,10410725].map(at),Oa=[3750777,5395619,7040719,10264286,6519097,9216594,11915115,13556636,9202993,12426809,15186514,15190932,8666169,11356490,14049643,15177372,8077683,10834324,13528509,14589654].map(at),Na=[3244733,7057110,10406625,13032431,15095053,16616764,16625259,16634018,3253076,7652470,10607003,13101504,7695281,10394312,12369372,14342891,6513507,9868950,12434877,14277081].map(at)
function La(){return 0}e.scale.quantile=function(){return function t(r,n){var i
function o(){var t=0,o=n.length
for(i=[];++t<o;)i[t-1]=e.quantile(r,t/o)
return a}function a(t){if(!isNaN(t=+t))return n[e.bisect(i,t)]}a.domain=function(e){return arguments.length?(r=e.map(h).filter(d).sort(f),o()):r}
a.range=function(e){return arguments.length?(n=e,o()):n}
a.quantiles=function(){return i}
a.invertExtent=function(e){return(e=n.indexOf(e))<0?[NaN,NaN]:[e>0?i[e-1]:r[0],e<i.length?i[e]:r[r.length-1]]}
a.copy=function(){return t(r,n)}
return o()}([],[])},e.scale.quantize=function(){return function e(t,r,n){var i,o
function a(e){return n[Math.max(0,Math.min(o,Math.floor(i*(e-t))))]}function s(){return i=n.length/(r-t),o=n.length-1,a}a.domain=function(e){return arguments.length?(t=+e[0],r=+e[e.length-1],s()):[t,r]}
a.range=function(e){return arguments.length?(n=e,s()):n}
a.invertExtent=function(e){return[e=(e=n.indexOf(e))<0?NaN:e/i+t,e+1/i]}
a.copy=function(){return e(t,r,n)}
return s()}(0,1,[0,1])},e.scale.threshold=function(){return function t(r,n){function i(t){if(t<=t)return n[e.bisect(r,t)]}i.domain=function(e){return arguments.length?(r=e,i):r}
i.range=function(e){return arguments.length?(n=e,i):n}
i.invertExtent=function(e){return e=n.indexOf(e),[r[e-1],r[e]]}
i.copy=function(){return t(r,n)}
return i}([.5],[0,1])},e.scale.identity=function(){return function e(t){function r(e){return+e}r.invert=r
r.domain=r.range=function(e){return arguments.length?(t=e.map(r),r):t}
r.ticks=function(e){return wa(t,e)}
r.tickFormat=function(e,r){return xa(t,e,r)}
r.copy=function(){return e(t)}
return r}([0,1])},e.svg={},e.svg.arc=function(){var e=Pa,t=Ra,r=La,n=Da,i=ja,o=Ia,a=Ba
function s(){var s=Math.max(0,+e.apply(this,arguments)),l=Math.max(0,+t.apply(this,arguments)),c=i.apply(this,arguments)-Ce,f=o.apply(this,arguments)-Ce,h=Math.abs(f-c),d=c>f?0:1
if(l<s&&(p=l,l=s,s=p),h>=Ae)return u(l,d)+(s?u(s,1-d):"")+"Z"
var p,m,g,v,b,y,_,w,x,E,k,S,A=0,C=0,M=[]
if((v=(+a.apply(this,arguments)||0)/2)&&(g=n===Da?Math.sqrt(s*s+l*l):+n.apply(this,arguments),d||(C*=-1),l&&(C=De(g/l*Math.sin(v))),s&&(A=De(g/s*Math.sin(v)))),l){b=l*Math.cos(c+C),y=l*Math.sin(c+C),_=l*Math.cos(f-C),w=l*Math.sin(f-C)
var T=Math.abs(f-c-2*C)<=ke?0:1
if(C&&Va(b,y,_,w)===d^T){var O=(c+f)/2
...
var N=Math.abs(c-f+2*A)<=ke?0:1
if(A&&Va(x,E,k,S)===1-d^N){var L=(c+f)/2
x=s*Math.cos(L),E=s*Math.sin(L),k=S=null}}else x=E=0
if(h>xe&&(p=Math.min(Math.abs(l-s)/2,+r.apply(this,arguments)))>.001){m=s<l^d?0:1
var D=p,P=p
if(h<ke){var R=null==k?[x,E]:null==_?[b,y]:ui([b,y],[k,S],[_,w],[x,E]),j=b-R[0],I=y-R[1],B=_-R[0],V=w-R[1],F=1/Math.sin(Math.acos((j*B+I*V)/(Math.sqrt(j*j+I*I)*Math.sqrt(B*B+V*V)))/2),H=Math.sqrt(R[0]*R[0]+R[1]*R[1])
P=Math.min(p,(s-H)/(F-1)),D=Math.min(p,(l-H)/(F+1))}if(null!=_){var W=Fa(null==k?[x,E]:[k,S],[b,y],l,D,d),z=Fa([_,w],[x,E],l,D,d)
p===D?M.push("M",W[0],"A",D,",",D," 0 0,",m," ",W[1],"A",l,",",l," 0 ",1-d^Va(W[1][0],W[1][1],z[1][0],z[1][1]),",",d," ",z[1],"A",D,",",D," 0 0,",m," ",z[0]):M.push("M",W[0],"A",D,",",D," 0 1,",m," ",z[0])}else M.push("M",b,",",y)
if(null!=k){var q=Fa([b,y],[k,S],s,-P,d),U=Fa([x,E],null==_?[b,y]:[_,w],s,-P,d)
p===P?M.push("L",U[0],"A",P,",",P," 0 0,",m," ",U[1],"A",s,",",s," 0 ",d^Va(U[1][0],U[1][1],q[1][0],q[1][1]),",",1-d," ",q[1],"A",P,",",P," 0 0,",m," ",q[0]):M.push("L",U[0],"A",P,",",P," 0 0,",m," ",q[0])}else M.push("L",x,",",E)}else M.push("M",b,",",y),null!=_&&M.push("A",l,",",l," 0 ",T,",",d," ",_,",",w),M.push("L",x,",",E),null!=k&&M.push("A",s,",",s," 0 ",N,",",1-d," ",k,",",S)
return M.push("Z"),M.join("")}function u(e,t){return"M0,"+e+"A"+e+","+e+" 0 1,"+t+" 0,"+-e+"A"+e+","+e+" 0 1,"+t+" 0,"+e}return s.innerRadius=function(t){return arguments.length?(e=mt(t),s):e},s.outerRadius=function(e){return arguments.length?(t=mt(e),s):t},s.cornerRadius=function(e){return arguments.length?(r=mt(e),s):r},s.padRadius=function(e){return arguments.length?(n=e==Da?Da:mt(e),s):n},s.startAngle=function(e){return arguments.length?(i=mt(e),s):i},s.endAngle=function(e){return arguments.length?(o=mt(e),s):o},s.padAngle=function(e){return arguments.length?(a=mt(e),s):a},s.centroid=function(){var r=(+e.apply(this,arguments)+ +t.apply(this,arguments))/2,n=(+i.apply(this,arguments)+ +o.apply(this,arguments))/2-Ce
return[Math.cos(n)*r,Math.sin(n)*r]},s}
var Da="auto"
function Pa(e){return e.innerRadius}function Ra(e){return e.outerRadius}function ja(e){return e.startAngle}function Ia(e){return e.endAngle}function Ba(e){return e&&e.padAngle}function Va(e,t,r,n){return(e-r)*t-(t-n)*e>0?0:1}function Fa(e,t,r,n,i){var o=e[0]-t[0],a=e[1]-t[1],s=(i?n:-n)/Math.sqrt(o*o+a*a),u=s*a,l=-s*o,c=e[0]+u,f=e[1]+l,h=t[0]+u,d=t[1]+l,p=(c+h)/2,m=(f+d)/2,g=h-c,v=d-f,b=g*g+v*v,y=r-n,_=c*d-h*f,w=(v<0?-1:1)*Math.sqrt(Math.max(0,y*y*b-_*_)),x=(_*v-g*w)/b,E=(-_*g-v*w)/b,k=(_*v+g*w)/b,S=(-_*g+v*w)/b,A=x-p,C=E-m,M=k-p,T=S-m
return A*A+C*C>M*M+T*T&&(x=k,E=S),[[x-u,E-l],[x*r/y,E*r/y]]}function Ha(e){var t=ri,r=ni,n=$r,i=za,o=i.key,a=.7
function s(o){var s,u=[],l=[],c=-1,f=o.length,h=mt(t),d=mt(r)
function p(){u.push("M",i(e(l),a))}for(;++c<f;)n.call(this,s=o[c],c)?l.push([+h.call(this,s,c),+d.call(this,s,c)]):l.length&&(p(),l=[])
return l.length&&p(),u.length?u.join(""):null}return s.x=function(e){return arguments.length?(t=e,s):t},s.y=function(e){return arguments.length?(r=e,s):r},s.defined=function(e){return arguments.length?(n=e,s):n},s.interpolate=function(e){return arguments.length?(o="function"==typeof e?i=e:(i=Wa.get(e)||za).key,s):o},s.tension=function(e){return arguments.length?(a=e,s):a},s}e.svg.line=function(){return Ha(O)}
var Wa=e.map({linear:za,"linear-closed":qa,step:function(e){var t=0,r=e.length,n=e[0],i=[n[0],",",n[1]]
for(;++t<r;)i.push("H",(n[0]+(n=e[t])[0])/2,"V",n[1])
r>1&&i.push("H",n[0])
return i.join("")},"step-before":Ua,"step-after":Ga,basis:Ya,"basis-open":function(e){if(e.length<4)return za(e)
var t,r=[],n=-1,i=e.length,o=[0],a=[0]
for(;++n<3;)t=e[n],o.push(t[0]),a.push(t[1])
r.push(Qa(Ja,o)+","+Qa(Ja,a)),--n
for(;++n<i;)t=e[n],o.shift(),o.push(t[0]),a.shift(),a.push(t[1]),es(r,o,a)
return r.join("")},"basis-closed":function(e){var t,r,n=-1,i=e.length,o=i+4,a=[],s=[]
for(;++n<4;)r=e[n%i],a.push(r[0]),s.push(r[1])
t=[Qa(Ja,a),",",Qa(Ja,s)],--n
for(;++n<o;)r=e[n%i],a.shift(),a.push(r[0]),s.shift(),s.push(r[1]),es(t,a,s)
return t.join("")},bundle:function(e,t){var r=e.length-1
if(r)for(var n,i,o=e[0][0],a=e[0][1],s=e[r][0]-o,u=e[r][1]-a,l=-1;++l<=r;)n=e[l],i=l/r,n[0]=t*n[0]+(1-t)*(o+i*s),n[1]=t*n[1]+(1-t)*(a+i*u)
return Ya(e)},cardinal:function(e,t){return e.length<3?za(e):e[0]+$a(e,Ka(e,t))},"cardinal-open":function(e,t){return e.length<4?za(e):e[1]+$a(e.slice(1,-1),Ka(e,t))},"cardinal-closed":function(e,t){return e.length<3?qa(e):e[0]+$a((e.push(e[0]),e),Ka([e[e.length-2]].concat(e,[e[1]]),t))},monotone:function(e){return e.length<3?za(e):e[0]+$a(e,function(e){var t,r,n,i,o=[],a=function(e){var t=0,r=e.length-1,n=[],i=e[0],o=e[1],a=n[0]=ts(i,o)
for(;++t<r;)n[t]=(a+(a=ts(i=o,o=e[t+1])))/2
return n[t]=a,n}(e),s=-1,u=e.length-1
for(;++s<u;)t=ts(e[s],e[s+1]),v(t)<xe?a[s]=a[s+1]=0:(r=a[s]/t,n=a[s+1]/t,(i=r*r+n*n)>9&&(i=3*t/Math.sqrt(i),a[s]=i*r,a[s+1]=i*n))
s=-1
for(;++s<=u;)i=(e[Math.min(u,s+1)][0]-e[Math.max(0,s-1)][0])/(6*(1+a[s]*a[s])),o.push([i||0,a[s]*i||0])
return o}(e))}})
function za(e){return e.length>1?e.join("L"):e+"Z"}function qa(e){return e.join("L")+"Z"}function Ua(e){for(var t=0,r=e.length,n=e[0],i=[n[0],",",n[1]];++t<r;)i.push("V",(n=e[t])[1],"H",n[0])
return i.join("")}function Ga(e){for(var t=0,r=e.length,n=e[0],i=[n[0],",",n[1]];++t<r;)i.push("H",(n=e[t])[0],"V",n[1])
return i.join("")}function $a(e,t){if(t.length<1||e.length!=t.length&&e.length!=t.length+2)return za(e)
...
n+="Q"+(o[0]+2*s[0]/3)+","+(o[1]+2*s[1]/3)+","+c[0]+","+c[1]}return n}function Ka(e,t){for(var r,n=[],i=(1-t)/2,o=e[0],a=e[1],s=1,u=e.length;++s<u;)r=o,o=a,a=e[s],n.push([i*(a[0]-r[0]),i*(a[1]-r[1])])
return n}function Ya(e){if(e.length<3)return za(e)
var t=1,r=e.length,n=e[0],i=n[0],o=n[1],a=[i,i,i,(n=e[1])[0]],s=[o,o,o,n[1]],u=[i,",",o,"L",Qa(Ja,a),",",Qa(Ja,s)]
for(e.push(e[r-1]);++t<=r;)n=e[t],a.shift(),a.push(n[0]),s.shift(),s.push(n[1]),es(u,a,s)
return e.pop(),u.push("L",n),u.join("")}function Qa(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]+e[3]*t[3]}Wa.forEach(function(e,t){t.key=e,t.closed=/-closed$/.test(e)})
var Xa=[0,2/3,1/3,0],Za=[0,1/3,2/3,0],Ja=[0,1/6,2/3,1/6]
function es(e,t,r){e.push("C",Qa(Xa,t),",",Qa(Xa,r),",",Qa(Za,t),",",Qa(Za,r),",",Qa(Ja,t),",",Qa(Ja,r))}function ts(e,t){return(t[1]-e[1])/(t[0]-e[0])}function rs(e){for(var t,r,n,i=-1,o=e.length;++i<o;)r=(t=e[i])[0],n=t[1]-Ce,t[0]=r*Math.cos(n),t[1]=r*Math.sin(n)
return e}function ns(e){var t=ri,r=ri,n=0,i=ni,o=$r,a=za,s=a.key,u=a,l="L",c=.7
function f(s){var f,h,d,p=[],m=[],g=[],v=-1,b=s.length,y=mt(t),_=mt(n),w=t===r?function(){return h}:mt(r),x=n===i?function(){return d}:mt(i)
...
return m.length&&E(),p.length?p.join(""):null}return f.x=function(e){return arguments.length?(t=r=e,f):r},f.x0=function(e){return arguments.length?(t=e,f):t},f.x1=function(e){return arguments.length?(r=e,f):r},f.y=function(e){return arguments.length?(n=i=e,f):i},f.y0=function(e){return arguments.length?(n=e,f):n},f.y1=function(e){return arguments.length?(i=e,f):i},f.defined=function(e){return arguments.length?(o=e,f):o},f.interpolate=function(e){return arguments.length?(s="function"==typeof e?a=e:(a=Wa.get(e)||za).key,u=a.reverse||a,l=a.closed?"M":"L",f):s},f.tension=function(e){return arguments.length?(c=e,f):c},f}function is(e){return e.radius}function os(e){return[e.x,e.y]}function as(){return 64}function ss(){return"circle"}function us(e){var t=Math.sqrt(e/ke)
return"M0,"+t+"A"+t+","+t+" 0 1,1 0,"+-t+"A"+t+","+t+" 0 1,1 0,"+t+"Z"}e.svg.line.radial=function(){var e=Ha(rs)
return e.radius=e.x,delete e.x,e.angle=e.y,delete e.y,e},Ua.reverse=Ga,Ga.reverse=Ua,e.svg.area=function(){return ns(O)},e.svg.area.radial=function(){var e=ns(rs)
return e.radius=e.x,delete e.x,e.innerRadius=e.x0,delete e.x0,e.outerRadius=e.x1,delete e.x1,e.angle=e.y,delete e.y,e.startAngle=e.y0,delete e.y0,e.endAngle=e.y1,delete e.y1,e},e.svg.chord=function(){var e=Wn,t=zn,r=is,n=ja,i=Ia
function o(r,n){var i,o,l=a(this,e,r,n),c=a(this,t,r,n)
return"M"+l.p0+s(l.r,l.p1,l.a1-l.a0)+(o=c,(i=l).a0==o.a0&&i.a1==o.a1?u(l.r,l.p1,l.r,l.p0):u(l.r,l.p1,c.r,c.p0)+s(c.r,c.p1,c.a1-c.a0)+u(c.r,c.p1,l.r,l.p0))+"Z"}function a(e,t,o,a){var s=t.call(e,o,a),u=r.call(e,s,a),l=n.call(e,s,a)-Ce,c=i.call(e,s,a)-Ce
return{r:u,a0:l,a1:c,p0:[u*Math.cos(l),u*Math.sin(l)],p1:[u*Math.cos(c),u*Math.sin(c)]}}function s(e,t,r){return"A"+e+","+e+" 0 "+ +(r>ke)+",1 "+t}function u(e,t,r,n){return"Q 0,0 "+n}return o.radius=function(e){return arguments.length?(r=mt(e),o):r},o.source=function(t){return arguments.length?(e=mt(t),o):e},o.target=function(e){return arguments.length?(t=mt(e),o):t},o.startAngle=function(e){return arguments.length?(n=mt(e),o):n},o.endAngle=function(e){return arguments.length?(i=mt(e),o):i},o},e.svg.diagonal=function(){var e=Wn,t=zn,r=os
function n(n,i){var o=e.call(this,n,i),a=t.call(this,n,i),s=(o.y+a.y)/2,u=[o,{x:o.x,y:s},{x:a.x,y:s},a]
return"M"+(u=u.map(r))[0]+"C"+u[1]+" "+u[2]+" "+u[3]}return n.source=function(t){return arguments.length?(e=mt(t),n):e},n.target=function(e){return arguments.length?(t=mt(e),n):t},n.projection=function(e){return arguments.length?(r=e,n):r},n},e.svg.diagonal.radial=function(){var t=e.svg.diagonal(),r=os,n=t.projection
return t.projection=function(e){return arguments.length?n(function(e){return function(){var t=e.apply(this,arguments),r=t[0],n=t[1]-Ce
return[r*Math.cos(n),r*Math.sin(n)]}}(r=e)):r},t},e.svg.symbol=function(){var e=ss,t=as
function r(r,n){return(ls.get(e.call(this,r,n))||us)(t.call(this,r,n))}return r.type=function(t){return arguments.length?(e=mt(t),r):e},r.size=function(e){return arguments.length?(t=mt(e),r):t},r}
var ls=e.map({circle:us,cross:function(e){var t=Math.sqrt(e/5)/2
return"M"+-3*t+","+-t+"H"+-t+"V"+-3*t+"H"+t+"V"+-t+"H"+3*t+"V"+t+"H"+t+"V"+3*t+"H"+-t+"V"+t+"H"+-3*t+"Z"},diamond:function(e){var t=Math.sqrt(e/(2*fs)),r=t*fs
return"M0,"+-t+"L"+r+",0 0,"+t+" "+-r+",0Z"},square:function(e){var t=Math.sqrt(e)/2
return"M"+-t+","+-t+"L"+t+","+-t+" "+t+","+t+" "+-t+","+t+"Z"},"triangle-down":function(e){var t=Math.sqrt(e/cs),r=t*cs/2
return"M0,"+r+"L"+t+","+-r+" "+-t+","+-r+"Z"},"triangle-up":function(e){var t=Math.sqrt(e/cs),r=t*cs/2
return"M0,"+-r+"L"+t+","+r+" "+-t+","+r+"Z"}})
e.svg.symbolTypes=ls.keys()
var cs=Math.sqrt(3),fs=Math.tan(30*Me)
G.transition=function(e){for(var t,r,n=ms||++bs,i=ws(e),o=[],a=gs||{time:Date.now(),ease:oo,delay:0,duration:250},s=-1,u=this.length;++s<u;){o.push(t=[])
for(var l=this[s],c=-1,f=l.length;++c<f;)(r=l[c])&&xs(r,c,i,n,a),t.push(r)}return ps(o,i,n)},G.interrupt=function(e){return this.each(null==e?hs:ds(ws(e)))}
var hs=ds(ws())
function ds(e){return function(){var t,r,n;(t=this[e])&&(n=t[r=t.active])&&(n.timer.c=null,n.timer.t=NaN,--t.count?delete t[r]:delete this[e],t.active+=.5,n.event&&n.event.interrupt.call(this,this.__data__,n.index))}}function ps(e,t,r){return H(e,vs),e.namespace=t,e.id=r,e}var ms,gs,vs=[],bs=0
function ys(e,t,r,n){var i=e.id,o=e.namespace
return le(e,"function"==typeof r?function(e,a,s){e[o][i].tween.set(t,n(r.call(e,e.__data__,a,s)))}:(r=n(r),function(e){e[o][i].tween.set(t,r)}))}function _s(e){return null==e&&(e=""),function(){this.textContent=e}}function ws(e){return null==e?"__transition__":"__transition_"+e+"__"}function xs(e,t,r,n,i){var o,a,s,u,l,c=e[r]||(e[r]={active:0,count:0}),f=c[n]
...
m.timer.c=null,m.timer.t=NaN,--c.count,delete c[p]}a.c=d,Et(function(){return a.c&&d(r||1)&&(a.c=null,a.t=NaN),1},0,o),c.active=n,f.event&&f.event.start.call(e,e.__data__,t),l=[],f.tween.forEach(function(r,n){(n=n.call(e,e.__data__,t))&&l.push(n)}),u=f.ease,s=f.duration}function d(i){for(var o=i/s,a=u(o),h=l.length;h>0;)l[--h].call(e,a)
if(o>=1)return f.event&&f.event.end.call(e,e.__data__,t),--c.count?delete c[n]:delete e[r],1}f||(o=i.time,a=Et(function(e){var t=f.delay
if(a.t=t+o,t<=e)return h(e-t)
a.c=h},0,o),f=c[n]={tween:new y,time:o,timer:a,delay:i.delay,duration:i.duration,ease:i.ease,index:t},i=null,++c.count)}vs.call=G.call,vs.empty=G.empty,vs.node=G.node,vs.size=G.size,e.transition=function(t,r){return t&&t.transition?ms?t.transition(r):t:e.selection().transition(t)},e.transition.prototype=vs,vs.select=function(e){var t,r,n,i=this.id,o=this.namespace,a=[]
e=$(e)
for(var s=-1,u=this.length;++s<u;){a.push(t=[])
for(var l=this[s],c=-1,f=l.length;++c<f;)(n=l[c])&&(r=e.call(n,n.__data__,c,s))?("__data__"in n&&(r.__data__=n.__data__),xs(r,c,o,i,n[o][i]),t.push(r)):t.push(null)}return ps(a,o,i)},vs.selectAll=function(e){var t,r,n,i,o,a=this.id,s=this.namespace,u=[]
e=K(e)
for(var l=-1,c=this.length;++l<c;)for(var f=this[l],h=-1,d=f.length;++h<d;)if(n=f[h]){o=n[s][a],r=e.call(n,n.__data__,h,l),u.push(t=[])
for(var p=-1,m=r.length;++p<m;)(i=r[p])&&xs(i,p,s,a,o),t.push(i)}return ps(u,s,a)},vs.filter=function(e){var t,r,n=[]
"function"!=typeof e&&(e=ue(e))
for(var i=0,o=this.length;i<o;i++){n.push(t=[])
for(var a,s=0,u=(a=this[i]).length;s<u;s++)(r=a[s])&&e.call(r,r.__data__,s,i)&&t.push(r)}return ps(n,this.namespace,this.id)},vs.tween=function(e,t){var r=this.id,n=this.namespace
return arguments.length<2?this.node()[n][r].tween.get(e):le(this,null==t?function(t){t[n][r].tween.remove(e)}:function(i){i[n][r].tween.set(e,t)})},vs.attr=function(t,r){if(arguments.length<2){for(r in t)this.attr(r,t[r])
return this}var n="transform"==t?vo:Qi,i=e.ns.qualify(t)
function o(){this.removeAttribute(i)}function a(){this.removeAttributeNS(i.space,i.local)}return ys(this,"attr."+t,r,i.local?function(e){return null==e?a:(e+="",function(){var t,r=this.getAttributeNS(i.space,i.local)
return r!==e&&(t=n(r,e),function(e){this.setAttributeNS(i.space,i.local,t(e))})})}:function(e){return null==e?o:(e+="",function(){var t,r=this.getAttribute(i)
return r!==e&&(t=n(r,e),function(e){this.setAttribute(i,t(e))})})})},vs.attrTween=function(t,r){var n=e.ns.qualify(t)
return this.tween("attr."+t,n.local?function(e,t){var i=r.call(this,e,t,this.getAttributeNS(n.space,n.local))
return i&&function(e){this.setAttributeNS(n.space,n.local,i(e))}}:function(e,t){var i=r.call(this,e,t,this.getAttribute(n))
return i&&function(e){this.setAttribute(n,i(e))}})},vs.style=function(e,t,r){var n=arguments.length
if(n<3){if("string"!=typeof e){for(r in n<2&&(t=""),e)this.style(r,e[r],t)
return this}r=""}function i(){this.style.removeProperty(e)}return ys(this,"style."+e,t,function(t){return null==t?i:(t+="",function(){var n,i=o(this).getComputedStyle(this,null).getPropertyValue(e)
return i!==t&&(n=Qi(i,t),function(t){this.style.setProperty(e,n(t),r)})})})},vs.styleTween=function(e,t,r){return arguments.length<3&&(r=""),this.tween("style."+e,function(n,i){var a=t.call(this,n,i,o(this).getComputedStyle(this,null).getPropertyValue(e))
return a&&function(t){this.style.setProperty(e,a(t),r)}})},vs.text=function(e){return ys(this,"text",e,_s)},vs.remove=function(){var e=this.namespace
return this.each("end.transition",function(){var t
this[e].count<2&&(t=this.parentNode)&&t.removeChild(this)})},vs.ease=function(t){var r=this.id,n=this.namespace
return arguments.length<1?this.node()[n][r].ease:("function"!=typeof t&&(t=e.ease.apply(e,arguments)),le(this,function(e){e[n][r].ease=t}))},vs.delay=function(e){var t=this.id,r=this.namespace
return arguments.length<1?this.node()[r][t].delay:le(this,"function"==typeof e?function(n,i,o){n[r][t].delay=+e.call(n,n.__data__,i,o)}:(e=+e,function(n){n[r][t].delay=e}))},vs.duration=function(e){var t=this.id,r=this.namespace
return arguments.length<1?this.node()[r][t].duration:le(this,"function"==typeof e?function(n,i,o){n[r][t].duration=Math.max(1,e.call(n,n.__data__,i,o))}:(e=Math.max(1,e),function(n){n[r][t].duration=e}))},vs.each=function(t,r){var n=this.id,i=this.namespace
if(arguments.length<2){var o=gs,a=ms
try{ms=n,le(this,function(e,r,o){gs=e[i][n],t.call(e,e.__data__,r,o)})}finally{gs=o,ms=a}}else le(this,function(o){var a=o[i][n];(a.event||(a.event=e.dispatch("start","end","interrupt"))).on(t,r)})
return this},vs.transition=function(){for(var e,t,r,n=this.id,i=++bs,o=this.namespace,a=[],s=0,u=this.length;s<u;s++){a.push(e=[])
for(var l,c=0,f=(l=this[s]).length;c<f;c++)(t=l[c])&&xs(t,c,o,i,{time:(r=t[o][n]).time,ease:r.ease,delay:r.delay+r.duration,duration:r.duration}),e.push(t)}return ps(a,o,i)},e.svg.axis=function(){var t,n=e.scale.linear(),i=Es,o=6,a=6,s=3,u=[10],l=null
function c(r){r.each(function(){var r,c=e.select(this),f=this.__chart__||n,h=this.__chart__=n.copy(),d=null==l?h.ticks?h.ticks.apply(h,u):h.domain():l,p=null==t?h.tickFormat?h.tickFormat.apply(h,u):O:t,m=c.selectAll(".tick").data(d,h),g=m.enter().insert("g",".domain").attr("class","tick").style("opacity",xe),v=e.transition(m.exit()).style("opacity",xe).remove(),b=e.transition(m.order()).style("opacity",1),y=Math.max(o,0)+s,_=ha(h),w=c.selectAll(".domain").data([0]),x=(w.enter().append("path").attr("class","domain"),e.transition(w))
g.append("line"),g.append("text")
var E,k,S,A,C=g.select("line"),M=b.select("line"),T=m.select("text").text(p),N=g.select("text"),L=b.select("text"),D="top"===i||"left"===i?-1:1
if("bottom"===i||"top"===i?(r=Ss,E="x",S="y",k="x2",A="y2",T.attr("dy",D<0?"0em":".71em").style("text-anchor","middle"),x.attr("d","M"+_[0]+","+D*a+"V0H"+_[1]+"V"+D*a)):(r=As,E="y",S="x",k="y2",A="x2",T.attr("dy",".32em").style("text-anchor",D<0?"end":"start"),x.attr("d","M"+D*a+","+_[0]+"H0V"+_[1]+"H"+D*a)),C.attr(A,D*o),N.attr(S,D*y),M.attr(k,0).attr(A,D*o),L.attr(E,0).attr(S,D*y),h.rangeBand){var P=h,R=P.rangeBand()/2
f=h=function(e){return P(e)+R}}else f.rangeBand?f=h:v.call(r,h,f)
g.call(r,f,h),b.call(r,h,h)})}return c.scale=function(e){return arguments.length?(n=e,c):n},c.orient=function(e){return arguments.length?(i=e in ks?e+"":Es,c):i},c.ticks=function(){return arguments.length?(u=r(arguments),c):u},c.tickValues=function(e){return arguments.length?(l=e,c):l},c.tickFormat=function(e){return arguments.length?(t=e,c):t},c.tickSize=function(e){var t=arguments.length
return t?(o=+e,a=+arguments[t-1],c):o},c.innerTickSize=function(e){return arguments.length?(o=+e,c):o},c.outerTickSize=function(e){return arguments.length?(a=+e,c):a},c.tickPadding=function(e){return arguments.length?(s=+e,c):s},c.tickSubdivide=function(){return arguments.length&&c},c}
var Es="bottom",ks={top:1,right:1,bottom:1,left:1}
function Ss(e,t,r){e.attr("transform",function(e){var n=t(e)
return"translate("+(isFinite(n)?n:r(e))+",0)"})}function As(e,t,r){e.attr("transform",function(e){var n=t(e)
return"translate(0,"+(isFinite(n)?n:r(e))+")"})}e.svg.brush=function(){var t,r,n=V(h,"brushstart","brush","brushend"),i=null,a=null,s=[0,0],u=[0,0],l=!0,c=!0,f=Ms[0]
function h(t){t.each(function(){var t=e.select(this).style("pointer-events","all").style("-webkit-tap-highlight-color","rgba(0,0,0,0)").on("mousedown.brush",g).on("touchstart.brush",g),r=t.selectAll(".background").data([0])
r.enter().append("rect").attr("class","background").style("visibility","hidden").style("cursor","crosshair"),t.selectAll(".extent").data([0]).enter().append("rect").attr("class","extent").style("cursor","move")
var n=t.selectAll(".resize").data(f,O)
n.exit().remove(),n.enter().append("g").attr("class",function(e){return"resize "+e}).style("cursor",function(e){return Cs[e]}).append("rect").attr("x",function(e){return/[ew]$/.test(e)?-3:null}).attr("y",function(e){return/^[ns]/.test(e)?-3:null}).attr("width",6).attr("height",6).style("visibility","hidden"),n.style("display",h.empty()?"none":null)
var o,s=e.transition(t),u=e.transition(r)
i&&(o=ha(i),u.attr("x",o[0]).attr("width",o[1]-o[0]),p(s)),a&&(o=ha(a),u.attr("y",o[0]).attr("height",o[1]-o[0]),m(s)),d(s)})}function d(e){e.selectAll(".resize").attr("transform",function(e){return"translate("+s[+/e$/.test(e)]+","+u[+/^s/.test(e)]+")"})}function p(e){e.select(".extent").attr("x",s[0]),e.selectAll(".extent,.n>rect,.s>rect").attr("width",s[1]-s[0])}function m(e){e.select(".extent").attr("y",u[0]),e.selectAll(".extent,.e>rect,.w>rect").attr("height",u[1]-u[0])}function g(){var f,g,v=this,b=e.select(e.event.target),y=n.of(v,arguments),_=e.select(v),w=b.datum(),x=!/^(n|s)$/.test(w)&&i,E=!/^(e|w)$/.test(w)&&a,k=b.classed("extent"),S=be(v),A=e.mouse(v),C=e.select(o(v)).on("keydown.brush",function(){32==e.event.keyCode&&(k||(f=null,A[0]-=s[1],A[1]-=u[1],k=2),I())}).on("keyup.brush",function(){32==e.event.keyCode&&2==k&&(A[0]+=s[1],A[1]+=u[1],k=0,I())})
if(e.event.changedTouches?C.on("touchmove.brush",O).on("touchend.brush",L):C.on("mousemove.brush",O).on("mouseup.brush",L),_.interrupt().selectAll("*").interrupt(),k)A[0]=s[0]-A[0],A[1]=u[0]-A[1]
else if(w){var M=+/w$/.test(w),T=+/^n/.test(w)
g=[s[1-M]-A[0],u[1-T]-A[1]],A[0]=s[M],A[1]=u[T]}else e.event.altKey&&(f=A.slice())
function O(){var t=e.mouse(v),r=!1
g&&(t[0]+=g[0],t[1]+=g[1]),k||(e.event.altKey?(f||(f=[(s[0]+s[1])/2,(u[0]+u[1])/2]),A[0]=s[+(t[0]<f[0])],A[1]=u[+(t[1]<f[1])]):f=null),x&&N(t,i,0)&&(p(_),r=!0),E&&N(t,a,1)&&(m(_),r=!0),r&&(d(_),y({type:"brush",mode:k?"move":"resize"}))}function N(e,n,i){var o,a,h=ha(n),d=h[0],p=h[1],m=A[i],g=i?u:s,v=g[1]-g[0]
if(k&&(d-=m,p-=v+m),o=(i?c:l)?Math.max(d,Math.min(p,e[i])):e[i],k?a=(o+=m)+v:(f&&(m=Math.max(d,Math.min(p,2*f[i]-o))),m<o?(a=o,o=m):a=m),g[0]!=o||g[1]!=a)return i?r=null:t=null,g[0]=o,g[1]=a,!0}function L(){O(),_.style("pointer-events","all").selectAll(".resize").style("display",h.empty()?"none":null),e.select("body").style("cursor",null),C.on("mousemove.brush",null).on("mouseup.brush",null).on("touchmove.brush",null).on("touchend.brush",null).on("keydown.brush",null).on("keyup.brush",null),S(),y({type:"brushend"})}_.style("pointer-events","none").selectAll(".resize").style("display",null),e.select("body").style("cursor",b.style("cursor")),y({type:"brushstart"}),O()}return h.event=function(i){i.each(function(){var i=n.of(this,arguments),o={x:s,y:u,i:t,j:r},a=this.__chart__||o
this.__chart__=o,ms?e.select(this).transition().each("start.brush",function(){t=a.i,r=a.j,s=a.x,u=a.y,i({type:"brushstart"})}).tween("brush:brush",function(){var e=Xi(s,o.x),n=Xi(u,o.y)
return t=r=null,function(t){s=o.x=e(t),u=o.y=n(t),i({type:"brush",mode:"resize"})}}).each("end.brush",function(){t=o.i,r=o.j,i({type:"brush",mode:"resize"}),i({type:"brushend"})}):(i({type:"brushstart"}),i({type:"brush",mode:"resize"}),i({type:"brushend"}))})},h.x=function(e){return arguments.length?(f=Ms[!(i=e)<<1|!a],h):i},h.y=function(e){return arguments.length?(f=Ms[!i<<1|!(a=e)],h):a},h.clamp=function(e){return arguments.length?(i&&a?(l=!!e[0],c=!!e[1]):i?l=!!e:a&&(c=!!e),h):i&&a?[l,c]:i?l:a?c:null},h.extent=function(e){var n,o,l,c,f
return arguments.length?(i&&(n=e[0],o=e[1],a&&(n=n[0],o=o[0]),t=[n,o],i.invert&&(n=i(n),o=i(o)),o<n&&(f=n,n=o,o=f),n==s[0]&&o==s[1]||(s=[n,o])),a&&(l=e[0],c=e[1],i&&(l=l[1],c=c[1]),r=[l,c],a.invert&&(l=a(l),c=a(c)),c<l&&(f=l,l=c,c=f),l==u[0]&&c==u[1]||(u=[l,c])),h):(i&&(t?(n=t[0],o=t[1]):(n=s[0],o=s[1],i.invert&&(n=i.invert(n),o=i.invert(o)),o<n&&(f=n,n=o,o=f))),a&&(r?(l=r[0],c=r[1]):(l=u[0],c=u[1],a.invert&&(l=a.invert(l),c=a.invert(c)),c<l&&(f=l,l=c,c=f))),i&&a?[[n,l],[o,c]]:i?[n,o]:a&&[l,c])},h.clear=function(){return h.empty()||(s=[0,0],u=[0,0],t=r=null),h},h.empty=function(){return!!i&&s[0]==s[1]||!!a&&u[0]==u[1]},e.rebind(h,n,"on")}
var Cs={n:"ns-resize",e:"ew-resize",s:"ns-resize",w:"ew-resize",nw:"nwse-resize",ne:"nesw-resize",se:"nwse-resize",sw:"nesw-resize"},Ms=[["n","e","s","w","nw","ne","se","sw"],["e","w"],["n","s"],[]],Ts=Dt.format=ur.timeFormat,Os=Ts.utc,Ns=Os("%Y-%m-%dT%H:%M:%S.%LZ")
function Ls(e){return e.toISOString()}function Ds(t,r,n){function i(e){return t(e)}function o(t,n){var i=(t[1]-t[0])/n,o=e.bisect(Rs,i)
return o==Rs.length?[r.year,_a(t.map(function(e){return e/31536e6}),n)[2]]:o?r[i/Rs[o-1]<Rs[o]/i?o-1:o]:[Bs,_a(t,n)[2]]}return i.invert=function(e){return Ps(t.invert(e))},i.domain=function(e){return arguments.length?(t.domain(e),i):t.domain().map(Ps)},i.nice=function(e,t){var r=i.domain(),n=fa(r),a=null==e?o(n,10):"number"==typeof e&&o(n,e)
function s(r){return!isNaN(r)&&!e.range(r,Ps(+r+1),t).length}return a&&(e=a[0],t=a[1]),i.domain(pa(r,t>1?{floor:function(t){for(;s(t=e.floor(t));)t=Ps(t-1)
return t},ceil:function(t){for(;s(t=e.ceil(t));)t=Ps(+t+1)
return t}}:e))},i.ticks=function(e,t){var r=fa(i.domain()),n=null==e?o(r,10):"number"==typeof e?o(r,e):!e.range&&[{range:e},t]
return n&&(e=n[0],t=n[1]),e.range(r[0],Ps(+r[1]+1),t<1?1:t)},i.tickFormat=function(){return n},i.copy=function(){return Ds(t.copy(),r,n)},ba(i,t)}function Ps(e){return new Date(e)}Ts.iso=Date.prototype.toISOString&&+new Date("2000-01-01T00:00:00.000Z")?Ls:Ns,Ls.parse=function(e){var t=new Date(e)
return isNaN(t)?null:t},Ls.toString=Ns.toString,Dt.second=It(function(e){return new Pt(1e3*Math.floor(e/1e3))},function(e,t){e.setTime(e.getTime()+1e3*Math.floor(t))},function(e){return e.getSeconds()}),Dt.seconds=Dt.second.range,Dt.seconds.utc=Dt.second.utc.range,Dt.minute=It(function(e){return new Pt(6e4*Math.floor(e/6e4))},function(e,t){e.setTime(e.getTime()+6e4*Math.floor(t))},function(e){return e.getMinutes()}),Dt.minutes=Dt.minute.range,Dt.minutes.utc=Dt.minute.utc.range,Dt.hour=It(function(e){var t=e.getTimezoneOffset()/60
return new Pt(36e5*(Math.floor(e/36e5-t)+t))},function(e,t){e.setTime(e.getTime()+36e5*Math.floor(t))},function(e){return e.getHours()}),Dt.hours=Dt.hour.range,Dt.hours.utc=Dt.hour.utc.range,Dt.month=It(function(e){return(e=Dt.day(e)).setDate(1),e},function(e,t){e.setMonth(e.getMonth()+t)},function(e){return e.getMonth()}),Dt.months=Dt.month.range,Dt.months.utc=Dt.month.utc.range
var Rs=[1e3,5e3,15e3,3e4,6e4,3e5,9e5,18e5,36e5,108e5,216e5,432e5,864e5,1728e5,6048e5,2592e6,7776e6,31536e6],js=[[Dt.second,1],[Dt.second,5],[Dt.second,15],[Dt.second,30],[Dt.minute,1],[Dt.minute,5],[Dt.minute,15],[Dt.minute,30],[Dt.hour,1],[Dt.hour,3],[Dt.hour,6],[Dt.hour,12],[Dt.day,1],[Dt.day,2],[Dt.week,1],[Dt.month,1],[Dt.month,3],[Dt.year,1]],Is=Ts.multi([[".%L",function(e){return e.getMilliseconds()}],[":%S",function(e){return e.getSeconds()}],["%I:%M",function(e){return e.getMinutes()}],["%I %p",function(e){return e.getHours()}],["%a %d",function(e){return e.getDay()&&1!=e.getDate()}],["%b %d",function(e){return 1!=e.getDate()}],["%B",function(e){return e.getMonth()}],["%Y",$r]]),Bs={range:function(t,r,n){return e.range(Math.ceil(t/n)*n,+r,n).map(Ps)},floor:O,ceil:O}
js.year=Dt.year,Dt.scale=function(){return Ds(e.scale.linear(),js,Is)}
var Vs=js.map(function(e){return[e[0].utc,e[1]]}),Fs=Os.multi([[".%L",function(e){return e.getUTCMilliseconds()}],[":%S",function(e){return e.getUTCSeconds()}],["%I:%M",function(e){return e.getUTCMinutes()}],["%I %p",function(e){return e.getUTCHours()}],["%a %d",function(e){return e.getUTCDay()&&1!=e.getUTCDate()}],["%b %d",function(e){return 1!=e.getUTCDate()}],["%B",function(e){return e.getUTCMonth()}],["%Y",$r]])
function Hs(e){return JSON.parse(e.responseText)}function Ws(e){var t=n.createRange()
return t.selectNode(n.body),t.createContextualFragment(e.responseText)}Vs.year=Dt.year.utc,Dt.scale.utc=function(){return Ds(e.scale.linear(),Vs,Fs)},e.text=gt(function(e){return e.responseText}),e.json=function(e,t){return vt(e,"application/json",Hs,t)},e.html=function(e,t){return vt(e,"text/html",Ws,t)},e.xml=gt(function(e){return e.responseXML}),"function"==typeof define&&define.amd?(this.d3=e,define(e)):"object"==typeof module&&module.exports?module.exports=e:this.d3=e}(),function(){"use strict"
...
function F(e){return!!V.CSS_UNIT.exec(e)}"undefined"!=typeof module&&module.exports?module.exports=u:"function"==typeof define&&define.amd?define(function(){return u}):window.tinycolor=u}(Math),define("ember-charts/components/bubble-chart",["exports","ember-charts/components/chart-component","ember-charts/mixins/floating-tooltip"],function(e,t,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var n=t.default.extend(r.default,{classNames:["chart-bubble"],layoutGravity:-.01,damper:.1,charge:Ember.computed(function(){return function(e){return-Math.pow(e.radius,2)/8}}),formatLabel:d3.format(",.2f"),showDetails:Ember.computed("isInteractive",function(){return this.get("isInteractive")?Ember.K:function(e,t,r){d3.select(r).classed("hovered",!0)
var n=this.get("formatLabel"),i=$("<span>")
return i.append($('<span class="tip-label">').text(e.label)),i.append($('<span class="name">').text(this.get("tooltipValueDisplayName")+": ")),i.append($('<span class="value">').text(n(e.value))),this.showTooltip(i.html(),d3.event)}}),hideDetails:Ember.computed("isInteractive",function(){return this.get("isInteractive")?Ember.K:function(e,t,r){return d3.select(r).classed("hovered",!1),this.hideTooltip()}}),willDestroyElement:function(){if(this._hasMouseEventListeners){var e=this.get("viewport").selectAll("circle")
e.on("mouseover",null),e.on("mouseout",null)}this._super.apply(this,arguments)},renderVars:["selectedSeedColor"],radiusScale:Ember.computed("data","width","height",function(){var e=d3.max(this.get("data"),function(e){return e.value}),t=d3.min([this.get("width"),this.get("height")])/7
return d3.scale.pow().exponent(.5).domain([0,e]).range([2,t])}),nodeData:Ember.computed("radiusScale",function(){var e=this,t=this.get("data")
...
return n.sort(function(e,t){return t.value-e.value}),n}),finishedData:Ember.computed.alias("nodeData"),numColorSeries:Ember.computed.alias("finishedData.length"),drawChart:function(){return this.updateVis()},updateVis:function(){var e=this,t=this.get("viewport"),r=this.get("nodeData"),n=this.get("showDetails"),i=this.get("hideDetails"),o=this.get("getSeriesColor")
this._hasMouseEventListeners=!0
var a=t.selectAll("circle").data(r,function(e){return e.id})
a.enter().append("circle").attr("r",0).attr("id",function(e){return"bubble_"+e.id}).on("mouseover",function(e,t){return n(e,t,this)}).on("mouseout",function(e,t){return i(e,t,this)}),a.transition().duration(2e3).attr("r",function(e){return e.radius}),a.attr("fill",o).attr("stroke-width",2).attr("stroke",function(e,t){return d3.rgb(o(e,t)).darker()}),a.exit().remove()
var s=d3.layout.force().nodes(r).size([this.get("width"),this.get("height")])
return s.gravity(this.get("layoutGravity")).charge(this.get("charge")).friction(.9).on("tick",function(t){var r,n,i
a.each((r=t.alpha,n=e.get("width")/2,i=e.get("height")/2,function(t){t.x=t.x+(n-t.x)*(e.get("damper")+.02)*r,t.y=t.y+(i-t.y)*(e.get("damper")+.02)*r})).attr("cx",function(e){return e.x}).attr("cy",function(e){return e.y})}),s.start(),t.selectAll(".years").remove()}})
e.default=n}),define("ember-charts/components/chart-component",["exports","lodash-es","ember-charts/mixins/resize-handler","ember-charts/mixins/colorable"],function(e,t,r,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var i=Ember.Component.extend(n.default,r.default,{layoutName:"components/chart-component",classNames:["chart-frame","scroll-y"],isInteractive:!0,horizontalMargin:30,verticalMargin:30,horizontalMarginLeft:null,horizontalMarginRight:null,allFinishedDataValues:Ember.computed("finishedData.@each.value",function(){return this.get("finishedData").map(function(e){return e.value})}),minValue:Ember.computed("allFinishedDataValues.[]",function(){return d3.min(this.get("allFinishedDataValues"))}),maxValue:Ember.computed("allFinishedDataValues.[]",function(){return d3.max(this.get("allFinishedDataValues"))}),positiveValues:Ember.computed("allFinishedDataValues.[]",function(){return this.get("allFinishedDataValues").filter(function(e){return e>=0})}),negativeValues:Ember.computed("allFinishedDataValues.[]",function(){return this.get("allFinishedDataValues").filter(function(e){return e<0})}),hasNegativeValues:Ember.computed.lt("minValue",0),hasPositiveValues:Ember.computed.gt("maxValue",0),hasAllNegativeValues:Ember.computed.lte("maxValue",0),hasAllPositiveValues:Ember.computed.gte("minValue",0),marginRight:Ember.computed("horizontalMarginRight","horizontalMargin",function(){var e=this.get("horizontalMarginRight")
...
return Ember.isNone(e)?this.get("horizontalMargin"):e}),marginTop:Ember.computed.alias("verticalMargin"),marginBottom:Ember.computed.alias("verticalMargin"),defaultOuterHeight:500,defaultOuterWidth:700,outerHeight:Ember.computed.alias("defaultOuterHeight"),outerWidth:Ember.computed.alias("defaultOuterWidth"),width:Ember.computed("outerWidth","marginLeft","marginRight",function(){return Math.abs(this.get("outerWidth")-this.get("marginLeft")-this.get("marginRight"))}),height:Ember.computed("outerHeight","marginBottom","marginTop",function(){return Math.max(1,this.get("outerHeight")-this.get("marginBottom")-this.get("marginTop"))}),$viewport:Ember.computed(function(){return this.$(".chart-viewport")[0]}),viewport:Ember.computed(function(){return d3.select(this.get("$viewport"))}),transformViewport:Ember.computed("marginLeft","marginTop",function(){var e=this.get("marginLeft"),t=this.get("marginTop")
...
return Ember.isNone(e)?null:this.get("numBars")*e+this.get("marginTop")+this.get("marginBottom")}),outerHeight:Ember.computed("minOuterHeight","maxOuterHeight","defaultOuterHeight",function(){var e=d3.max([this.get("defaultOuterHeight"),this.get("minOuterHeight")])
return d3.min([e,this.get("maxOuterHeight")])}),marginTop:Ember.computed.alias("labelPadding"),marginBottom:Ember.computed("labelPadding","xTitleVerticalOffset","hasXAxisTitle",function(){return this.get("hasXAxisTitle")?this.get("labelPadding")+this.get("xTitleVerticalOffset"):this.get("labelPadding")}),marginLeft:Ember.computed.alias("horizontalMarginLeft"),numBars:Ember.computed.alias("finishedData.length"),xDomain:Ember.computed("minValue","maxValue",function(){var e=this.get("minValue"),t=this.get("maxValue")
return this.get("hasNegativeValues")?this.get("hasPositiveValues")?[e,t]:[e,0]:[0,t]}),_xScaleForWidth:function(e){return d3.scale.linear().domain(this.get("xDomain")).range([0,e])},xScale:Ember.computed("width","xDomain",function(){return this._xScaleForWidth(this.get("width"))}),yScale:Ember.computed("height","barPadding",function(){return d3.scale.ordinal().domain(d3.range(this.get("numBars"))).rangeRoundBands([0,this.get("height")],this.get("barPadding"))}),barThickness:Ember.computed("yScale",function(){return this.get("yScale").rangeBand()}),showDetails:Ember.computed("isInteractive",function(){var e=this
return this.get("isInteractive")?function(t,r,n){d3.select(n).classed("hovered",!0)
var i=e.get("formatLabelFunction"),o=$("<span>")
return o.append($('<span class="tip-label">').text(t.label)),o.append($('<span class="name">').text(e.get("tooltipValueDisplayName")+": ")),o.append($('<span class="value">').text(i(t.value))),e.showTooltip(o.html(),d3.event)}:Ember.K}),hideDetails:Ember.computed("isInteractive",function(){var e=this
return this.get("isInteractive")?function(t,r,n){return d3.select(n).classed("hovered",!1),e.hideTooltip()}:Ember.K}),groupAttrs:Ember.computed("xScale","yScale",function(){var e=this.get("xScale"),t=this.get("yScale")
...
var o=this.get("labelPadding"),s=this.get("yAxisTitleHeightOffset")
this.setProperties({horizontalMarginLeft:i.left+o+s,horizontalMarginRight:i.right+o+(this.get("isInteractive")?15:0)})
var u=this.get("maxLabelWidth")
if(!Ember.isNone(u)){var l=a.default.create({getLabelSize:function(){return u},getLabelText:function(e){return e.label}})
t.select("text.group").call(l.get("trim"))}}})
e.default=u}),define("ember-charts/components/pie-chart",["exports","lodash-es","ember-charts/components/chart-component","ember-charts/mixins/formattable","ember-charts/mixins/floating-tooltip","ember-charts/mixins/sortable-chart","ember-charts/mixins/pie-legend","ember-charts/mixins/label-width","ember-charts/utils/label-trimmer"],function(e,t,r,n,i,o,a,s,u){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var l=r.default.extend(i.default,n.default,o.default,a.default,s.default,{classNames:["chart-pie"],minSlicePercent:5,maxNumberOfSlices:8,maxRadius:2e3,minimumTopBottomMargin:0,maxDecimalPlace:0,rotationOffset:.25*Math.PI,includeRoundedZeroPercentSlices:!0,willDestroyElement:function(){if(this._hasMouseEventListeners){var e=this.getViewportArc()
...
return e=this.get("data"),Ember.isEmpty(e)?[]:e.filter(function(e){return e.value<0})}),sortedData:Ember.computed("filteredData","sortKey",function(){var e=this.get("filteredData"),r=e.reduce(function(e,t){return t.value+e},0)
return 0===r?[]:(e=e.map(function(e){return{color:e.color,label:e.label,value:e.value,percent:100*e.value/r}}),(0,t.sortBy)(e,this.get("sortKey")))}),otherLabel:"Other",sortedDataWithOther:Ember.computed("sortedData","maxNumberOfSlices","minSlicePercent","maxDecimalPlace","includeRoundedZeroPercentSlices",function(){var e,r,n,i=(0,t.cloneDeep)(this.get("sortedData")).reverse(),o=this.get("maxNumberOfSlices"),a=this.get("minSlicePercent"),s=[],u={label:this.get("otherLabel"),percent:0,_otherItems:s},l=(0,t.indexOf)(i,(0,t.find)(i,function(e){return e.percent<a}))
l<0?l=i.length:((0,t.takeRight)(i,i.length-l).forEach(function(e){return s.push(e),u.percent+=e.percent}),u.percent<a&&(e=i[l-1]).percent<a&&(l-=1,s.push(e),u.percent+=e.percent)),u.percent>0&&(o-=1),n=(0,t.take)(i,l),(r=(0,t.drop)(n,o)).length>0&&(r.forEach(function(e){return s.push(e),u.percent+=e.percent}),n=(0,t.take)(n,o)),1===s.length?n.push(s[0]):u.percent>0&&(u.percent>n[0].percent?n.unshift(u):n.push(u))
var c=this.get("maxDecimalPlace"),f=function(e){e.forEach(function(e){e.percent=d3.round(1*e.percent,c)})}
f(n),f(s)
return!1===this.get("includeRoundedZeroPercentSlices")&&(n=n.filter(function(e){return 0!==e.percent})),n.reverse()}),otherData:Ember.computed("sortedDataWithOther.[]","sortFunction",function(){var e,r=(0,t.find)(this.get("sortedDataWithOther"),function(e){return e._otherItems})
return e=null!=r&&null!=r._otherItems?r._otherItems:[],(0,t.sortBy)(e,this.get("sortFunction")).reverse()}),otherDataValue:Ember.computed("otherData.[]",function(){var e,r
return r=0,null!=(e=this.get("otherData"))&&(0,t.each)(e,function(e){return r+=e.value}),r}),finishedData:Ember.computed.alias("sortedDataWithOther"),horizontalMargin:Ember.computed("labelPadding","labelWidth",function(){return this.get("labelPadding")+this.get("labelWidth")}),_marginBottom:Ember.computed("legendHeight","hasLegend","marginTop",function(){return this.get("hasLegend")?this.get("legendHeight"):this.get("marginTop")}),marginBottom:Ember.computed("_marginBottom","minimumTopBottomMargin",function(){return Math.max(this.get("_marginBottom"),this.get("minimumTopBottomMargin"))}),_marginTop:Ember.computed("outerHeight",function(){return Math.max(1,.1*this.get("outerHeight"))}),marginTop:Ember.computed("_marginTop","minimumTopBottomMargin",function(){return Math.max(this.get("_marginTop"),this.get("minimumTopBottomMargin"))}),numSlices:Ember.computed.alias("finishedData.length"),startOffset:Ember.computed("finishedData","sortKey","rotationOffset",function(){var e=this.get("finishedData")
if(Ember.isEmpty(e))return 0
var r=e.reduce(function(e,t){return t.percent+e},0)
return function(e){var r=(0,t.sortBy)(e,"percent"),n=Math.min(2,r.length),i=(0,t.last)(r).percent,o=r.slice(0,n).reduce(function(e,t){return t.percent/(n-0)+e},0)
return o<=2.75||o<=5&&45<=i&&i<=55}(e)?this.get("rotationOffset"):(0,t.last)(e).percent/r*2*Math.PI}),pieRadius:Ember.computed("maxRadius","width","height",function(){return d3.min([this.get("maxRadius"),this.get("width")/2,this.get("height")/2])}),labelRadius:Ember.computed("pieRadius","labelPadding",function(){return this.get("pieRadius")+this.get("labelPadding")}),getSliceColor:Ember.computed("numSlices","colorScale",function(){var e=this
...
return this.get("isInteractive")?function(t,r,n){var i,o,a,s
return d3.select(n).classed("hovered",!0),s=(o=t.data)._otherItems?e.get("otherDataValue"):o.value,a=e.get("formatLabelFunction"),(i=$("<span>")).append($('<span class="tip-label">').text(o.label)),i.append($('<span class="name">').text(e.get("tooltipValueDisplayName")+": ")),i.append($('<span class="value">').text(a(s))),e.showTooltip(i.html(),d3.event)}:Ember.K}),hideDetails:Ember.computed("isInteractive",function(){var e=this
return this.get("isInteractive")?function(t,r,n){return d3.select(n).classed("hovered",!1),t.data._otherItems?e.get("viewport").select(".legend").classed("hovered",!1):e.hideTooltip()}:Ember.K}),transformViewport:Ember.computed("marginLeft","marginTop","width","height",function(){return"translate("+(this.get("marginLeft")+this.get("width")/2)+","+(this.get("marginTop")+this.get("height")/2)+")"}),arc:Ember.computed("pieRadius",function(){return d3.svg.arc().outerRadius(this.get("pieRadius")).innerRadius(0)}),pie:Ember.computed("startOffset",function(){return d3.layout.pie().startAngle(this.get("startOffset")).endAngle(this.get("startOffset")+2*Math.PI).sort(null).value(function(e){return e.percent})}),groupAttrs:Ember.computed(function(){return{class:function(e){return e.data._otherItems?"arc other-slice":"arc"}}}),sliceAttrs:Ember.computed("arc","getSliceColor",function(){return{d:this.get("arc"),fill:this.get("getSliceColor"),stroke:this.get("getSliceColor")}}),labelAttrs:Ember.computed("arc","labelRadius","numSlices","mostTintedColor",function(){var e=this.get("arc"),r=this.get("labelRadius"),n={left:[],right:[]}
...
return Math.PI<t&&t<2*Math.PI?"end":"start"},transform:function(i){var o=e.centroid(i)[0],a=e.centroid(i)[1],s=function(e){return e/Math.sqrt(o*o+a*a)*r},u=s(o),l=s(a),c=this.getBBox().height,f=u>0?"right":"left",h=function(e){return Math.sqrt(Math.max(Math.pow(r,2)-Math.pow(e,2),0))}
return function(e,t,r){return n[e].some(function(e){return Math.abs(t-e)<r})}(f,l,c)&&(u="right"===f?h(l=(0,t.max)(n[f])+c):-1*h(l=(0,t.min)(n[f])-c)),n[f].push(l),"translate("+u+","+l+")"}}:{dy:".71em","stroke-width":0,"text-anchor":"middle",transform:null,style:"fill:"+this.get("mostTintedColor")+";"}}),getViewportArc:function(){return this.get("viewport").selectAll(".arc")},groups:Ember.computed(function(){var e=this.get("pie")(this.get("finishedData"))
...
var t=this.get("outerWidth")/2-this.get("labelPadding"),r=u.default.create({reservedCharLength:4,getLabelSize:function(e,r){var n=r.filter(function(t){return t===e}),i=d3.transform(n.attr("transform")).translate[0]
return t-Math.abs(i)},getLabelText:function(e){return e.data.label}})
return e.select("text.data").text(function(e){return e.data.label}).attr(this.get("labelAttrs")).call(r.get("trim")).text(function(e){return this.textContent+", "+e.data.percent+"%"})}})
e.default=l}),define("ember-charts/components/scatter-chart",["exports","lodash-es","ember-charts/components/chart-component","ember-charts/mixins/legend","ember-charts/mixins/floating-tooltip","ember-charts/mixins/axes","ember-charts/mixins/no-margin-chart","ember-charts/mixins/axis-titles","ember-charts/utils/group-by"],function(e,t,r,n,i,o,a,s,u){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var l=r.default.extend(n.default,i.default,o.default,a.default,s.default,{classNames:["chart-scatter"],formatXValue:d3.format(",.2f"),formatYValue:d3.format(",.2f"),dotRadius:7,dotShapeArea:Ember.computed("dotRadius",function(){return Math.pow(this.get("dotRadius"),2)}),graphPadding:.05,tickSpacing:80,marginRight:Ember.computed.alias("horizontalMargin"),hasXDomainPadding:!0,hasYDomainPadding:!0,willDestroyElement:function(){if(this._hasMouseEventListeners){var e=this.getViewportGroups()
e.on("mouseover",null),e.on("mouseout",null)
var t=this.get("viewport").select(".totalgroup")
t.on("mouseover",null),t.on("mouseout",null)}this._super.apply(this,arguments)},isShowingTotal:!1,totalPointData:null,filteredData:Ember.computed("data.@each",function(){var e
return e=this.get("data"),Ember.isEmpty(e)?[]:e.filter(function(e){return null!=e.xValue&&null!=e.yValue&&isFinite(e.xValue)&&isFinite(e.yValue)})}),groupedData:Ember.computed("filteredData.@each",function(){var e=this,r=this.get("filteredData")
if(Ember.isEmpty(r))return[]
var n=(0,u.groupBy)(r,function(t){return t.group||e.get("ungroupedSeriesName")})
return this.set("groupNames",(0,t.keys)(n)),(0,t.values)(n)}),groupNames:[],numGroups:Ember.computed.alias("groupedData.length"),isGrouped:Ember.computed("numGroups",function(){return this.get("numGroups")>1}),finishedData:Ember.computed.alias("groupedData"),graphicTop:Ember.computed.alias("axisTitleHeight"),graphicLeft:Ember.computed.alias("labelWidthOffset"),graphicHeight:Ember.computed("height","legendHeight","legendChartPadding",function(){var e=this.get("legendHeight")+this.get("legendChartPadding")+(this.get("marginBottom")||0)
...
return r===n&&0===n?[-1,1]:r===n?[r*(1-this.get("graphPadding")),r*(1+this.get("graphPadding"))]:[r,n]}),yDomain:Ember.computed("filteredData.@each","isShowingTotal","totalPointData","graphPadding",function(){var e=this.get("isShowingTotal")?[this.get("totalPointData")]:[],t=d3.extent(e.concat(this.get("filteredData")),function(e){return e.yValue}),r=t[0],n=t[1]
return r===n&&0===n?[-1,1]:r===n?[r*(1-this.get("graphPadding")),r*(1+this.get("graphPadding"))]:[r,n]}),xScale:Ember.computed("xDomain","graphPadding","graphicLeft","graphicWidth","numXTicks",function(){var e=this.get("xDomain"),t=this.get("graphicLeft"),r=this.get("graphicWidth"),n=0
return this.get("hasXDomainPadding")&&(n=(e[1]-e[0])*this.get("graphPadding")),d3.scale.linear().domain([e[0]-n,e[1]+n]).range([t,t+r]).nice(this.get("numXTicks"))}),yScale:Ember.computed("yDomain","graphPadding","graphicTop","graphicHeight","numYTicks",function(){var e=this.get("yDomain"),t=this.get("graphicTop"),r=this.get("graphicHeight"),n=0
return this.get("hasYDomainPadding")&&(n=(e[1]-e[0])*this.get("graphPadding")),d3.scale.linear().domain([e[0]-n,e[1]+n]).range([t+r,t]).nice(this.get("numYTicks"))}),groupShapes:Ember.computed(function(){return["circle","square","triangle-up","cross","diamond"]}),numGroupShapes:Ember.computed.alias("groupShapes.length"),numGroupColors:2,maxNumGroups:Ember.computed("numGroupColors","numGroupShapes",function(){return this.get("numGroupColors")*this.get("numGroupShapes")}),displayGroups:Ember.computed("isGrouped","numGroups","numGroupShapes",function(){return this.get("isGrouped")&&this.get("numGroups")<=this.get("maxNumGroups")}),getGroupShape:Ember.computed(function(){var e=this
...
return this.get("isInteractive")?function(t,r,n){d3.select(n).classed("hovered",!0)
var i=e.get("formatXValue"),o=e.get("formatYValue"),a=$('<span class="name" />').text(e.get("xValueDisplayName")+": "),s=$('<span class="name" />').text(e.get("yValueDisplayName")+": "),u=$('<span class="value" />').text(i(t.xValue)),l=$('<span class="value" />').text(o(t.yValue)),c=$("<span />")
c.append($('<span class="tip-label" />').text(t.group)).append(a).append(u).append("<br />").append(s).append(l),e.showTooltip(c.html(),d3.event)}:Ember.K}),hideDetails:Ember.computed("isInteractive",function(){var e=this
return this.get("isInteractive")?function(t,r,n){return d3.select(n).classed("hovered",!1),e.hideTooltip()}:Ember.K}),groupAttrs:Ember.computed(function(){return{class:function(e,t){return"group group-"+t}}}),pointAttrs:Ember.computed("dotShapeArea","getGroupShape","xScale","yScale","displayGroups","getGroupColor",function(){var e=this
return{d:d3.svg.symbol().size(this.get("dotShapeArea")).type(this.get("getGroupShape")),fill:this.get("displayGroups")?this.get("getGroupColor"):"transparent",stroke:this.get("getGroupColor"),"stroke-width":1.5,transform:function(t){return"translate("+e.get("xScale")(t.xValue)+", "+e.get("yScale")(t.yValue)+")"}}}),getViewportGroups:function(){return this.get("viewport").selectAll(".group")},groups:Ember.computed(function(){return this.getViewportGroups().data(this.get("finishedData"))}).volatile(),selectOrCreateAxis:function(e){var t=this.get("viewport").select(e)
return t.empty()?this.get("viewport").insert("g",":first-child"):t},xAxis:Ember.computed(function(){return this.selectOrCreateAxis(".x.axis").attr("class","x axis")}).volatile(),yAxis:Ember.computed(function(){return this.selectOrCreateAxis(".y.axis").attr("class","y axis")}).volatile(),renderVars:["xScale","yScale","dotShapeArea","finishedData","xValueDisplayName","yValueDisplayName","hasAxisTitles","hasXAxisTitle","hasYAxisTitle","xTitleHorizontalOffset","yTitleVerticalOffset"],drawChart:function(){return this.updateTotalPointData(),this.updateData(),this.updateAxes(),this.updateGraphic(),this.updateAxisTitles(),this.get("hasLegend")?this.drawLegend():this.clearLegend()},totalPointShape:Ember.computed(function(){var e=this,t=this.get("dotShapeArea")
return function(r){return r.append("path").attr({class:"totaldot",d:d3.svg.symbol().size(t).type("circle"),fill:e.get("getGroupColor")}),r.append("path").attr({class:"totaloutline",d:d3.svg.symbol().size(3*t).type("circle"),fill:"transparent",stroke:e.get("getGroupColor"),"stroke-width":2})}}),updateTotalPointData:function(){var e=this.get("isShowingTotal")?[this.get("totalPointData")]:[],t=this.get("viewport").selectAll(".totalgroup").data(e)
return t.exit().remove(),t.enter().append("g").attr("class","totalgroup").call(this.get("totalPointShape"))},updateData:function(){var e,t
return(e=this.get("groups")).enter().append("g").attr("class","group").attr(this.get("groupAttrs")),e.exit().remove(),(t=e.selectAll(".dot").data(function(e){return e})).enter().append("path").attr("class","dot"),t.exit().remove()},updateAxes:function(){var e=d3.svg.axis().scale(this.get("xScale")).orient("top").ticks(this.get("numXTicks")).tickSize(this.get("graphicHeight")).tickFormat(this.get("formatXValue")),t=d3.svg.axis().scale(this.get("yScale")).orient("right").ticks(this.get("numYTicks")).tickSize(this.get("graphicWidth")).tickFormat(this.get("formatYValue")),r=this.get("graphicTop"),n=this.get("graphicHeight"),i=this.get("xAxis").attr("transform","translate(0,"+(r+n)+")").call(e)
i.selectAll("g").filter(function(e){return 0!==e}).classed("major",!1).classed("minor",!0)
var o=this.get("labelPadding")
i.selectAll("text").style("text-anchor","middle").attr({y:function(){return this.getBBox().height+o/2}})
var a=this.get("yAxis")
this.set("graphicLeft",this.maxLabelLength(a.selectAll("text"))+this.get("labelPadding"))
var s=this.get("graphicLeft")
a.attr("transform","translate("+s+",0)").call(t),a.selectAll("g").filter(function(e){return 0!==e}).classed("major",!1).classed("minor",!0),a.selectAll("text").style("text-anchor","end").attr({x:-this.get("labelPadding")})},updateGraphic:function(){var e=this,t=this.get("showDetails"),r=this.get("hideDetails")
...
e.default=l}),define("ember-charts/components/stacked-vertical-bar-chart",["exports","lodash-es","ember-charts/components/chart-component","ember-charts/mixins/legend","ember-charts/mixins/floating-tooltip","ember-charts/mixins/axes","ember-charts/mixins/formattable","ember-charts/mixins/no-margin-chart","ember-charts/mixins/axis-titles","ember-charts/utils/label-trimmer"],function(e,t,r,n,i,o,a,s,u,l){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var c=r.default.extend(n.default,i.default,o.default,a.default,s.default,u.default,{classNames:["chart-vertical-bar","chart-stacked-vertical-bar"],minSlicePercent:2,ungroupedSeriesName:"Other",maxNumberOfSlices:10,otherSliceLabel:"Other",strokeWidth:1,betweenBarPadding:Ember.computed("barNames.length",function(){return d3.scale.linear().domain([1,8]).range([.625,.125]).clamp(!0)(this.get("barNames.length"))}),maxLabelHeight:50,willDestroyElement:function(){if(this._hasMouseEventListeners){var e=this.getViewportBars()
e.on("mouseover",null),e.on("mouseout",null)
var t=e.selectAll("rect")
t.on("mouseover",null),t.on("mouseout",null)}this._super.apply(this,arguments)},dataGroupedBySlice:Ember.computed("data.[]",function(){return(0,t.groupBy)(this.get("data"),"sliceLabel")}),dataGroupedByBar:Ember.computed("ungroupedSeriesName","data.[]",function(){var e=this.get("ungroupedSeriesName")
return(0,t.groupBy)(this.get("data"),function(t){return t.barLabel||e})}),largestGrossBarValue:Ember.computed("dataGroupedByBar",function(){var e=(0,t.map)(this.get("dataGroupedByBar"),function(e){return e.reduce(function(e,t){return e+Math.abs(t.value)},0)})
return(0,t.max)(e)}),largestSliceData:Ember.computed("dataGroupedBySlice","largestGrossBarValue",function(){var e,r,n
return e=this.get("dataGroupedBySlice"),n=this.get("largestGrossBarValue"),(0,t.map)(e,function(e,i){return r=(0,t.maxBy)(e,function(e){return Math.abs(e.value)}),{sliceLabel:i,percentOfBar:Math.abs(r.value/n*100)}}).filter(function(e){return!(isNaN(e.percentOfBar)||0===e.percentOfBar)})}),nonOtherSliceTypes:Ember.computed("minSlicePercent","maxNumberOfSlices","largestSliceData.[]",function(){var e,r,n,i
return e=this.get("minSlicePercent"),n=this.get("largestSliceData"),i=(0,t.filter)(n,function(t){return t.percentOfBar>=e}),r=this.get("maxNumberOfSlices"),i=(0,t.takeRight)((0,t.sortBy)(i,"percentOfBar"),r-1),n.length-i.length<=1?(0,t.map)(n,"sliceLabel"):(0,t.map)(i,"sliceLabel")}),otherSliceTypes:Ember.computed("largestSliceData.[]","nonOtherSliceTypes.[]",function(){var e=(0,t.map)(this.get("largestSliceData"),"sliceLabel")
return(0,t.difference)(e,this.get("nonOtherSliceTypes"))}),sortedData:Ember.computed("dataGroupedByBar","otherSliceLabel","nonOtherSliceTypes.[]","sliceSortingFn",function(){var e,r,n,i=this
return e=this.get("dataGroupedByBar"),r=this.get("nonOtherSliceTypes"),n=this.get("otherSliceLabel"),(0,t.reduce)(e,function(e,t,o){var a,s
return a=[],s={barLabel:o,sliceLabel:n,value:0},t.forEach(function(e){-1!==r.indexOf(e.sliceLabel)?a.push(e):s.value+=e.value}),a.sort(i.get("sliceSortingFn")),0!==s.value&&a.push(s),e[o]=a,e},{})}),finishedData:Ember.computed("sortedData",function(){var e,r
return(0,t.map)(this.get("sortedData"),function(n,i){return e=0,r=0,{barLabel:i,slices:n,stackedSlices:(0,t.map)(n,function(t){var n,i
return t.value<0?(i=r,n=r+=t.value):(n=e,i=e+=t.value),{yMin:n,yMax:i,value:t.value,barLabel:t.barLabel,sliceLabel:t.sliceLabel,color:t.color}}),max:e,min:r}})}),sliceSortKey:"value",sliceOrderByValue:Ember.computed("netBarValues.[]","dataGroupedByBar","otherSliceLabel",function(){var e,r,n
return n=this.get("dataGroupedByBar"),e=(0,t.sortBy)(this.get("netBarValues"),"value").reverse(),r=[],e.forEach(function(e){(0,t.sortBy)(n[e.barLabel],function(e){return-Math.abs(e.value)}).forEach(function(e){-1===r.indexOf(e.sliceLabel)&&r.push(e.sliceLabel)})}),r.push(this.get("otherSliceLabel")),r}),valueSliceSortingFn:Ember.computed("sliceOrderByValue.[]",function(){var e=this,t=this.get("sliceOrderByValue")
...
return(0,t.map)(e,function(e,t){return{barLabel:t,value:e.reduce(function(e,t){return e+t.value},0)}})}),barNames:Ember.computed("netBarValues","barSortingFn","barSortAscending",function(){var e,r
return e=this.get("netBarValues").sort(this.get("barSortingFn")),r=(0,t.map)(e,"barLabel"),this.get("barSortAscending")||r.reverse(),r}),defaultCompareFn:function(e,t){return e<t?-1:e>t?1:0},labelHeightOffset:Ember.computed("_shouldRotateLabels","maxLabelHeight","labelHeight","labelPadding",function(){return(this.get("_shouldRotateLabels")?this.get("maxLabelHeight"):this.get("labelHeight"))+this.get("labelPadding")}),graphicLeft:Ember.computed.alias("labelWidthOffset"),graphicWidth:Ember.computed("width","labelWidthOffset",function(){return this.get("width")-this.get("labelWidthOffset")}),graphicHeight:Ember.computed("height","legendHeight","legendChartPadding",function(){return this.get("height")-this.get("legendHeight")-this.get("legendChartPadding")}),yDomain:Ember.computed("finishedData",function(){var e=this.get("finishedData"),t=d3.max(e,function(e){return e.max}),r=d3.min(e,function(e){return e.min})
return r>0?[0,t]:t<0?[r,0]:0===r&&0===t?[0,1]:[r,t]}),yScale:Ember.computed("graphicTop","graphicHeight","yDomain","numYTicks",function(){return d3.scale.linear().domain(this.get("yDomain")).range([this.get("graphicTop")+this.get("graphicHeight"),this.get("graphicTop")]).nice(this.get("numYTicks"))}),allSliceLabels:Ember.computed("nonOtherSliceTypes.[]","otherSliceTypes.[]","otherSliceLabel",function(){var e=(0,t.clone)(this.get("nonOtherSliceTypes"))
...
return(0,t.zipObject)(e,(0,t.range)(e.length))}),barWidth:Ember.computed("xBetweenBarScale",function(){return this.get("xBetweenBarScale").rangeBand()}),xBetweenBarScale:Ember.computed("graphicWidth","barNames","betweenBarPadding",function(){var e=this.get("betweenBarPadding")
...
return this.get("isInteractive")?function(t,r,n){var i=Ember.isArray(t.slices)
n=i?n.parentNode.parentNode:n,d3.select(n).classed("hovered",!0)
var o=$("<span />")
t.barLabel&&o.append($('<span class="tip-label" />').text(t.barLabel))
var a=e.get("formatLabelFunction"),s=function(e){var t=$('<span class="name" />').text(e.sliceLabel+": ")
o.append(t)
var r=$('<span class="value" />').text(a(e.value))
o.append(r),o.append("<br />")}
return i?t.slices.forEach(s):s(t),e.showTooltip(o.html(),d3.event)}:Ember.K}),hideDetails:Ember.computed("isInteractive",function(){var e=this
return this.get("isInteractive")?function(t,r,n){return Ember.isArray(t.slices)&&(n=n.parentNode.parentNode),d3.select(n).classed("hovered",!1),e.hideTooltip()}:Ember.K}),barAttrs:Ember.computed("graphicLeft","graphicTop","xBetweenBarScale",function(){var e=this,t=this.get("xBetweenBarScale")
...
return e=l.default.create({getLabelSize:function(){return t.get("rotatedLabelLength")},getLabelText:function(e){return e.barLabel}}),r.call(e.get("trim")).attr({"text-anchor":"end",transform:"rotate("+-n+")",dy:function(){return this.getBBox().height}})}var i=this.get("maxLabelWidth")
return e=l.default.create({getLabelSize:function(){return i},getLabelText:function(e){return null!=e.barLabel?e.barLabel:""}}),r.call(e.get("trim")).attr({"text-anchor":"middle",dy:this.get("labelPadding")})},updateAxes:function(){var e=d3.svg.axis().scale(this.get("yScale")).orient("right").ticks(this.get("numYTicks")).tickSize(this.get("graphicWidth")).tickFormat(this.get("formatValueAxis")),t=this.get("yAxis")
this.set("graphicLeft",this.maxLabelLength(t.selectAll("text"))+this.get("labelPadding"))
var r=this.get("graphicTop"),n=this.get("graphicLeft")
t.attr({transform:"translate("+n+", "+r+")"}).call(e),t.selectAll("g").filter(function(e){return 0!==e}).classed("major",!1).classed("minor",!0),t.selectAll("text").style("text-anchor","end").attr({x:-this.get("labelPadding")})},updateGraphic:function(){var e=this.get("bars"),t=this.get("sliceAttrs")
...
e.default=c}),define("ember-charts/components/time-series-chart",["exports","lodash-es","ember-charts/components/chart-component","ember-charts/mixins/legend","ember-charts/mixins/time-series-labeler","ember-charts/mixins/floating-tooltip","ember-charts/mixins/has-time-series-rule","ember-charts/mixins/axes","ember-charts/mixins/formattable","ember-charts/mixins/no-margin-chart","ember-charts/mixins/axis-titles","ember-charts/utils/group-by"],function(e,t,r,n,i,o,a,s,u,l,c,f){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var h=r.default.extend(n.default,i.default,o.default,a.default,s.default,u.default,l.default,c.default,{classNames:["chart-time-series"],lineData:null,barData:null,formatTime:d3.time.format("%Y-%m-%d"),formatTimeLong:d3.time.format("%a %b %-d, %Y"),ungroupedSeriesName:"Other",interpolate:!1,yAxisFromZero:!1,barPadding:0,barGroupPadding:.25,barLeftOffset:0,xAxisVertLabels:!1,willDestroyElement:function(){this._removeMouseEventListeners(),this._super.apply(this,arguments)},DEFAULT_MAX_NUMBER_OF_LABELS:10,finishedData:Ember.computed("_groupedLineData.@each.values","_groupedBarData.@each",function(){return{lineData:this.get("_groupedLineData"),groupedBarData:this.get("_groupedBarData")}}),hasNoData:Ember.computed("_hasBarData","_hasLineData",function(){return!this.get("_hasBarData")&&!this.get("_hasLineData")}),_getLabelOrDefault:function(e){return e.label&&e.label.toString()||this.get("ungroupedSeriesName")},_groupedLineData:Ember.computed("lineData.@each","ungroupedSeriesName",function(){var e=this,r=this.get("lineData")
if(Ember.isEmpty(r))return[]
var n=(0,f.groupBy)(r,function(t){return e._getLabelOrDefault(t)})
return(0,t.map)(n,function(e,t){return{group:t,values:e}})}),_groupedBarData:Ember.computed("barData.@each","ungroupedSeriesName","barLeftOffset",function(){var e=this,r=this.get("barData")
if(Ember.isEmpty(r))return[]
var n=(0,f.groupBy)(r,function(e){return e.time.getTime()})
return(0,t.map)(n,function(r){return(0,t.map)(r,function(t){var r=e._getLabelOrDefault(t),n=t.time
...
return r>351?"year":r>33?"quarter":r>9?"month":r>3?"week":"day"}),barDataExtent:Ember.computed("timeDelta","_groupedBarData.@each",function(){var e=this.get("timeDelta"),r=this.get("_groupedBarData")
if(Ember.isEmpty(r))return[new Date,new Date]
var n=(0,t.head)(r),i=(0,t.last)(r),o=new Date(n[0].time),a=new Date(i[0].time),s=this._padTimeBackward(o,e),u=this._padTimeForward(a,e)
return[new Date(s),new Date(u)]}),xBetweenGroupDomain:Ember.computed.alias("barDataExtent"),xWithinGroupDomain:Ember.computed.alias("_barGroups"),barWidth:Ember.computed("xGroupScale",function(){return this.get("xGroupScale").rangeBand()}),paddedGroupWidth:Ember.computed("timeDelta","xTimeScale","xBetweenGroupDomain",function(){var e=this.get("timeDelta"),t=this.get("xTimeScale"),r=this.get("xBetweenGroupDomain")[0]
return t("quarter"===e?d3.time.month.offset(r,3):d3.time[e].offset(r,1))-t(r)}),lineSeriesNames:Ember.computed("_groupedLineData",function(){var e=this.get("_groupedLineData")
...
var r=(0,t.map)(e,"values").map(function(e){return d3.extent(e.map(function(e){return e.time}))})
return[d3.min(r,function(e){return e[0]}),d3.max(r,function(e){return e[1]})]}),xBetweenSeriesDomain:Ember.computed.alias("lineSeriesNames"),xWithinSeriesDomain:Ember.computed.alias("lineDataExtent"),maxNumberOfLabels:Ember.computed("numXTicks","dynamicXAxis","maxNumberOfRotatedLabels","xAxisVertLabels",function(e,t){var r=this.get("numXTicks")
...
return[Math.min(e,r),Math.max(t,n)]}),yDomain:Ember.computed("_groupedLineData","_groupedBarData","_hasBarData","_hasLineData","yAxisFromZero",function(){var e,t,r=this.get("_groupedLineData"),n=this.get("_groupedBarData"),i=d3.max(r,function(e){return d3.max(e.values,function(e){return e.value})}),o=d3.min(r,function(e){return d3.min(e.values,function(e){return e.value})}),a=d3.max(n,function(e){return d3.max(e,function(e){return e.value})}),s=d3.min(n,function(e){return d3.min(e,function(e){return e.value})}),u=this.get("_hasBarData"),l=this.get("_hasLineData")
if(u?l?(e=Math.min(s,o),t=Math.max(a,i)):(e=s,t=a):(e=o,t=i),this.get("yAxisFromZero")||e===t){if(t<0)return[e,0]
if(e>0)return[0,t]
if(e===t&&0===t)return[-1,1]}return[e,t]}),yRange:Ember.computed("graphicTop","graphicHeight",function(){return[this.get("graphicTop")+this.get("graphicHeight"),this.get("graphicTop")]}),yScale:Ember.computed("yDomain","yRange","numYTicks",function(){return d3.scale.linear().domain(this.get("yDomain")).range(this.get("yRange")).nice(this.get("numYTicks"))}),xRange:Ember.computed("graphicLeft","graphicWidth",function(){return[this.get("graphicLeft"),this.get("graphicLeft")+this.get("graphicWidth")]}),xTimeScale:Ember.computed("xDomain","xRange",function(){return d3.time.scale().domain(this.get("xDomain")).range(this.get("xRange"))}),xGroupScale:Ember.computed("xWithinGroupDomain","paddedGroupWidth","barPadding","barGroupPadding",function(){return d3.scale.ordinal().domain(this.get("xWithinGroupDomain")).rangeRoundBands([0,this.get("paddedGroupWidth")],this.get("barPadding")/2,this.get("barGroupPadding")/2)}),minAxisValue:Ember.computed("yScale",function(){return this.get("yScale").domain()[0]}),maxAxisValue:Ember.computed("yScale",function(){return this.get("yScale").domain()[1]}),showDetails:Ember.computed("isInteractive",function(){var e=this
return this.get("isInteractive")?function(t,r,n){d3.select(n).classed("hovered",!0)
var i=null!=t.labelTime?t.labelTime:t.time
i=e.adjustTimeForShowDetails(i)
var o=$("<span>")
o.append($('<span class="tip-label">').text(e.get("formatTime")(i))),e.showTooltip(o.html(),d3.event)
var a=e.get("formatLabelFunction"),s=function(e){var t=$('<span class="name" />').text(e.group+": "),r=$('<span class="value" />').text(a(e.value))
o.append(t),o.append(r),o.append("<br />")}
return Ember.isArray(t.values)?t.values.forEach(s):s(t),e.showTooltip(o.html(),d3.event)}:Ember.K}),hideDetails:Ember.computed("isInteractive",function(){var e=this
return this.get("isInteractive")?function(t,r,n){return d3.select(n).classed("hovered",!1),e.hideTooltip()}:Ember.K}),adjustTimeForShowDetails:function(e){return e},zeroDisplacement:1,groupAttrs:Ember.computed("paddedGroupWidth",function(){var e=this
...
return d3.svg.line().x(function(t){return e.get("xTimeScale")(t.time)}).y(function(t){return e.get("yScale")(t.value)}).interpolate(this.get("interpolate")?"basis":"linear")}),lineColorFn:Ember.computed(function(){var e=this
...
e.default=h}),define("ember-charts/components/vertical-bar-chart",["exports","lodash-es","ember-charts/components/chart-component","ember-charts/mixins/legend","ember-charts/mixins/floating-tooltip","ember-charts/mixins/axes","ember-charts/mixins/formattable","ember-charts/mixins/sortable-chart","ember-charts/mixins/no-margin-chart","ember-charts/mixins/axis-titles","ember-charts/utils/group-by","ember-charts/utils/label-trimmer"],function(e,t,r,n,i,o,a,s,u,l,c,f){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var h=r.default.extend(n.default,i.default,o.default,a.default,s.default,u.default,l.default,{classNames:["chart-vertical-bar"],ungroupedSeriesName:"Other",stackBars:!1,withinGroupPadding:0,betweenGroupPadding:Ember.computed("numBars",function(){return d3.scale.linear().domain([1,8]).range([1.25,.25]).clamp(!0)(this.get("numBars"))}),numBars:Ember.computed("xBetweenGroupDomain","xWithinGroupDomain",function(){return this.get("xBetweenGroupDomain.length")*this.get("xWithinGroupDomain.length")||0}),maxLabelHeight:50,willDestroyElement:function(){if(this._hasMouseEventListeners){var e=this.getViewportBars()
e.on("mouseover",null),e.on("mouseout",null)
var t=e.selectAll("rect")
t.on("mouseover",null),t.on("mouseout",null)}this._super.apply(this,arguments)},sortedData:Ember.computed("data.[]","sortKey","sortAscending","stackBars",function(){var e,r,n,i,o,a,s,u,l,c,f,h
if(this.get("stackBars")){e=this.get("data"),o=(0,t.groupBy)(e,function(e){return e.group}),c=Ember.A()
var d=function(e,t){return e+t.value}
for(r in o)n=o[r],null!==r&&c.pushObject({group:r,value:n.reduce(d,0)})
...
return s}return e}return this._super()}),groupedData:Ember.computed("sortedData","stackBars","ungroupedSeriesName",function(){var e=this,r=this.get("sortedData")
return Ember.isEmpty(r)?[]:(r=(0,c.groupBy)(r,function(t){return t.group||e.get("ungroupedSeriesName")}),(0,t.each)((0,t.keys)(r),function(e){r[e]=(0,t.sortBy)(r[e],"label")}),r)}),groupNames:Ember.computed("groupedData",function(){return(0,t.keys)(this.get("groupedData"))}),isGrouped:Ember.computed("groupNames.length",function(){return this.get("groupNames.length")>1}),finishedData:Ember.computed("groupedData","isGrouped","stackBars","sortedData",function(){var e,r
return this.get("isGrouped")?Ember.isEmpty(this.get("groupedData"))?Ember.A():(0,t.map)(this.get("groupedData"),function(n,i){return e=0,{group:i,values:n,stackedValues:r=(0,t.map)(n,function(t){return{y0:e,y1:e+=Math.max(t.value,0),value:t.value,group:t.group,label:t.label,color:t.color}}),totalValue:e}}):this.get("stackBars")?Ember.isEmpty(this.get("data"))?Ember.A():(e=0,r=(0,t.map)(this.get("data"),function(t){return{y0:e,y1:e+=Math.max(t.value,0),value:t.value,group:t.group,label:t.label,color:t.color}}),Ember.A([{group:this.get("data.firstObject.group"),values:this.get("data"),stackedValues:r,totalValue:e}])):Ember.isEmpty(this.get("data"))?Ember.A():(0,t.map)(this.get("sortedData"),function(e){return{group:e.label,values:[e]}})}),labelHeightOffset:Ember.computed("_shouldRotateLabels","maxLabelHeight","labelHeight","labelPadding",function(){return(this.get("_shouldRotateLabels")?this.get("maxLabelHeight"):this.get("labelHeight"))+this.get("labelPadding")}),graphicLeft:Ember.computed.alias("labelWidthOffset"),graphicWidth:Ember.computed("width","labelWidthOffset",function(){return this.get("width")-this.get("labelWidthOffset")}),graphicHeight:Ember.computed("height","legendHeight","legendChartPadding",function(){return this.get("height")-this.get("legendHeight")-this.get("legendChartPadding")}),yDomain:Ember.computed("finishedData","stackBars",function(){var e,r,n=this.get("finishedData"),i=d3.min(n,function(e){return(0,t.min)(e.values.map(function(e){return e.value}))}),o=d3.max(n,function(e){return(0,t.max)(e.values.map(function(e){return e.value}))}),a=d3.max(n,function(e){return e.totalValue}),s=d3.min(n,function(){return 0})
return this.get("stackBars")?(e=s,r=a):(e=i,r=o),e>0?[0,r]:r<0?[e,0]:0===e&&0===r?[0,1]:[e,r]}),yScale:Ember.computed("graphicTop","graphicHeight","yDomain","numYTicks",function(){return d3.scale.linear().domain(this.get("yDomain")).range([this.get("graphicTop")+this.get("graphicHeight"),this.get("graphicTop")]).nice(this.get("numYTicks"))}),groupedIndividualBarLabels:Ember.computed("groupedData.[]",function(){var e=(0,t.map)((0,t.values)(this.get("groupedData")),function(e){return(0,t.map)(e,"label")})
return(0,t.uniq)((0,t.flatten)(e))}),ungroupedIndividualBarLabels:Ember.computed("sortedData.@each.label",function(){return(0,t.map)(this.get("sortedData"),"label")}),individualBarLabels:Ember.computed("isGrouped","stackBars","groupedIndividualBarLabels","ungroupedIndividualBarLabels",function(){return this.get("isGrouped")||this.get("stackBars")?this.get("groupedIndividualBarLabels"):this.get("ungroupedIndividualBarLabels")}),labelIDMapping:Ember.computed("individualBarLabels.[]",function(){return this.get("individualBarLabels").reduce(function(e,t,r){return e[t]=r,e},{})}),xBetweenGroupDomain:Ember.computed.alias("groupNames"),xWithinGroupDomain:Ember.computed.alias("individualBarLabels"),groupWidth:Ember.computed("xBetweenGroupScale",function(){return this.get("xBetweenGroupScale").rangeBand()}),barWidth:Ember.computed("xWithinGroupScale",function(){return this.get("xWithinGroupScale").rangeBand()}),xWithinGroupScale:Ember.computed("isGrouped","stackBars","xWithinGroupDomain","groupWidth","withinGroupPadding","betweenGroupPadding",function(){return this.get("isGrouped")||this.get("stackBars")?d3.scale.ordinal().domain(this.get("xWithinGroupDomain")).rangeRoundBands([0,this.get("groupWidth")],this.get("withinGroupPadding")/2,0):d3.scale.ordinal().domain(this.get("xWithinGroupDomain")).rangeRoundBands([0,this.get("groupWidth")],this.get("betweenGroupPadding")/2,this.get("betweenGroupPadding")/2)}),xBetweenGroupScale:Ember.computed("isGrouped","stackBars","graphicWidth","labelWidth","xBetweenGroupDomain","betweenGroupPadding",function(){var e
return e=this.get("isGrouped")||this.get("stackBars")?this.get("betweenGroupPadding"):0,d3.scale.ordinal().domain(this.get("xBetweenGroupDomain")).rangeRoundBands([0,this.get("graphicWidth")],e/2,e/2)}),minAxisValue:Ember.computed("yScale",function(){return this.get("yScale").domain()[0]}),maxAxisValue:Ember.computed("yScale",function(){return this.get("yScale").domain()[1]}),numColorSeries:Ember.computed.alias("individualBarLabels.length"),barColors:Ember.computed("individualBarLabels.[]","getSeriesColor",function(){var e=this.get("getSeriesColor"),t={}
...
return this.get("isInteractive")?function(t,r,n){var i=Ember.isArray(t.values)
n=i?n.parentNode.parentNode:n,d3.select(n).classed("hovered",!0)
var o=t.group?$('<span class="tip-label" />').text(t.group):"",a=$("<span />").append(o),s=e.get("formatLabelFunction"),u=function(e){var t=$('<span class="name" />').text(e.label+": ")
a.append(t)
var r=$('<span class="value">').text(s(e.value))
a.append(r),a.append("<br />")}
return i?t.values.forEach(u):u(t),e.showTooltip(a.html(),d3.event)}:Ember.K}),hideDetails:Ember.computed("isInteractive",function(){var e=this
return this.get("isInteractive")?function(t,r,n){return Ember.isArray(t.values)&&(n=n.parentNode.parentNode),d3.select(n).classed("hovered",!1),e.hideTooltip()}:Ember.K}),groupAttrs:Ember.computed("graphicLeft","graphicTop","xBetweenGroupScale",function(){var e=this,t=this.get("xBetweenGroupScale")
...
return{class:function(t){return"grouping-"+e.get("labelIDMapping")[t.label]}}}),stackedBarAttrs:Ember.computed("commonBarAttrs","yScale","groupWidth",function(){var e=this,r=this.get("yScale")
return(0,t.assign)({"stroke-width":0,width:function(){return e.get("groupWidth")},x:null,y:function(e){return r(e.y1)+1},height:function(e){return r(e.y0)-r(e.y1)}},this.get("commonBarAttrs"))}),groupedBarAttrs:Ember.computed("commonBarAttrs","yScale","barWidth","xWithinGroupScale",function(){var e=this,r=this.get("yScale")
return(0,t.assign)({"stroke-width":0,width:function(){return e.get("barWidth")},x:function(t){return e.get("xWithinGroupScale")(t.label)},height:function(e){return Math.max(0,Math.abs(r(e.value)-r(0))-1)},y:function(e){return e.value>0?r(e.value):r(0)+1}},this.get("commonBarAttrs"))}),labelAttrs:Ember.computed("barWidth","isGrouped","stackBars","groupWidth","xWithinGroupScale","graphicTop","graphicHeight","labelPadding",function(){var e=this
...
if(this.setRotateLabels(),this.get("_shouldRotateLabels")){var n=this.get("rotateLabelDegrees")
return e=f.default.create({getLabelSize:function(){return t.get("rotatedLabelLength")},getLabelText:function(e){return e.group}}),r.call(e.get("trim")).attr({"text-anchor":"end",transform:"rotate("+-n+")",dy:function(){return this.getBBox().height}})}var i=this.get("maxLabelWidth")
return e=f.default.create({getLabelSize:function(){return i},getLabelText:function(e){return null!=e.group?e.group:""}}),r.call(e.get("trim")).attr({"text-anchor":"middle",dy:this.get("labelPadding")})},updateAxes:function(){var e=d3.svg.axis().scale(this.get("yScale")).orient("right").ticks(this.get("numYTicks")).tickSize(this.get("graphicWidth")).tickFormat(this.get("formatValueAxis")),t=this.get("yAxis")
this.set("graphicLeft",this.maxLabelLength(t.selectAll("text"))+this.get("labelPadding"))
var r=this.get("graphicTop"),n=this.get("graphicLeft")
t.attr({transform:"translate("+n+", "+r+")"}).call(e),t.selectAll("g").filter(function(e){return 0!==e}).classed("major",!1).classed("minor",!0),t.selectAll("text").style("text-anchor","end").attr({x:-this.get("labelPadding")})},updateGraphic:function(){var e=this.get("groups"),t=this.get("stackBars")?this.get("stackedBarAttrs"):this.get("groupedBarAttrs")
...
e.default=h}),define("ember-charts/mixins/axes",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.Mixin.create({graphicWidth:null,graphicHeight:null,minXTicks:3,minYTicks:3,minAxisValue:0,maxAxisValue:0,tickSpacing:50,tickSpacingX:null,tickSpacingY:null,_innerTickSpacingX:Ember.computed("tickSpacingX","tickSpacing",function(){var e=this.get("tickSpacingX")
...
e.default=t}),define("ember-charts/mixins/colorable",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.Mixin.create({selectedSeedColor:"rgb(65, 65, 65)",tint:.8,minimumTint:0,maximumTint:.66,colorScaleType:d3.scale.linear,renderVars:["colorScale"],colorRange:Ember.computed("selectedSeedColor","getColorRange",function(){var e=this.get("selectedSeedColor")
return this.get("getColorRange")(e)}),getColorRange:Ember.computed("minimumTint","maximumTint",function(){var e=this
return function(t){var r,n,i
return i=(r=d3.interpolateRgb(t,"rgb(255,255,255)"))(e.get("minimumTint")),n=r(e.get("maximumTint")),[d3.rgb(i),d3.rgb(n)]}}),colorScale:Ember.computed("selectedSeedColor","getColorScale",function(){var e=this.get("selectedSeedColor")
...
return e.get("colorScaleType")().range(r)}}),secondaryMinimumTint:.4,secondaryMaximumTint:.85,secondaryColorScaleType:d3.scale.linear,secondaryColorRange:Ember.computed("selectedSeedColor","secondaryMinimumTint","secondaryMaximumTint",function(){var e=this.get("selectedSeedColor"),t=d3.interpolateRgb(e,"rgb(255,255,255)"),r=t(this.get("secondaryMinimumTint")),n=t(this.get("secondaryMaximumTint"))
return[d3.rgb(r),d3.rgb(n)]}),secondaryColorScale:Ember.computed("secondaryColorScaleType","secondaryColorRange",function(){return this.get("secondaryColorScaleType")().range(this.get("secondaryColorRange"))}),leastTintedColor:Ember.computed("colorRange.[]",function(){return this.get("colorRange")[0]}),mostTintedColor:Ember.computed("colorRange.[]",function(){return this.get("colorRange")[1]}),numColorSeries:1,getSeriesColor:Ember.computed("numColorSeries","getColorRange","getColorScale","selectedSeedColor",function(){var e=this.get("numColorSeries"),t=this.get("selectedSeedColor"),r=this
...
e.default=t}),define("ember-charts/mixins/floating-tooltip",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
e.default=t}),define("ember-charts/mixins/formattable",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.Mixin.create({formatLabelFunction:Ember.computed("formatLabel",function(){return d3.format(","+this.get("formatLabel"))}),formatLabel:".2f"})
e.default=t}),define("ember-charts/mixins/has-time-series-rule",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.Mixin.create({xRange:null,yRange:null,xTimeScale:null,showDetails:null,hideDetails:null,lineColorFn:null,graphicHeight:null,willDestroyElement:function(){if(this._hasMouseEventListeners){var e=this._getLineMarkers()
e.on("mouseover",null),e.on("mouseout",null)}this._super.apply(this,arguments)},updateLineMarkers:function(){var e=this._getLineMarkers(),t=this.get("showDetails"),r=this.get("hideDetails")
this._hasMouseEventListeners=!0,e.enter().append("path").on("mouseover",function(e,r){return t(e,r,this)}).on("mouseout",function(e,t){return r(e,t,this)}).attr({class:"line-marker",fill:this.get("lineColorFn"),d:d3.svg.symbol().size(50).type("circle")}),e.exit().remove(),e.attr({transform:function(e){return"translate("+e.x+","+e.y+")"}}),e.style({"stroke-width":function(e){return d3.select(e.path).attr("stroke-width")}})},_getLineMarkers:function(){return this.get("viewport").selectAll(".line-marker").data(this._lineMarkerData())},didInsertElement:function(){var e=this
this._super(),d3.select(this.$("svg")[0]).on("mousemove",function(){e.get("isInteractive")&&e._isEventWithinValidRange()&&Ember.run(e,e.get("updateLineMarkers"))})},_lineMarkerTolerance:6e4,_mousePosition:function(){return d3.event?d3.mouse(this.get("$viewport")):null},_isEventWithinValidRange:function(){var e=this.get("xRange"),t=this.get("yRange"),r=this._mousePosition()[0],n=this._mousePosition()[1],i=d3.min(e)<r<d3.max(e),o=d3.min(t)<n<d3.max(t)
return i&&o},_lineMarkerData:function(){var e=this._mousePosition()
...
e.default=t}),define("ember-charts/mixins/label-width",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
e.default=t}),define("ember-charts/mixins/legend",["exports","lodash-es","ember-charts/utils/label-trimmer"],function(e,t,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var n=function(e,r){var n=r/e.length
e=(0,t.sortBy)(e)
for(var i=0;i<e.length;i++){var o=e[i]
if(o<n)n=(r-=o)/(e.length-(i+1))}return n},i=function(e,t,n,i){var o=r.default.create({getLabelSize:function(){return i}})
e.filter(function(e,r){return r>=t&&r<n}).call(o.get("trim"))},o=function(e,t,r,n){var i=0
return e.filter(function(e,n){return n>=t&&n<r}).each(function(e,t){0===t?i=0:i+=2*n,i+=this.getBBox().width}),i},a=Ember.Mixin.create({legendTopPadding:10,legendItemHeight:18,minLegendItemWidth:120,maxLegendItemWidth:160,legendIconRadius:9,legendLabelPadding:10,showLegend:!0,willDestroyElement:function(){if(this._hasMouseEventListeners){var e=this.get("legend").selectAll(".legend-item")
...
return{d:function(t,r){return"line"===t.icon(t)?"M "+-e+" 0 L "+e+" 0":d3.svg.symbol().type(t.icon(t,r)).size(Math.pow(e,2))(t,r)},fill:function(e,r){return(0,t.isFunction)(e.fill)?e.fill(e,r):e.fill},stroke:function(e,r){return(0,t.isFunction)(e.stroke)?e.stroke(e,r):e.stroke},"stroke-width":function(e){return e.width?(0,t.isFunction)(e.width)?e.width(e):e.width:1.5},"stroke-dasharray":function(e){if(e.dotted)return"2,2"}}}),legendLabelAttrs:Ember.computed("legendIconRadius","legendLabelPadding",function(){return{x:this.get("legendIconRadius")/2+this.get("legendLabelPadding"),y:".35em"}}),showLegendDetails:Ember.computed("isInteractive",function(){if(!this.get("isInteractive"))return Ember.K
var e=this
return function(t,r,n){d3.select(n).classed("hovered",!0),t.selector&&e.get("viewport").selectAll(t.selector).classed("hovered",!0)
var i=$("<span />")
if(i.append($('<span class="tip-label">').text(t.label)),!Ember.isNone(t.xValue)){var o=e.get("formatXValue")
i.append($('<span class="name" />').text(e.get("tooltipXValueDisplayName")+": ")),i.append($('<span class="value" />').text(o(t.xValue))),Ember.isNone(t.yValue)||i.append("<br />")}if(!Ember.isNone(t.yValue)){var a=e.get("formatYValue")
i.append($('<span class="name" />').text(e.get("tooltipYValueDisplayName")+": ")),i.append($('<span class="value" />').text(a(t.yValue)))}e.showTooltip(i.html(),d3.event)}}),hideLegendDetails:Ember.computed("isInteractive",function(){if(!this.get("isInteractive"))return Ember.K
var e=this
return function(t,r,n){return d3.select(n).classed("hovered",!1),t.selector&&e.get("viewport").selectAll(t.selector).classed("hovered",!1),e.hideTooltip()}}),clearLegend:function(){return this.get("viewport").select(".legend-container").remove()},legend:Ember.computed(function(){var e=this.get("viewport").select(".legend-container")
...
var t=this.get("showLegendDetails"),r=this.get("hideLegendDetails")
this._hasMouseEventListeners=!0
var a=e.selectAll(".legend-item").data(this.get("legendItems")).enter().append("g").on("mouseover",function(e,r){return t(e,r,this)}).on("mouseout",function(e,t){return r(e,t,this)}),s=this.get("legendIconAttrs"),u=this.get("isShowingTotal"),l=this.get("totalPointShape")
a.each(function(e,t){var r=d3.select(this)
return 0===t&&u?r.append("g").attr("class","icon").call(l):r.append("path").attr("class","icon").attr(s)})
var c=[],f=a.append("text").style("text-anchor","start").text(function(e){return e.label}).attr(this.get("legendLabelAttrs")).each(function(){c.push(this.getComputedTextLength())}),h=this.get("minLegendItemWidth"),d=this.get("maxLegendItemWidth"),p=this.get("legendLabelPadding"),m=[0],g=0,v=this.get("legendWidth"),b=v
a.each(function(){var e=Math.min(this.getBBox().width,d)
m[g]>0&&(b-=2*p),b>=h||b>=e?m[g]++:(m[++g]=1,b=v),b-=Math.min(b,e)}),this.set("numLegendItemsByRows",m)
var y=0,_=[],w=this.get("legendIconRadius"),x=w/2+p,E=2*p
for(g=0;g<m.length;g++){var k=m[g],S=v-k*(w+x)-(k-1)*E,A=c.splice(0,k),C=n(A,S)
i(f,y,y+k,C),_[g]=o(a,y,y+k,p),y+=m[g]}return this.set("legendRowWidths",_),a.attr(this.get("legendItemAttrs")),this}}})
e.default=a}),define("ember-charts/mixins/no-margin-chart",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
e.default=r}),define("ember-charts/mixins/time-series-labeler",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t={S:"seconds",H:"hours",D:"days",W:"weeks",M:"months",Q:"months",Y:"years"},r={S:"seconds",H:"hours",D:"days",W:"weeks",M:"months",Q:"quarters",Y:"years"},n={seconds:"S",hours:"H",days:"D",weeks:"W",months:"M",quarters:"Q",years:"Y"},i=Ember.Mixin.create({centerAxisLabels:!1,selectedInterval:"M",computedBarInterval:null,dynamicXAxis:!1,SPECIFICITY_RATIO:.7,minTimeSpecificity:"S",maxTimeSpecificity:"Y",MONTHS_IN_QUARTER:3,xAxisTimeInterval:Ember.computed("selectedInterval","dynamicXAxis",function(e,t){var r
return(r=this.get("dynamicXAxis")?t||"M":this.get("selectedInterval")).length>1?n[r]:r}),maxNumberOfLabels:10,DOMAIN_ORDERING:["S","H","D","W","M","Q","Y"],maxNumberOfMinorTicks:0,minorTickInterval:1,filterMinorTicks:function(){var e,t,r,n=this.get("xAxis"),i=this.get("minorTickInterval")
...
return this.get("maxTimeSpecificity")}),times:Ember.computed("xDomain",function(){var e,t,n,i,o,a,s
for(e={},n=(t=this.get("xDomain"))[0],i=t[1],s=0,a=(o=this.get("DOMAIN_ORDERING")).length;s<a;s++)e[o[s]]=this.numTimeBetween(r[o[s]],n,i)
return e}),_advanceMiddle:function(e,t,r){return new Date(e=e.getTime()/2+d3.time[t].offset(e,r)/2)},numTimeBetween:function(e,t,r){switch(e){case"seconds":return(r-t)/1e3
case"hours":return(r-t)/36e5
case"days":return(r-t)/864e5
case"weeks":return d3.time.weeks(t,r).length
case"months":return d3.time.months(t,r).length
case"quarters":return d3.time.months(t,r).length/this.MONTHS_IN_QUARTER
case"years":return d3.time.years(t,r).length}},domainTypeToLongDomainTypeSingular:function(e){var t=r[e]
return t.substring(0,t.length-1)},dynamicXLabelling:function(e,r){var n,i
return n=this.get("intervalSpecificity"),this.set("xAxisTimeInterval",n),i=d3.time[t[n]](e,r),"Q"===n&&(i=this.filterLabelsForQuarters(i)),this.filterLabels(i,n)},filterLabels:function(e,t){var r,n,i,o
...
return this.get("dynamicXAxis")?function(t,r){return e.dynamicXLabelling(t,r)}:function(r,n){var i,o
return i=e.get("xAxisTimeInterval"),e.set("maxTimeSpecificity",i),o=d3.time[t[i]](r,n),"Q"===i&&(o=e.filterLabelsForQuarters(o)),e.filterLabels(o,i)}}),quarterFormat:function(e){var t
return"",((t=e.getMonth()%12)<3?"Q1":t<6?"Q2":t<9?"Q3":"Q4")+" "+d3.time.format("%Y")(e)},formattedTime:Ember.computed("xAxisTimeInterval",function(){switch(this.get("xAxisTimeInterval")){case"years":case"Y":return d3.time.format("%Y")
case"quarters":case"Q":return this.quarterFormat
case"months":case"M":return d3.time.format("%b '%y")
case"weeks":case"W":return d3.time.format("%-m/%-d/%y")
case"days":case"D":return d3.time.format("%-m/%-d/%y")
case"hours":case"H":return d3.time.format("%H:%M:%S")
case"seconds":case"S":return d3.time.format("%H:%M:%S")
default:return d3.time.format("%Y")}})})
e.default=i})
define("ember-charts/utils/group-by",["exports"],function(e){"use strict"
...
return i}}),define("ember-charts/utils/label-trimmer",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
var r=t.debugInfo()
e.waiters[t.name]=r||!0}}),e}}),(window.webpackJsonp_ember_auto_import_=window.webpackJsonp_ember_auto_import_||[]).push([[2],[function(e,t,r){"use strict"
var n=r(4)
...
"undefined"!=typeof document&&(r.p=(n=document.querySelectorAll("script"))[n.length-1].src.replace(/\/[^\/]*$/,"/")),e.exports=(i=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return o("_eai_dyn_"+e)},void i("lodash-es",[],function(){return r(12)}))}})
